...
**Stand:** 2026-08-28 · Quellstand `09ab25a` · **14 von 37 abgenommen** · 3 gebaut · 20 offen

> ⚠️ Gerechnet aus dem Arbeitsbaum: unter `docs/plan/`, `docs/beweise/`
> oder `tools/plan/` liegen Änderungen, die noch nicht in `09ab25a` sind.

`███████████████▓▓▓░░░░░░░░░░░░░░░░░░░░░░` 38 % abgenommen · 46 % gebaut

**Als Nächstes:** **Nacharbeit an S9** — der Prüfer hat einen Befund offen gelassen (docs/beweise/SONDE-007b.md).

**Wartet auf ein Urteil** (gebaut, nachgemessen, aber ohne PASS eines frischen Prüfers): `S8`
...
| **P1** — Verträge, gespeicherter Zustand, neutrale Hüllen | `██████████▓▓▓▓▓▓▓▓▓▓▓░░░` | 3 | 3 | 1 |
...
flowchart LR
  ...
  P0 --> P1
  P2["P1<br/>3/7 abgenommen<br/>+3 gebaut"]:::laeuft
  P1 --> P2
...
### P1 — Verträge, gespeicherter Zustand, neutrale Hüllen  (3/7 abgenommen, 3 gebaut)
