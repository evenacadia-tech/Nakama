...
**Stand:** 2026-08-30 · Quellstand `dc7ce7d` · **15 von 38 abgenommen** · 4 gebaut · 19 offen

> ⚠️ Gerechnet aus dem Arbeitsbaum: unter `docs/plan/`, `docs/beweise/`
> oder `tools/plan/` liegen Änderungen, die noch nicht in `dc7ce7d` sind.

`████████████████▓▓▓▓░░░░░░░░░░░░░░░░░░░░` 39 % abgenommen · 50 % gebaut

**Als Nächstes:** **Nacharbeit an G1** — der Prüfer hat einen Befund offen gelassen (docs/beweise/G1.md).

**Wartet auf ein Urteil** (gebaut, nachgemessen, aber ohne PASS eines frischen Prüfers): `S9` · `S9b` · `S14–15`
...
| **P1** — Verträge, gespeicherter Zustand, neutrale Hüllen | `██████████████▓▓▓▓▓▓▓▓▓▓` | 4 | 3 | 0 |
...
flowchart LR
  ...
  P0 --> P1
  P2["P1<br/>4/7 abgenommen<br/>+3 gebaut"]:::laeuft
  P1 --> P2
...
### P1 — Verträge, gespeicherter Zustand, neutrale Hüllen  (4/7 abgenommen, 3 gebaut)
