...
| 24.08. | ~~**WhatsApp ist der Berichtskanal**~~ — **überholt am 24.08. (zwei Zeilen darunter: WhatsApp ist ganz abgeschafft)**; die Regel „nur an den User selbst, nie an Dritte" gilt weiter | „du schickst nur nachrichten an mich selbst. […] das ist der offizielle weg mich zu erreichen ab jetzt. schreib immer wenn eine session fertig ist ein ganz kurzen bericht" |
...
| 24.08. | **WhatsApp ist als Kanal abgeschafft; der Messenger wird Matrix (E2EE).** Grund ist kein Bug, sondern das Auth-Modell: Baileys hängt als **verknüpftes Gerät** am Konto des Users, und eine gelöste Kopplung stellt nur ein QR-Scan **am PC** wieder her — unmöglich genau dann, wenn der User remote ist. Matrix meldet sich mit **Benutzer + Passwort** an, der Bot kann sich also selbst neu anmelden, ohne den User. Die claude.ai-Routine (Zeile darüber) bleibt davon unberührt, bis der User etwas anderes sagt. **Stand 24.08.: gebaut und Ende-zu-Ende belegt** — Hinweg und Rückweg, Werkzeug `C:\Users\phili\.claude\matrix-bridge\` (außerhalb des Repos, es trägt Zugangsdaten) | „wir machen das anders , nichtmehr über whatsapp das funktioniert . suche mal einen anderen messanger raus der sich am besten dafür eignet" · Wahl „Matrix (E2EE)" gegen die Empfehlung Telegram |
...
abgenommen) · **WhatsApp als Kanal in jeder Form** — auch nicht „optional"
oder „als Rückfall" (abgeschafft 24.08.; der Ersatz ist Matrix). Die
`whatsapp`-MCPs bleiben installiert, werden aber für Berichte und Rückfragen
nicht mehr benutzt.
