...
Render mit Verarbeitung und ohne Nakama-Slots braucht die Projekte aus Karte
U43), Snapshot über den Diagnose-Briefkasten (`snapshot-runde01.json`), Karte
