...
**Stand:** 2026-08-30 · Quellstand `22d3695` · **14 von 38 abgenommen** · 5 gebaut · 19 offen

> ⚠️ Gerechnet aus dem Arbeitsbaum: unter `docs/plan/`, `docs/beweise/`
> oder `tools/plan/` liegen Änderungen, die noch nicht in `22d3695` sind.
