...
| Jede neue Prüfung wurde einmal absichtlich gebrochen | **§13**: 16 Rotbeweise, jeder mit beiden Läufen in seiner Rohdatei, jeder an einem TESTFALL. |
...
| E · Behauptung ≤ Messung; jede neue Prüfung einmal gebrochen | 16 Rotbeweise `roh/SONDE-013-rot-C1..C8-r3.txt` und `-B1,B3..B6,B9..B11,B13,B14,B16..B19-r3.txt`; jeder fällt an einem TESTFALL |
