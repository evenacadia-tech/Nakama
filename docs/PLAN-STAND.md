...
**Stand:** 2026-08-28 · Quellstand `b68ee2e` · **13 von 37 abgenommen** · 4 gebaut · 20 offen

> ⚠️ Gerechnet aus dem Arbeitsbaum: unter `docs/plan/`, `docs/beweise/`
> oder `tools/plan/` liegen Änderungen, die noch nicht in `b68ee2e` sind.

`██████████████▓▓▓▓░░░░░░░░░░░░░░░░░░░░░░` 35 % abgenommen · 46 % gebaut

**Als Nächstes:** **Nacharbeit an S9** — der Prüfer hat einen Befund offen gelassen (docs/beweise/SONDE-007b.md).

**Wartet auf ein Urteil** (gebaut, nachgemessen, aber ohne PASS eines frischen Prüfers): `S7` · `S8`
...
| **P1** — Verträge, gespeicherter Zustand, neutrale Hüllen | `███████▓▓▓▓▓▓▓▓▓▓▓▓▓▓░░░` | 2 | 4 | 1 |
...
flowchart LR
  ...
  P0 --> P1
  P2["P1<br/>2/7 abgenommen<br/>+4 gebaut"]:::laeuft
  P1 --> P2
...
### P1 — Verträge, gespeicherter Zustand, neutrale Hüllen  (2/7 abgenommen, 4 gebaut)
