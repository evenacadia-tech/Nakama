...
| 24.08. | **WhatsApp ist als Kanal abgeschafft; der Messenger wird Matrix (E2EE).** Grund ist kein Bug, sondern das Auth-Modell: Baileys hängt als **verknüpftes Gerät** am Konto des Users, und eine gelöste Kopplung stellt nur ein QR-Scan **am PC** wieder her — unmöglich genau dann, wenn der User remote ist. Matrix meldet sich mit **Benutzer + Passwort** an, der Bot kann sich also selbst neu anmelden, ohne den User. Die claude.ai-Routine (Zeile darüber) bleibt davon unberührt, bis der User etwas anderes sagt. **Stand: entschieden, noch nicht gebaut** — es fehlen Bot-Konto und Zugangsdaten, die nur der User anlegen kann | „wir machen das anders , nichtmehr über whatsapp das funktioniert . suche mal einen anderen messanger raus der sich am besten dafür eignet" · Wahl „Matrix (E2EE)" gegen die Empfehlung Telegram |
