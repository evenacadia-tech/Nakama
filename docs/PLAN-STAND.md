...
**Stand:** 2026-08-24 · Quellstand `d76cc8e` · **12 von 36 abgenommen** · 5 gebaut · 19 offen

`█████████████▓▓▓▓▓▓░░░░░░░░░░░░░░░░░░░░░` 33 % abgenommen · 47 % gebaut

**Als Nächstes:** **Nacharbeit an S5** — der Prüfer hat einen Befund offen gelassen (docs/beweise/SONDE-005a.md).

**Bei dir liegen 9 Fragen** — `U2, U5, U6, U8, U9, U10, U11, U12, U13`. Sie werden im Chat gestellt: Skill `/fragen`.
...
- ▣ **S5** `SONDE-005a` — Nachrichtenverträge (JSON) mit Bandgitter und 153 Prüffällen; in Python, C++ und Rust gleich gelesen. Gebaut und nachgearbeitet — das abschließende Prüfurteil eines frischen Prüfers steht noch aus. (gebaut · T3 NEEDS_WORK 2026-08-24 · Befund offen · Kanon 12/12 grün)
- ▣ **S6** `SONDE-005b` — Binärformat für Messdaten (FlatBuffers) mit festen Feldnummern und zwei handgeschriebenen Lesern; 6215 Byte-Mutanten bestanden. Prüfurteil wie S5 noch offen. (gebaut · T3 NEEDS_WORK 2026-08-24 · Befund offen · Kanon 15/15 grün)
