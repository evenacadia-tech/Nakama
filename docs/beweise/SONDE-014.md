...
| Phase | **Abgenommen — T2 PASS 2026-09-07.** Die **Wiederprüfung 4** (Codex `gpt-6-astra`, Effort max, lesend, `HEAD` vor und nach dem Lauf `1796c37`, Thread `01a07bdf-8d94-7272-b8c0-99358cab6f6f`, 8 min; Rohurteil `docs/beweise/roh/SONDE-014-wiederpruefung-4-1796c37.txt`) bestätigt KR-01 als geschlossen und nichts gebrochen: **PASS**. Der **Abschlusskanon** auf dem Endstand `4df8855` (Code identisch mit `1796c37`) ist **GRÜN 60/60** (`docs/beweise/roh/SONDE-014-4df8855.md`). Davor: **Etappe 2: Konvergenzrunde abgeschlossen.** Die Wiederprüfung 3 (Astra max, `0f595a2`) fand **1 Befund**; das Rundenbudget von drei Nacharbeitsrunden war damit verbraucht, und der **Konvergenzentscheid des Dirigenten** (1 Defekt, **Entscheid E-15**: genau ein Register für ausstehende persistenzpflichtige Aufträge) hat die **Konvergenzrunde** beauftragt. Sie hat den Befund als **KR-01** geschlossen — Konvergenzentscheid im Wortlaut, Zuordnung, Rotbeweis, die vierzehn gemessenen Beine und die Matrixnachträge zu M-73 und M-71 stehen in **§11**. **WP2-2 hat der Prüfer als geschlossen bestätigt.** Davor: die Wiederprüfung 2 (Astra max, `d09a6d7`) fand **2 Befunde**; die Nacharbeit 3 hat sie als **WN3-01 und WN3-02** geschlossen (**§10**). **WP1-2 bis WP1-5 hat der Prüfer als geschlossen bestätigt.** Davor: die Wiederprüfung 1 (Astra max, `f30ac47`) fand **5 Befunde**; die Nacharbeit 2 hat sie als **WN-01 bis WN-05** geschlossen — Einordnung, Entscheid **E-14**, das Sendepfad-Inventar, die gemessenen Beine und die Matrixnachträge stehen in **§9**. Davor: die Erstprüfung 1 (Astra max, `dce6970`) fand **14 Befunde**; die Nacharbeit 1 hat sie als **NR-01 bis NR-14** geschlossen — Einordnung, Zuordnung, gemessene Beine und die neu gemessene Kalibrierung stehen in **§8**. Davor: **Bau abgeschlossen.** Alle **neun** Bauetappen aus §5.1 stehen, jede mit vollem Kanon auf ihrem eigenen Stand: **A** `SourceIntent` im Main-State (`8f030f5`, GRÜN 55/55) · **B** Fassung 3 des Wire-Envelopes (`edea7a9`, `baa6291`, `581431a`, GRÜN 55/55) · **C** Evidenzgraph und `CauseHypothesis` (`2e2c97c`, GRÜN 55/55) · **D** Befundzustände (`c303554`, GRÜN 56/56) · **E** Maskierungs-Datenweg (`522e2ab`, GRÜN 56/56) · **F** Proposal-Policy (`a9659b1`, GRÜN 56/56) · **G** `AssistantStep` im Main (`d1f62d3`, GRÜN 57/57) · **H** P5-Evaluationskorpus als Kette (`0e853f9`, GRÜN 60/60) · **I** Ort, Nebenläufigkeit und Invarianten (`1381e14`, `a90d2ab`, Abschlusskanon siehe Zeile Kanon nachher). Davor ohne Produktcode: **Matrixnacharbeit 1** (2026-09-06), **Etappe 1b — Entscheide E-01 bis E-10** (`fdb04e4`) und **Etappe 1 — Verhaltensmatrix** (`1f126a4`). Der Bauverlauf steht in §7.1 bis §7.9, die abgehakte Prüfliste am gebauten Stand in §7.10, die gesammelten Nebenbefunde in §7.11 und die Runden in §7.12. |
...
| Entscheide | E-01 bis E-10 wörtlich in `docs/beweise/roh/SONDE-014-etappe-1-entscheid-auftrag.txt`. Eingearbeitet in Etappe 1b: neun angenommene Technikentscheide (E-01 bis E-09, E-01 und E-03 mit Präzisierung, E-08 mit Autoritätenzuweisung) und **eine neue Lücke E-10** (Transport des Intents vom Main zum Broker) mit den zwei zusätzlichen Matrixzeilen **M-85** und **M-86**. **Seit der Konvergenzrunde (07.09.2026) kommt E-15 dazu** (genau **ein** Register für ausstehende persistenzpflichtige Aufträge; der Deckel „64 P0-Plätze" aus WN3-01 ist als irrig zurückgenommen — §11.2, Matrixzeilen M-73 und M-71). **Seit der Nacharbeit 2 (07.09.2026) kommt E-14 dazu** (Bestandsgeneration statt Sender-Revision für `STALE` und Eintragung, §9.2, Matrixzeile M-10). **Seit der Nacharbeit 1 E-13** (das Experimentziel überlebt den Brokerneustart, §8.2). **Seit der Matrixnacharbeit 1 kommt E-11 dazu** (Transport und versionierter Spiegel des `AssistantStep`, Regel R3, §4.13) mit **M-88** und **M-89**. Je Entscheid steht ein Block „Etappe 1b (Entscheid des Dirigenten, 06.09.2026)" unter dem zugehörigen §4-Abschnitt; der vorige Vorschlagstext bleibt als Historie stehen. |
| Urteil | **T2 PASS 2026-09-07 (Dirigent).** Grundlage: **Wiederprüfung 4** (Codex `gpt-6-astra`, Effort max, lesend, `HEAD` vor und nach dem Lauf `1796c37`, Thread `01a07bdf-8d94-7272-b8c0-99358cab6f6f`): **PASS** — KR-01 geschlossen, nichts gebrochen (Rohurteil `docs/beweise/roh/SONDE-014-wiederpruefung-4-1796c37.txt`, Auftrag `docs/beweise/roh/SONDE-014-wiederpruefung-4-auftrag.txt`); **Abschlusskanon GRÜN 60/60 auf `4df8855`** (Code identisch mit `1796c37`; `docs/beweise/roh/SONDE-014-4df8855.md`). Befundzahl je Prüfrunde: 14 → 5 → 2 → 1 → 0. Was T2 NICHT sagt: G5 (Gate, T3, adversariale Gegenbeispiele) und der FL-Lauf stehen aus. — **Wiederprüfung 3 (Codex `gpt-6-astra`, Effort max, lesend, `HEAD` vor und nach dem Lauf `0f595a2`): NEEDS_WORK, 1 Befund — Konvergenzentscheid des Dirigenten: 1 Defekt, Entscheid E-15.** Rohurteil `docs/beweise/roh/SONDE-014-wiederpruefung-3-0f595a2.txt`, Auftrag der Konvergenzrunde `docs/beweise/roh/SONDE-014-konvergenzrunde-auftrag.txt`; der Befund ist in der **Konvergenzrunde** (07.09.2026, §11) als **KR-01** geschlossen, mit dem Rotbeweis `docs/beweise/roh/SONDE-014-rot-KR-01.txt`, und die betroffenen Beine sind auf dem Endstand `2ef235e` **alle grün** (§11.5, vierzehn Beine). **WP2-2 ist vom Prüfer als geschlossen bestätigt.** — **Wiederprüfung 2 (Codex `gpt-6-astra`, Effort max, lesend, `HEAD` vor und nach dem Lauf `d09a6d7`): NEEDS_WORK, 2 Befunde — 2 Defekte.** Rohurteil `docs/beweise/roh/SONDE-014-wiederpruefung-2-d09a6d7.txt`, Nacharbeitsauftrag `docs/beweise/roh/SONDE-014-nacharbeit-3-auftrag.txt`; beide sind in der **Nacharbeit 3** (07.09.2026, §10) geschlossen, jede mit eigenem Rotbeweis unter `docs/beweise/roh/` (`SONDE-014-rot-WN3-01.txt` und `-WN3-02.txt`), und die betroffenen Beine sind auf dem Endstand `1c736ab` **alle grün** (§10.5). **WP1-2 bis WP1-5 sind vom Prüfer als geschlossen bestätigt.** — **Wiederprüfung 1 (Codex `gpt-6-astra`, Effort max, lesend, `HEAD` vor und nach dem Lauf `f30ac47`): NEEDS_WORK, 5 Befunde — 4 Defekte, 1 Lücke (E-14).** Rohurteil `docs/beweise/roh/SONDE-014-wiederpruefung-1-f30ac47.txt`, Nacharbeitsauftrag `docs/beweise/roh/SONDE-014-nacharbeit-2-auftrag.txt`; alle fünf sind in der **Nacharbeit 2** (07.09.2026, §9) geschlossen, jede mit eigenem Rotbeweis unter `docs/beweise/roh/` (`SONDE-014-rot-WN-01.txt` bis `-WN-05.txt`, fünf Dateien), und die betroffenen Beine sind auf dem Endstand `b49dc69` **alle grün** (§9.5). — **Erstprüfung 1 (Codex `gpt-6-astra`, Effort max, lesend, `HEAD` vor und nach dem Lauf `dce6970`): NEEDS_WORK, 14 Befunde — 13 Defekte, 1 Lücke (E-13).** Rohurteil `docs/beweise/roh/SONDE-014-erstpruefung-1-dce6970.txt`, Nacharbeitsauftrag `docs/beweise/roh/SONDE-014-nacharbeit-1-auftrag.txt`; alle vierzehn sind in der **Nacharbeit 1** (07.09.2026, §8) geschlossen, jede mit eigenem Rotbeweis unter `docs/beweise/roh/` (Muster `SONDE-014-rot-NR-01.txt` bis `-NR-14.txt`, vierzehn Dateien). — **T1 PASS (Erbauer), 2026-09-07.** Selbstaudit des Bauers auf dem Abschlussstand `c053be8`: alle neun Bauetappen gebaut, voller Kanon **GRÜN 60/60** auf sauberem Baum, Rohausgabe `docs/beweise/roh/SONDE-014-c053be8.md`. **T2 steht aus** - die Erstprüfung der Etappe 2 durch einen frischen, lesenden Codex-Thread hat noch nicht stattgefunden; sie setzt der Dirigent. Was T1 NICHT sagt: dass ein zweiter Leser die Zusagen gegen Gate-Text und Matrix gehalten hätte. |
| Prüfstufe | T1+T2 gefordert (`docs/bauaufteilung-sonden.md` Zeile 394 · `docs/plan/plan.json`, Schritt S23–25, `"stufe": "T2"`). **T1 vergeben** (Selbstaudit des Erbauers), **T2 vergeben** (Dirigent, 07.09.2026, nach Wiederprüfung 4 PASS und Abschlusskanon GRÜN 60/60 auf `4df8855`). |
...
| Kanon nachher | **Abschlusskanon GRÜN 60/60 auf `4df8855`** (Code identisch mit `1796c37`, dem Endstand der Konvergenzrunde), Rohausgabe `docs/beweise/roh/SONDE-014-4df8855.md`, Kanonabschnitt am Ende dieses Manifests; abgekoppelt auf sauberem Baum gefahren, mit `-Bauen` unmittelbar davor gebaut. Davor: **GRÜN 60/60 auf `c053be8`** (`docs/beweise/roh/SONDE-014-c053be8.md`). ⚠️ Jener Kanonstand lag **vor** den Nacharbeiten 1, 2 und 3 und vor der Konvergenzrunde: alle vier haben Produktcode geändert, und ihr Beleg sind die betroffenen Beine in §8.4 (`docs/beweise/roh/SONDE-014-nacharbeit-1-25460cd.txt`), §9.5 (`docs/beweise/roh/SONDE-014-nacharbeit-2-b49dc69.txt`, vierzehn Beine), §10.5 (`docs/beweise/roh/SONDE-014-nacharbeit-3-1c736ab.txt`, neunzehn Beine) beziehungsweise §11.5 (`docs/beweise/roh/SONDE-014-nacharbeit-4-2ef235e.txt`, vierzehn Beine, alle grün); der volle Kanon beim Ticketabschluss ist der oben genannte Lauf auf `4df8855`. Der Lauf ist abgekoppelt auf einem **sauberen** Baum gefahren und hat mit `-Bauen` unmittelbar davor gebaut; die Zahl steigt von **54** vor dem Ticket, weil B27, B28, B29, A28, A29 und A30 dazugekommen sind und kein Bein verschwunden ist. |
| Rundenbilanz Etappe 2 | Kumuliert (`py -3.13 tools/dirigent/rundenbilanz.py --runden f90abf5 dce6970 f30ac47 d09a6d7 0f595a2 1796c37`): **Bau** `f90abf5..dce6970` Produkt 109 Dateien +15772/−103, Tests 18 +7661/−27, Prüfwerkzeug 6 +1816/−17 · **Nacharbeit 1** Produkt 18 +952/−68, Tests 11 +1501/−24, Prüfwerkzeug 3 +288/−19 · **Nacharbeit 2** Produkt 11 +666/−54, Tests 4 +1068/−43 · **Nacharbeit 3** Produkt 8 +281/−57, Tests 4 +970/−0, Prüfwerkzeug 1 +18 · **Konvergenzrunde** Produkt 4 +249/−158, Tests 3 +415/−72. Kein Konvergenz-Signal: keine Runde ohne Produktfortschritt. |
...
<!-- NAKAMA-URTEIL: T2 PASS 2026-09-07 -->
...
| M-28 | Eine Behauptung wird sichtbar | **Jede sichtbare Behauptung referenziert existente Evidenz-IDs** (Exit-Gate, wörtlich). „Existent" ist eine Prüfung gegen den Store, nicht gegen den Speicher: eine ID, deren `evidence`-Zeile fehlt oder ausgeschlossen ist, macht die Behauptung unsichtbar beziehungsweise `STALE` — sie wird nie ohne Beleg gezeigt. **Nachtrag Nacharbeit 1 (07.09.2026), NR-04:** die Pruefung gegen den Store hat seither einen Produktpfad. `StoreHandle::evidenz_belegt` fragt die ganze Menge in EINER Abfrage, `befunde_gegen_store_haerten` laeuft ausserhalb des Standlocks und wendet unter dem Lock an — beim Eintragen UND vor jeder Serialisierung in `session_snapshot_json`. Bis dahin serialisierte der Snapshot ausschliesslich den Cache. **Ohne Store und bei degradiertem Store gilt die Speicherpruefung als benannter Fallback:** eine gescheiterte Leseabfrage ist keine Aussage darueber, ob die Zeile existiert. Beleg §8.3, Rotbeweis `docs/beweise/roh/SONDE-014-rot-NR-04.txt`. | **BELEGT** · **BAULÜCKE** | **NEU** `EqCopSonde014HypotheseTest`, Fall `behauptung_ohne_existente_evidenz_wird_nicht_sichtbar`; **A4** Storefall nach Neustart | Ein Befund mit einer gelöschten Evidenz-ID bleibt sichtbar und handelbar | Entwurf §59 Exit-Gate (§1.1); §34.2 |
...
| M-48 | Ein Experiment liest den Zielbereich (**NAK-168, Hälfte 2**) | **E-05, entschieden 06.09.2026.** `experiment_begin` bekommt in derselben **Fassung 3** ein optionales Objekt `ziel` (`band_von`, `band_bis`, `geschuetzte_baender` als Liste von Bandintervallen, `proposal_id` als Rückverweis). **Mit `ziel`** liest der Guardrail-Rechner Ziel- und Schutzbereiche und rät nichts. **Ohne `ziel`** — der manuelle Versuch ohne Vorschlag, der SONDE-013-Pfad — bleibt die heutige Heuristik (`experiment_verdrahtung.rs`:1069–1088) und das **Resultat trägt das Kennzeichen `ziel_geraten`**. Beide Pfade werden gemessen. **Nachtrag Nacharbeit 1 (07.09.2026), Entscheid E-13 (NR-09):** das `ziel` gehoert zum PERSISTIERTEN Experimentobjekt. `experiment_json` schreibt es, `experiment_aus_gespeichertem` liest es ueber dieselbe Funktion zurueck, die das `experiment_begin` liest; ein mit `ziel` begonnener Versuch behaelt es ueber den Brokerneustart, und `ziel_geraten` bleibt dem Versuch ohne `ziel` vorbehalten. Bis dahin setzte die Wiederherstellung es ausdruecklich auf `None` — die Guardrail-Auswertung wechselte damit still auf die Heuristik. Beleg §8.3, Rotbeweis `docs/beweise/roh/SONDE-014-rot-NR-09.txt`. | **ENTSCHIEDEN** (E-05, §4.5) · **BAULÜCKE** | **NEU** `EqCopSonde014ProposalTest` plus **A4**-Verdrahtungsfall für beide Pfade; **A5** Negativfixture für `ziel` | Zwei Rotbeweise: die Heuristik läuft **trotz** gesetztem `ziel`; und ein Resultat **ohne** `ziel` trägt kein `ziel_geraten` | E-05 (§4.5); NAK-168 (§1.8); `broker/src/coordinator/experiment_verdrahtung.rs`:1069–1088 |
...
| **N-26** | `transport::server_v3::tests::trennreihenfolge_je_callback_genau_einmal` flackert | §8 (Nacharbeit 1) | offen, ticketfremd; zeitabhängiger Named-Pipe-Fall, im Wiederholungslauf grün |
...
| **N-30** | Der persistierte `session_snapshot` trug Zahlen mit **sechzehn** signifikanten Stellen, die der **eigene** Textriegel verwirft | §9.4 (Nacharbeit 2) | **behoben** (WN-03): `beobachtung.wert_db` entsteht aus einem `f32` (`-3.3f32` → `-3.2999999523162842`), und `vertrag.rs` lehnt `signifikante_stellen > 15` ab. Jeder `resubscribe_snapshot_push` fiel damit in `routing_fail_closed`, sobald die Sitzung einen Befund trug. `zahl()` rundete seither auf 15 Stellen (`auf_wirestellen`). **Nacharbeit 3 (WN3-02):** diese Rundung war NUMERISCH und hielt die Zusage für Kleinwerte nicht — sie ist durch `vertrag::wire_zahl` am serialisierten TEXT ersetzt. Die damals offen gelassene Frage nach weiteren Zahlenwegen ist mit dem **f64-Feldinventar in §10.4** beantwortet: neunzehn Felder aus Befund, Maskierung und Proposal laufen durch den Deckel; Bandindizes sind ganzzahlig, `f32`-Felder tragen höchstens neun Stellen, und vom Draht gelesene `f64` trugen den Deckel bereits |
...
| **N-32** | Der WN-03-Kommentarblock steht in `subscription.rs` **zweimal** (vier Zeilen, unmittelbar hintereinander) | §10.7 (Nacharbeit 3) | offen, ticketfremd: reiner Kommentar aus der Vorrunde, kein Verhalten. Nicht angefasst, weil `subscription.rs` außerhalb der beiden Punkte dieses Auftrags liegt |
| **N-33** | `ControlClient::setzeAuftragAbgeschlossenHook` hat seit KR-01 **keinen Produktkonsumenten** mehr | §11.7 (Konvergenzrunde) | offen, benannt: sein einziger Zweck war die Freigabe des zweiten Registers, und E-15 schafft dieses Register ab. Der Hook bleibt, weil er die einzige Stelle ist, an der der ControlClient **je Kennung** meldet, dass ein persistenzpflichtiger Auftrag sein Register verlässt — genau das misst **B10** (`zwei_ausstehende_urteile_melden_ihren_abschluss_je_kennung`, `ein_angewandter_auftrag_meldet_seinen_abschluss_genau_einmal`, `kr01_erst_angewandt_gibt_den_ersten_auftrag_frei`), und der Auftrag der Konvergenzrunde verlangt ausdrücklich, dass diese Fälle grün bleiben. Ein echter Konsument wird fällig, sobald das Produkt auf einen **endgültig fehlgeschlagenen** persistenzpflichtigen Auftrag reagieren soll; das ist eine Produktfrage außerhalb dieses Auftrags |

**Zusammen 33 Zeilen: 19 behoben, 14 offen** — gezählt an der Tabelle, nicht
geschätzt.
...
- **Am Werkzeug oder im eigenen Diff behoben (6):** N-07, N-09, N-12, N-14,
  N-16, N-19.
- **Am Vertrags- oder Lesertext behoben (4):** N-05, N-08 sowie N-03, das mit
  N-23 zusammenfällt, und **N-30** (Wire-Deckel, in den Nacharbeiten 2 und 3
  geschlossen — er fehlte in dieser Aufzählung bis zur Konvergenzrunde).
- **Offen (14):** alte oder fremde Beine und Dateien (N-01, N-06, N-10,
  N-15, N-24, N-26, N-27 — davon N-01 ein Registertext), der Plantext N-04,
  N-25 (löst erst P6 auf), N-28 (benannte Produktlücke der Nacharbeit 1),
  N-29 (Werkzeuglandmine), N-31 (Testharnisch der Nacharbeit 1), N-32
  (Kommentardoppel in `subscription.rs`) und N-33 (Abschluss-Hook ohne
  Produktkonsumenten).
...
| **Wiederprüfung 2 (Etappe 2)** | Codex `gpt-6-astra` max, lesend | `d09a6d7` | **NEEDS_WORK**, 2 Befunde — 2 Defekte; WP1-2 bis WP1-5 bestätigt geschlossen |
| Nacharbeit 3 (WN3-01, WN3-02) | Bauer | `79fb91f`, `1c736ab` | Beide geschlossen, 2 Rotbeweise, betroffene Beine grün auf `1c736ab` (§10) |
| **Wiederprüfung 3 (Etappe 2)** | Codex `gpt-6-astra` max, lesend | `0f595a2` | **NEEDS_WORK**, 1 Befund — 1 Defekt; WP2-2 bestätigt geschlossen. Das Rundenbudget von drei Nacharbeitsrunden ist damit verbraucht |
| **Konvergenzentscheid** | Dirigent | `7cc79d7` | 1 Defekt an der Quelle bestätigt, **Entscheid E-15**: ein Register für ausstehende persistenzpflichtige Aufträge |
| Konvergenzrunde / Nacharbeit 4 (KR-01, E-15) | Bauer | `2ef235e` | Geschlossen, 1 Rotbeweis, 14 betroffene Beine grün auf `2ef235e` (§11) |
| **Wiederprüfung 4 (Konvergenzrunde)** | Codex `gpt-6-astra` max, lesend | `1796c37` | **PASS** — KR-01 geschlossen, nichts gebrochen (Thread `01a07bdf-8d94-7272-b8c0-99358cab6f6f`, 8 min) |
| **Abschlusskanon** | Dirigent (abgekoppelt) | `4df8855` | **GRÜN 60/60**, Rohausgabe `docs/beweise/roh/SONDE-014-4df8855.md` → **T2 PASS 2026-09-07** |

**Zwei Matrixprüfungen, fünf Prüfrunden der Etappe 2, drei Nacharbeiten plus
eine Konvergenzrunde, neun Bauetappen** — die Erstprüfung 1 und ihre
Nacharbeit 1 stehen in §8, die Wiederprüfung 1 und die Nacharbeit 2 in §9,
die Wiederprüfung 2 und die Nacharbeit 3 in §10, die **Wiederprüfung 3, der
Konvergenzentscheid und die Konvergenzrunde** in §11 (alle 07.09.2026). Die
Befundzahl je Runde fällt monoton: **14 → 5 → 2 → 1 → 0**. Die **Wiederprüfung 4** (Astra max, `1796c37`) ist **PASS**, der Abschlusskanon auf `4df8855` ist **GRÜN 60/60**; das Urteil im Kopf ist **T2 PASS** (Dirigent, 07.09.2026).

---

## 8. Erstprüfung 1 und Nacharbeit 1 (07.09.2026)
...
| Thread | `01a079da-2aab-7540-8173-c6733c7739ca` |
| `HEAD` vor und nach dem Lauf | `dce6970c7428bd25f24df9fe953bddb43204f9c6` (unverändert, keine eigenen Dateiänderungen) |
| Dauer | 31 min (2026-09-07T05:12:15 bis 05:43:25), `EXIT=0` |
| **Urteil** | **NEEDS_WORK** — mehrere konkrete Gate- und Matrixverletzungen, **14 Befunde** |
| Rohurteil | `docs/beweise/roh/SONDE-014-erstpruefung-1-dce6970.txt` |
| Auftrag | `docs/beweise/roh/SONDE-014-erstpruefung-1-auftrag.txt` |
| Nacharbeitsauftrag | `docs/beweise/roh/SONDE-014-nacharbeit-1-auftrag.txt` |
| Startstand der Nacharbeit | `a319b2d4e3d5e38cf8e756ba5bbcd7a84071e24a`, Worktree sauber |

**Was der Prüfer nicht gemessen hat** (wörtlich aus seinem Urteil): Neubau,
vollständiger Kanon, schreibende Store- und Killreproduktionen und die
Wiederholung aller 103 Rotbeweise; A12 war unter Python 3.14 wegen fehlendem
`rfc8785` blockiert, A29 nutzte das vorhandene Ergebnisartefakt, und die
übrigen Produktpfadbefunde beruhen auf Codeinspektion. Die Nacharbeit 1 hat
alle vierzehn Befunde **an der Quelle** nachvollzogen und geschlossen.

### 8.2 Einordnung des Dirigenten

**13 Defekte und eine Lücke.** Die Lücke ist EP-09 (das Experimentziel über
den Brokerneustart): M-48 sagt zum Neustart nichts, M-71 ordnet
„Experimente" dem Store zu. Sie ist in dieser Runde entschieden:

> **Entscheid E-13 (Dirigent, 07.09.2026).** Das Experimentziel ist Teil des
> persistierten Experimentobjekts (M-71 „Experimente gehören in den lokalen
> SQLite-Experimentstore" meint das ganze Objekt; `CLAUDE.md` „State bleibt
> verlustfrei", Arbeitsregel speichern↔laden im selben Änderungssatz). Ein mit
> `ziel` begonnenes Experiment behält sein Ziel über den Brokerneustart;
> `ziel_geraten` bleibt dem Versuch vorbehalten, der **ohne** `ziel` begonnen
> wurde.

Der Wortlaut des Entscheids und die vierzehn Regeln NR-01 bis NR-14 stehen in
`docs/beweise/roh/SONDE-014-nacharbeit-1-auftrag.txt`.

### 8.3 Zuordnung: Befund → Regel → geänderte Stelle → Rotbeweis

| Befund | Zusage | Regel und was gebaut wurde | Gemessen an | Rotbeweis |
|---|---|---|---|---|
| **EP-01** | M-86 | **NR-01** — die Sperre ist **fail-closed**. Die Bedingung lautete zweimal `intent.is_some_and(\|i\| !i.vollstaendig)`; bei `intent == None` ist sie **falsch**, und ohne jede Vollständigkeitsmeldung entstanden Findings und Proposals. Die Frage steht jetzt an EINER Stelle (`intent::darf_gerechnet_werden`) und wird von `darf_rechnen`, `aufnahmen_sammeln` und `hypothesen()` gestellt | `sonde014_verdrahtung.rs::keine_rechnung_ohne_jede_intentmeldung` (A4) | `roh/SONDE-014-rot-NR-01.txt` |
| **EP-02** | M-85 | **NR-02** — die Revisionsordnung gilt **je Koaleszierungsobjekt** `(quelle_id, scope)`. `P1Warteschlange::einreihen()` ersetzt einen Eintrag an seiner Position, sodass A/3 **vor** B/2 ankommt; global gemessen wurde B/2 verworfen und die geschützte Rolle einer fremden Quelle fehlte dauerhaft. `IntentBestand` führt dafür `teilrevisionen` und `grundrevision`; die Sitzungsrevision wird als **Maximum** fortgeschrieben und ordnet nur Vollberichte | `sonde014_verdrahtung.rs::teilupdate_fremden_schluessels_ueberlebt_eine_koaleszierung` (A4) | `roh/SONDE-014-rot-NR-02.txt` |
| **EP-03** | M-10, M-24 | **NR-03** — das Rechenergebnis wird **unter demselben Lock** gegen den Stand geprüft, bevor es eingesetzt wird: Intent-Revision gleich der Sitzungsrevision, und jede `evidence_id` vorhanden und nicht ausgeschlossen. Sonst wird verworfen und die Sitzung bleibt dirty. Der neue `rechen_test_haken` fällt genau einmal zwischen `aufnahmen_sammeln` und `befunde_eintragen` | `sonde014_verdrahtung.rs::veraltetes_rechenergebnis_wird_nicht_veroeffentlicht` (A4), zwei Abschnitte | `roh/SONDE-014-rot-NR-03.txt` |
| **EP-04** | M-28 | **NR-04** — „existent" ist eine Prüfung gegen die Tabelle `evidence` des **Stores**. `StoreHandle::evidenz_belegt` fragt die ganze Menge in EINER Abfrage, `befunde_gegen_store_haerten` läuft außerhalb des Standlocks und wendet unter dem Lock an — beim Eintragen **und** vor jeder Serialisierung — an der Lesesicht `session_snapshot_json` **und** im produktseitigen `flush_session`, das den Push baut. Ohne Store und bei degradiertem Store gilt die Speicherprüfung ausdrücklich als Fallback | `sonde014_nacharbeit1.rs::befund_mit_geloeschter_evidenzzeile_wird_unsichtbar` **und** `…::der_flush_pfad_haelt_die_belege_ebenfalls_gegen_den_store` (A4, echter SQLite-Store) | `roh/SONDE-014-rot-NR-04.txt` |
| **EP-05** | M-23 | **NR-05** — die Mindestfensterzahl gilt **je beteiligter Quelle**. Passagengate und Klassenbildung halten `passagenmaterial()` = `min(kandidat, master)` gegen `GATE_MINDEST_FENSTER`; acht Kandidatenfenster gegen ein einziges Masterfenster bestanden vorher alle vier relativen Gates | `sonde014_nacharbeit1.rs::passagengate_misst_auch_die_fenster_des_masters` (A4, mit Gegenprobe) | `roh/SONDE-014-rot-NR-05.txt` |
| **EP-06** | M-18, M-19, M-16 | **NR-06** — die Rückabbildung ist die **echte Umkehrung**: `von = ceil(g·221/64)`, `bis = ceil((g+1)·221/64)` in `bandintervall_der_gruppe`. Mit der abrundenden Form lagen **63 von 221** Bändern außerhalb des Intervalls ihrer eigenen Gruppe; Band 100 bekam `[96, 100)`. Ein `debug_assert` hält fest, dass das beobachtete Band im zurückgegebenen Intervall liegt | `sonde014_hypothese.rs::jedes_band_liegt_im_intervall_seiner_gruppe` (A4, alle 221 Bänder plus Lückenlosigkeit) | `roh/SONDE-014-rot-NR-06.txt` |
| **EP-07** | Exit-Gate, M-43, M-46 | **NR-07** — `passage_id` steht in `$defs/proposal.required`. Vertrag, C++-Writer (`kleinstesProposalJson`) und die Negativfixture `proposal-ohne-passage.json` ziehen gemeinsam nach; der Sprung `if feld == "passage_id" { continue; }` ist fort | `sonde014_nacharbeit1.rs::sechs_gate_felder_sind_pflicht_mit_passage` (A4) und **A5** an der Negativfixture | `roh/SONDE-014-rot-NR-07.txt` |
| **EP-08** | M-59, M-88, M-89 | **NR-08** — EINE Wahrheit des Schritts. `v3AssistantStepJson()` liest `zustand.assistent` unter dem Bindungsschloss mit **dessen** Revision; das Schattenfeld samt eigener Zählung ist entfernt, `assistentSchrittKopie()` leitet ab, `setzeAssistentSchritt` ist der reine Meldeweg mit Riegel gegen den Main-State | `Sonde014AssistentTest.cpp`, Abschnitt „NR-08" (**B29**), beide Reprofolgen | `roh/SONDE-014-rot-NR-08.txt` |
| **EP-09** | M-48, **E-13** | **NR-09** — `experiment_json` schreibt `ziel`, `experiment_aus_gespeichertem` liest es über **dieselbe** Funktion zurück, die das `experiment_begin` liest | `sonde014_nacharbeit1.rs::experimentziel_ueberlebt_den_brokerneustart` (A4, echter Neustart auf demselben Store, mit Gegenprobe ohne Ziel) | `roh/SONDE-014-rot-NR-09.txt` |
| **EP-10** | M-73, E-09 | **NR-10** — `user_verdict` hat einen Produktpfad auf **beiden** Seiten: der Broker nimmt es in `p0_json_mit_minor` als persistenzpflichtigen P0 an (Append `event_type = "user_verdict"`, Projektion `user_verdicts`, ACK **nach** dem Append); das Plugin sendet es in `assistentAntwort` über `sendePersistenzP0`. Die Urteilsmenge steht als `nakama::state::Userurteil` in ihrer C++-Hälfte (M-77) | `sonde014_nacharbeit1.rs::user_verdict_wird_persistiert_und_bestaetigt` und `…_wiederholt_sich_idempotent_ueber_den_brokerkill` (A4/A4-SI-Muster), `Sonde014AssistentTest.cpp` Abschnitt „NR-10" (**B29**) | `roh/SONDE-014-rot-NR-10.txt` |
| **EP-11** | M-71 | **NR-11** — der versionierte SQLite-Spiegel des Intents über denselben Ein-Writer-Append wie `assistent.rs`; append-only `event_log`, `event_type = "intent_update"`, **keine** Domänenprojektion. Der Spiegel ist nie autoritativ | `sonde014_nacharbeit1.rs::intent_bestand_wird_versioniert_gespiegelt` (A4, zwei Zeilen mit steigender Revision, Main gewinnt nach dem Neustart) | `roh/SONDE-014-rot-NR-11.txt` |
| **EP-12** | M-31, M-66 | **NR-12** — `schwelle_suchen` bewertet die **neu zugelassene Handlung**, nicht die ursprüngliche Klasse. Enthaltungen sind ausgenommen | `pruefe_p5_korpus.py --selbsttest` (**A30**), fünf Fälle mit Gegenteil | `roh/SONDE-014-rot-NR-12.txt` |
| **EP-13** | M-64 | **NR-13** — die Klassenmetrik rechnet gegen `soll_klasse` aus `sitzungen.json`; eine Abweichung ist ein eigener roter Riegel mit Sitzungsname, und der Recall-Nenner entsteht aus den Sollsitzungen | **A30**, vier Fälle mit Gegenteil | `roh/SONDE-014-rot-NR-13.txt` |
| **EP-14** | M-65, NAK-190 | **NR-14** — jede `alternatives`-ID löst auf einen existenten **anderen** Befund desselben Laufs auf, und dessen `candidate_source` ist die im Korpus deklarierte Distraktorquelle (`distraktor: true`, A28 bytegleich). Nicht auflösbare, selbstbezügliche und fremde IDs sind rote Zeilen | **A30**, vier Fälle mit Gegenteil | `roh/SONDE-014-rot-NR-14.txt` |

### 8.4 Die Beine, gemessen

Nur die **betroffenen** Beine — kein voller Kanon; der läuft beim
Ticketabschluss. Rohprotokoll:
`docs/beweise/roh/SONDE-014-nacharbeit-1-25460cd.txt`, gefahren auf sauberem Baum auf dem Endstand `25460cd` der Nacharbeit 1, **alle gruen**. Der Lauf auf `cba0573` (vor dem Manifest) war identisch gruen.

| Bein | Was | Zahl |
|---|---|---|
| **A4** | `cargo test --manifest-path broker/Cargo.toml` | **638** Prüfungen in 26 Binaries, 0 Fehler (von 626 vor der Nacharbeit) |
| **A4-SI** | `store_crash_matrix -- --ignored` | 22 Prüfungen, 0 Fehler |
| **A5** | `pruefe_v3_vertrag.py --abdeckung` | **598** Prüfungen, 0 gescheitert (von 597 — die neue Negativfixture) |
| **A8** | `erzeuge_v3_fixtures.py --pruefen` | **392** Dateien bytegleich (von 391) |
| **A28** | `erzeuge_p5_korpus.py --pruefen` | 2 Dateien, 6 Sitzungen, bytegleich |
| **A29** | `pruefe_p5_korpus.py` | 6 Sitzungen, 8 Befunde, grün |
| **A30** | `pruefe_p5_korpus.py --selbsttest` | **52** Prüfungen (von 38), grün |
| **B3c** | `EqCopSchemaTest` | 136 bestanden, 0 gescheitert |
| **B10** | `EqCopIpcTest` | 370 Prüfungen, 0 Fehler |
...
| **B29** | `EqCopSonde014AssistentTest` | **152/152** grün (von 129) |
...
Neue Rust-Fälle je Ziel: `sonde014_verdrahtung` **17** (von 14),
`sonde014_nacharbeit1` **8** (neu), `sonde014_hypothese` **19** (von 18),
`sonde014_proposal` 18, `sonde014_befund` 7, `sonde014_maskierung` 5,
`sonde014_p5_korpus` 1.

### 8.5 Neu gemessene Kalibrierung (NR-05, NR-12)

**`GATE_MINDEST_FENSTER` = 8 hält weiterhin.** Beide Passagensitzungen
(`zu_kurze_passage`, `verschobene_passage`) tragen **null** starke Aussagen —
auch nachdem NR-05 den Master ins Minimum genommen hat. Es entsteht
weiterhin **kein** `metrics_version`-Schritt (E-12 Fall 3).

**Die Schwelle aus M-31 hat sich bewegt — nicht ihr Wert, sondern ihre
Messung.** `schwelle_suchen` findet als niedrigste haltende Stufe seit NR-12
**`hoch`** statt `unklar`:

```
  Schwelle hoch:   handelbar=1  davon_falsch=0  haelt=True
  Schwelle mittel: handelbar=6  davon_falsch=2  haelt=False (korrelierter_distraktor, parent_duplikat)
  Schwelle unklar: handelbar=8  davon_falsch=2  haelt=False (korrelierter_distraktor, parent_duplikat)
  SCHWELLE (Ausgabe, M-31): niedrigste haltende Stufe = hoch
  PRODUKTSCHWELLE (M-31): 1 von 8 Befunden handelbar, Sicherheiten ['hoch']
```

Das Produkt handelt genau bei `hoch` (`produktschwelle()` liest den `zustand`
jedes ausgegebenen Befunds). Die Schwelle ist damit **exakt kalibriert**
statt „strenger als nötig" — die frühere Aussage in M-31 beruhte auf der
Lücke, die EP-12 gefunden hat. Der Wert selbst ändert sich nicht, also
entsteht **kein** `metrics_version`-Schritt.

**Kennzahlen je Soll-Ursachenklasse** (NR-13, Nenner aus dem Korpus):

| Sollklasse | n | precision | recall | soll_starke | brier | Kalibrierung | Coverage |
|---|---|---|---|---|---|---|---|
| `daten_reichen_nicht` | 1 | 1,000 | 1,000 | 0 | 0,000 | 0,000 | 0,000 |
| `quelle_resonanz` | 3 | 1,000 | 1,000 | 1 | 0,085 | 0,250 | 0,667 |
| `zwei_quellen_konkurrenz` | 4 | 1,000 | 1,000 | 0 | 0,160 | 0,400 | 1,000 |
| **gesamt** | 8 | 1,000 | 1,000 | 1 | 0,135 | 0,350 | 0,750 |

### 8.6 Matrixzeilen, in dieser Runde nachgezogen

Die alte Fassung bleibt als Verlauf stehen; der Nachtrag steht darunter und
ist als **Nacharbeit 1** markiert.

| Zeile | Nachtrag |
|---|---|
| **M-86** | Die Sperre ist **fail-closed**: `intent == None` sperrt genauso wie ein unvollständiger Bestand. Sie steht als EINE Funktion `intent::darf_gerechnet_werden` und wird von `darf_rechnen`, `aufnahmen_sammeln` und `hypothesen()` gestellt (NR-01) |
| **M-85** | Die Revisionsordnung gilt **je Koaleszierungsobjekt** `(quelle_id, scope)`; die Sitzungsrevision wird als Maximum fortgeschrieben und ordnet nur Vollberichte. Für ein Objekt zählt **gleich** als nicht neuer (NR-02) |
| **M-10, M-24** | Ein Rechenergebnis wird **unter demselben Lock** gegen Intent-Revision und Evidenzbestand geprüft, bevor es eingesetzt wird; scheitert die Prüfung, wird verworfen und die Sitzung bleibt dirty (NR-03) |
| **M-28** | „Existent" ist eine Prüfung gegen die Tabelle `evidence` des Stores — beim Eintragen **und** vor jeder Serialisierung, also an der Lesesicht `session_snapshot_json` **und** im produktseitigen `flush_session`. Ohne Store und bei degradiertem Store gilt die Speicherprüfung als **benannter Fallback** (NR-04) |
| **M-23** | Die Mindestzahl unabhängiger Fenster gilt **je beteiligter Quelle** in der Passage, also auch für den Master: `min(kandidat, master) >= GATE_MINDEST_FENSTER` (NR-05). Der Startwert **8 hält** auch nach dieser Verschärfung |
| **M-18, M-19, M-16** | Die Rückabbildung Gruppe → feines Bandintervall ist die **echte Umkehrung** der Gruppierung (`ceil`, nicht `floor`); das beobachtete Band liegt im zurückgegebenen Intervall (NR-06) |
| **M-43, M-46** | `passage_id` ist **Pflichtfeld** des Proposals (`$defs/proposal.required`) — auch für `no_change` und `more_data` (NR-07) |
| **M-59, M-88, M-89** | Der Sender liest den **restaurierten Main-State**, nicht einen Schatten; es gibt genau eine Revisionszählung (NR-08) |
| **M-48** | **E-13 (Nacharbeit 1, 07.09.2026):** Das Experimentziel ist Teil des persistierten Experimentobjekts. Ein mit `ziel` begonnenes Experiment behält sein Ziel über den Brokerneustart; `ziel_geraten` bleibt dem Versuch vorbehalten, der ohne `ziel` begonnen wurde (NR-09) |
| **M-73** | `user_verdict` ist ein persistenzpflichtiger P0 **mit Produktpfad auf beiden Seiten**: Append, Projektion `user_verdicts`, ACK nach dem Append, idempotente Wiederholung über einen Brokerkill (NR-10) |
| **M-71** | Der zugesagte SQLite-Spiegel des **Intents** hat einen Produktpfad: derselbe Ein-Writer-Append wie beim Assistentenschritt, ohne Domänenprojektion, nie autoritativ (NR-11) |
| **M-31, M-66** | Die Schwellensuche bewertet die **neu zugelassene Handlung**. Neu gemessen: niedrigste haltende Stufe **`hoch`** statt `unklar`; das Produkt handelt genau dort. Kein `metrics_version`-Schritt (NR-12, §8.5) |
| **M-64** | Precision und Recall werden je **Soll**-Ursachenklasse ausgewiesen; der Recall-Nenner kommt aus den Sollsitzungen, und eine abweichende Klasse ist ein eigener roter Riegel (NR-13) |
| **M-65** | Der NAK-190-Nachweis gilt nur bei **aufgelöster** Alternativ-ID auf einen Befund der im Korpus deklarierten Distraktorquelle (NR-14) |

### 8.7 Abweichungen dieser Runde, benannt

1. **Zwei Ursachen in einem Commit** (`ef1eebf`): NR-04 (Store-Existenz) und
   NR-05 (Passagengate) teilen den neuen Harnisch in
   `broker/tests/sonde014_nacharbeit1.rs` — NR-04 braucht eine echte
   `evidence`-Zeile, NR-05 eine benannte Passage aus einem
   persistenzpflichtigen `experiment_begin`. Beide brauchen denselben Store;
   sie getrennt zu committen hieße, einen roten Zwischenstand zu übergeben.
   NR-06 liegt im selben Commit, weil die Maskierungsfolge (`8,55 → 8,84 dB`)
   ohne ihn nicht erklärbar wäre.
2. **`sechs_gate_felder_sind_pflicht` misst in zwei Hälften.** In
   `sonde014_proposal.rs` fällt die Zusage an der **Folge** (ohne Passage
   entsteht kein Angebot); das vollständige Sechsergebnis misst der eigene
   Fall `sechs_gate_felder_sind_pflicht_mit_passage` in
   `sonde014_nacharbeit1.rs`. Grund: die Bühne in `sonde014_proposal.rs`
   führt keinen Store, und eine benannte Passage entsteht nur aus einem
   persistenzpflichtigen P0. Der Testzielname bleibt unverändert.
3. **`assistentAntwort` nimmt den Befund als Parameter.** `finding_id` am
   `AssistentSchritt` hat im Main **keinen Produktschreiber** (N-28); ein
   Urteil, das seinen Gegenstand nur aus dem Schritt zöge, entstünde heute
   nie. Die Signatur ist deshalb **erweitert**, nicht umbenannt:
   `assistentAntwort(ergebnis, urteil = nullptr, findingId = {}, notiz = {})`.
   Der genannte Befund gewinnt, der Schritt ist der Rückfall.
4. **NR-04 ist im Selbstaudit ein zweites Mal nachgeschärft worden.** Die erste Fassung hing an `session_snapshot_json` — der **Lesesicht der Beine**. Der Push des Produkts geht durch `flush_session`, und der baut seinen Snapshot direkt unter dem Standlock (`snapshot_locked`); die Härtung lief dort nicht mit. Ein Riegel, der nur an der Lesesicht hängt, ist genau die Sorte Beleg, die `tools/dirigent/pruefliste.md` E ausschließt. Der Nachtrag setzt die Härtung vor den Standlock des Flushes; `der_flush_pfad_haelt_die_belege_ebenfalls_gegen_den_store` misst ihn ohne Evidenzänderung (eine gestiegene Intent-Revision löst den Flush aus), sodass `befunde_eintragen` nicht mitläuft.
5. **Vier Regeln pro Commit statt eine.** NR-07 bis NR-11 liegen in einem
   Satz (`348d15c`), weil `tools/dirigent/pruefliste.md` F Writer, Reader,
   Fixtures und Cross-Language-Verbraucher eines Vertrags im selben
   Änderungssatz verlangt und speichern↔laden dazugehört.

### 8.8 Prüfliste `tools/dirigent/pruefliste.md`, abgehakt für diese Runde

| Abschnitt | Wo in dieser Runde gemessen |
|---|---|
| **A** Rückstau und Prioritätsklassen | NR-02 misst die Koaleszierung am Empfänger (`teilupdate_fremden_schluessels_ueberlebt_eine_koaleszierung`); NR-10 misst `user_verdict` als **nicht** koaleszierenden P0 mit idempotenter Wiederholung über einen Brokerkill |
| **B** Lebenszyklus | NR-09 und NR-11 messen den **Brokerneustart** auf demselben Store: der Versuch samt Ziel überlebt, der Spiegel überstimmt den Main nicht |
| **C** Verträge und Längen | NR-07: `passage_id` in `required`, Negativfixture, A5 an derselben Datei; NR-10: die Urteilsmenge beidseitig (`$defs/user_urteil` ↔ `nakama::state::Userurteil`), Notizlänge 500 beidseitig gedeckelt |
...
## 10. Wiederprüfung 2 und Nacharbeit 3 (07.09.2026)
...
|---|---|
| Prüfer | Codex `gpt-6-astra`, Effort **max**, **lesend** |
| Thread | `01a07b4a-c459-7363-83c9-b8ece4f1d006` |
| `HEAD` vor und nach dem Lauf | `d09a6d72606db2eaed2735cbdc27b3c9c10cb15d` (unverändert, keine eigenen Dateiänderungen) |
| Dauer | 14 min (2026-09-07T11:54:52 bis 12:08:22), `EXIT=0` |
| Geprüfter Diff | `1a9ccbd...d09a6d7` (Variante B, die Fixe der Nacharbeit 2) |
| **Urteil** | **NEEDS_WORK** — WP1-1 bleibt bei mehreren ausstehenden Urteilen offen; zusätzlich verletzt die Zahlenrundung den Wirevertrag. **2 Befunde** |
| Geschlossen bestätigt | **WP1-2 bis WP1-5** (Bestandsgeneration, Re-Subscribe-Härtung, „ohne Passage kein Proposal", Auswertung der Queue-Politik) |
| Rohurteil | `docs/beweise/roh/SONDE-014-wiederpruefung-2-d09a6d7.txt` |
| Auftrag | `docs/beweise/roh/SONDE-014-wiederpruefung-2-auftrag.txt` |
| Nacharbeitsauftrag | `docs/beweise/roh/SONDE-014-nacharbeit-3-auftrag.txt` |
| Startstand der Nacharbeit | `38ef05fa4a00a951abb2f1cd356239fd1827550b`, Worktree sauber |

**Was der Prüfer nicht gemessen hat** (wörtlich aus seinem Urteil): erfolgreiche
Cargo-/Storeläufe wegen Schreibschutz, gekoppelte neue Gegenbeispiele im
Produkt, frischer Nulltest und vollständiger Kanon; die bestehenden
Nulltest-Binaries sind älter als der Fix. Beide Befunde sind **lesend
hergeleitet** — die Nacharbeit 3 hat beide an der Quelle nachvollzogen.

### 10.2 Einordnung des Dirigenten

**Zwei Defekte, keine Lücke.** Beide sind an der Quelle geprüft: WP2-1 ist der
unerzwungene Einzelwert im Prozessor, WP2-2 ein Rechenfehler in der Rundung
der Vorrunde. Der Dirigent hat WP2-2 in Rust nachgerechnet:
`10f64.powi(14 - exponent)` ist ab `exponent <= -9` selbst ungenau —
`2.7e-11` und `5.55e-12` ergeben je 17 Stellen, und von 100 000 vorher
gültigen Kleinwerten aus `1e-15…1e-9` werden **34 535** vertragswidrig. Der
Wortlaut beider Regeln WN3-01 und WN3-02 steht in
`docs/beweise/roh/SONDE-014-nacharbeit-3-auftrag.txt`.

### 10.3 Zuordnung: Befund → Regel → geänderte Stelle → Rotbeweis

| Befund | Zusage | Regel und was gebaut wurde | Gemessen an | Rotbeweis |
|---|---|---|---|---|
| **WP2-1** | M-73, §9.6 (M-73 „Nacharbeit 2") | **WN3-01** — der Wiederholungsinhalt eines `user_verdict` liegt **je `command_id`** vor, gedeckelt auf `nakama::ipc::kCapP0` (64). Die Vorrunde hielt einen Einzelwert mit der Begründung „zwei gleichzeitig offene gibt es nicht"; erzwungen war das nirgends. Zwei `assistentAntwort(…, &urteil, …)` vor dem ersten ACK überschrieben den ersten Mitschnitt, `urteilMitFrischemKopf` lieferte danach wegen der abweichenden Kennung einen leeren Text, und `ControlClient.cpp` entfernte das unpersistierte Urteil endgültig. Ein Eintrag entsteht beim Erzeugen und fällt erst, wenn der Auftrag das In-Flight-Register verlässt: der neue `setzeAuftragAbgeschlossenHook` meldet `angewandt`, `idempotent_wiederholt` und den endgültigen Fehlschlag — eine **Wiederholung** meldet nichts | `Sonde014AssistentTest.cpp` Abschnitt „WN3-01" (**B29**, am echten Hookrumpf `urteilMitFrischemKopf`: zwei ausstehende Urteile, Kennung/Befund/Revision/Urteil des ersten, Freigabe durch den Abschluss, Deckel und Verdrängung des ältesten) und `IpcTestMain.cpp::zwei_ausstehende_urteile_melden_ihren_abschluss_je_kennung` sowie `::ein_angewandter_auftrag_meldet_seinen_abschluss_genau_einmal` (**B10**, am echten Draht) | `roh/SONDE-014-rot-WN3-01.txt` |
| **WP2-2** | M-77, §9.4 (N-30), Exit-Gate | **WN3-02** — die 15-Stellen-Grenze greift an der **serialisierten Dezimaldarstellung**. `eqcop_broker::vertrag::wire_zahl` (Spiegel von `nakama::wire::wireZahl`) formatiert mit höchstens 15 signifikanten Stellen und parst zurück; die letzte Entscheidung fällt `textriegel_bytes` **selbst**, auf genau den Bytes, die `serde_json` schreiben wird — zwei Regelsätze für dieselbe Grenze waren die Ursache. `auf_wirestellen` entfällt; `zahl()` in `hypothese_verdrahtung.rs` **und** in `proposal_verdrahtung.rs` laufen durch dieselbe Funktion. Das Proposal hatte bis hierher **gar keinen** Deckel | `sonde014_nacharbeit3.rs` (**A4**): Eigenschaftstest über 30 000 Werte aus drei Bändern, die Wertetabelle mit Gegenprobe der alten Rundung, und der Produktpfad mit Re-Subscribe samt Gegenprobe. Dreisprachig an der Byteinstanz `evidenz-zahlen-wire-v1.json`: **B3c** (141, von 136), **A5** (598) und `contract_cross_language.rs`, das seit dieser Runde auch den **Erzeuger** hält | `roh/SONDE-014-rot-WN3-02.txt` |

### 10.4 Das f64-Feldinventar (WN3-02)

Erhoben mit `rg 'zahl\(|as_f64|f64'` über `hypothese_verdrahtung.rs`,
`sicht.rs`, `proposal_verdrahtung.rs` und `maskierung.rs`. **Neunzehn** Felder
gehen als `f64` auf den Draht; jedes läuft durch `wire_zahl`:

| Objekt | Felder | Weg |
|---|---|---|
| **Befund** (`befund_json`) | `beobachtung.wert_db`, `rang.bandpassung`, `.koinzidenz`, `.uplift`, `.intent_relevanz`, `.wiederholbarkeit`, `.routingqualitaet`, `confidence.score` (8) | `hypothese_verdrahtung.rs::zahl` → `wire_zahl` |
| **Maskierung** (am Befund, M-36/M-40) | `maskierung.wert_db` (1) | derselbe Weg |
| **Proposal** (`proposal_json`) | `confidence.score`, `parameters.frequency_hz`, `.q`, `.max_gain_db`, `allowed_bounds.{frequency_hz,q,gain_db}.{von,bis}` (10) | `proposal_verdrahtung.rs::zahl`/`zahl_wert` → `wire_zahl` |

**Was bewusst nicht durch `wire_zahl` läuft, und warum** — das ist die Antwort
auf die offene Hälfte von N-30:

* **Bandindizes und Revisionen** (`band_hz.von/bis`, `maskierung.band_von/bis`,
  `intent_revision`) sind `u32`/`i64`. Eine Ganzzahl trifft Regel 4 nie.
* **`f32`-Felder** (`passage.abdeckung`, die Fingerprintreihen, `lufs_*`)
  serialisiert `serde_json` mit dem `f32`-Ryu — höchstens **neun**
  signifikante Stellen. Der Deckel wäre wirkungslos.
* **Vom Draht gelesene `f64`** (`match_gain_db`, die Guardrailwerte des
  Experiments) kamen aus einem Text, den der Riegel bereits angenommen hat;
  ihre kürzeste Rückschreibform ist damit ebenfalls höchstens 15-stellig. Sie
  werden durchgereicht, nicht gerechnet — der Unterschied ist der Grund,
  warum Befund, Maskierung und Proposal die drei Familien sind.
* **`MessframeSicht.sample_rate`/`fenster_ms`** sind Felder einer
  **Rust-Lesesicht** ohne `Serialize`; sie erreichen keinen Wire-Pfad.

### 10.5 Die Beine, gemessen

Nur die **betroffenen** Beine — kein voller Kanon; der läuft beim
Ticketabschluss. Betroffen ist, was der Diff dieser Runde berührt:
`broker/src` (`vertrag.rs`, `hypothese_verdrahtung.rs`,
`proposal_verdrahtung.rs`), die v3-Fixtures sowie `ControlClient` und
`PluginProcessor` — und damit **jedes** C++-Bein, das sie baut. Rohprotokoll:
`docs/beweise/roh/SONDE-014-nacharbeit-3-1c736ab.txt`, gefahren auf sauberem
Baum auf dem Endstand `1c736ab`, **alle grün**. Alle C++-Binaries sind
unmittelbar davor mit geprüftem Exitcode gebaut worden (N-29).

**Die Menge ist gegenüber der Vorrunde größer.** `git grep -n
'src/PluginProcessor.cpp' eq-copilot/plugin/CMakeLists.txt` nennt vierzehn
Ziele; die Nacharbeit 2 hatte davon fünf nicht gefahren. Dazu gehört der
**Nulltest**, den der Prüfer in seinem „Nicht geprüft" ausdrücklich benannt
hat. A1, A3, B5, B8 und B23 laufen deshalb in dieser Runde mit.

**Was diese Auswahl NICHT sagt.** `core/ipc/ControlClient.cpp` liegt in
`NakamaKern`, und die Bibliothek bindet jedes Plugin-Bein über
`nakama_kern_anbinden` — formal baut ihn also der ganze Kanon. Gefahren sind
hier die Beine, die den Prozessor oder den v3-Steuerpfad wirklich **benutzen**;
der vollständige Kanon läuft beim Ticketabschluss, wie der Auftrag es
vorsieht.

| Bein | Was | Zahl |
|---|---|---|
| **A1** | `EqCopNullTest` | `NULLTEST OK` — der Prüfer hatte ihn ausdrücklich als **nicht gemessen** benannt („die bestehenden Nulltest-Binaries sind älter als der Fix"); er ist neu gebaut und gefahren |
| **A3** | `EqCopMarkierungTest` | `MARKIERUNGSTEST OK` |
| **A4** | `cargo test --manifest-path broker/Cargo.toml` | **645** Prüfungen in **28** Binaries, 0 Fehler (von 642 in 27) |
| **A4-SI** | `store_crash_matrix -- --ignored` | 22 Prüfungen, 0 Fehler |
| **A5** | `pruefe_v3_vertrag.py --abdeckung` | 598 Prüfungen, 0 gescheitert |
| **A8** | `erzeuge_v3_fixtures.py --pruefen` | 392 Dateien bytegleich, MANIFEST `sha256=3af1831…` |
| **B1** | `EqCopIdentityTest` | 120 Prüfungen, 0 Fehler |
| **B2** | `EqCopStateMigrationTest` | 180 Prüfungen, 0 Fehler |
| **B3c** | `EqCopSchemaTest` | **141** bestanden, 0 gescheitert (von 136 — die fünf neuen Zahlklassen) |
| **B4** | `EqCopQueueStressTest` | 121 Prüfungen, 0 Fehler |
| **B5** | `EqCopAnalysisGoldenTest` | 248 bestanden, 0 Fehler |
| **B8** | `EqCopLebenslaufTest` | 79 Prüfungen, 0 Fehler |
| **B10** | `EqCopIpcTest` | **374** Prüfungen, 0 Fehler (von 372 — die zwei neuen Fälle am echten Draht) |
| **B13** | `EqCopSonde012SourcesModelTest` | 79/79 grün |
| **B14** | `EqCopSonde012ProjectReloadTest` | 12/12 grün |
| **B23** | `EqCopSonde013PassageStateTest` | 343 bestanden, 0 gescheitert |
| **B27** | `EqCopSonde014IntentTest` | 210 Prüfungen, 0 Fehler |
| **B28** | `EqCopSonde014BefundTest` | 60/60 grün |
| **B29** | `EqCopSonde014AssistentTest` | **183/183** grün (von 167 — der Abschnitt WN3-01) |

Neu in dieser Runde: `broker/tests/sonde014_nacharbeit3.rs` mit **3** Fällen
(einer davon dreiteilig), fünf Klassen in `evidenz-zahlen-wire-v1.json` und
die Erzeugerhälfte in `contract_cross_language.rs`.

### 10.6 Matrixzeilen, in dieser Runde nachgezogen

Die alte Fassung bleibt als Verlauf stehen; der Nachtrag steht darunter und
ist als **Nacharbeit 3** markiert.

| Zeile | Nachtrag |
|---|---|
| **M-73** | **Nacharbeit 3 (WN3-01):** der Mitschnitt für die Konfliktwiederholung liegt **je `command_id`** vor, nicht als Einzelwert — gedeckelt auf die 64 P0-Plätze, eingetragen beim Erzeugen, freigegeben erst bei `angewandt`, `idempotent_wiederholt` oder endgültigem Fehlschlag. Der Nachtrag der Vorrunde („ein `konflikt`-ACK ist kein endgültiger Verlust") gilt damit für **jedes** ausstehende Urteil, nicht nur für das zuletzt abgesetzte. Der Rückweg dafür ist `ControlClient::setzeAuftragAbgeschlossenHook`; eine Wiederholung meldet nichts, denn der Auftrag läuft dann noch |
| **M-77** | **Nacharbeit 3 (WN3-02):** dieselbe Grenze, **eine** Regel — und sie gilt dem TEXT. C++ (`nakama::wire::wireZahl`) und Python (`erzeuge_v3_fixtures.py::wire_zahl`) deckelten die serialisierte Dezimaldarstellung, Rust rundete numerisch: dieselbe Zusage in zwei Auslegungen, und die Rustfassung hielt sie für Kleinwerte nicht. `eqcop_broker::vertrag::wire_zahl` ist die dritte Hälfte; sie entscheidet am fertigen Text und gegen `textriegel_bytes` selbst. Die Sprachparität wird seit dieser Runde auch am **Erzeuger** gemessen, nicht nur am Leser |

Fortgeschrieben wird außerdem **N-30** in §7.11: die dort offen gelassene
Frage nach weiteren Zahlenwegen ist mit dem Inventar in §10.4 beantwortet.

### 10.7 Abweichungen dieser Runde, benannt

1. **Der B10-Fall fährt den Prozessorhook nicht selbst.** Der Auftrag verlangt
   den Fall „über den echten Hook (`urteilMitFrischemKopf`, nicht eine
   Test-Lambda)". `EqCopIpcTest` linkt `juce_core` und `NakamaKern` — **keinen
   Prozessor**; ihn dort verfügbar zu machen hieße, das CMake-Ziel um
   `juce_audio_utils`, `juce_dsp`, `PluginEditor` und `AnalyseEngine` zu
   erweitern, also genau den Neben-Refactor, den der Auftrag verbietet. Der
   echte Hookrumpf läuft deshalb in **B29** (dort lebt der Prozessor), und B10
   misst die Hälfte, die nur er messen kann: dass der ControlClient den
   Abschluss **je Kennung** meldet und eine Wiederholung nicht. Beide Hälften
   zusammen tragen die Regel; keine allein.
2. **Der Kleinwertfall (c) setzt seine Zahlen in die gespeicherte Projektion,
   statt sie zu rechnen.** Die Bandwerte des Wire-Encodings `q_db_0p1_i16`
   sind geklemmt, und `bandpassung` hat deshalb in **jeder** Bühne dieses
   Korpus einen Boden bei `1/217` ≈ `4,6e-3` — gemessen über Breitbandsockel
   bis 120 dB und Anomaliehübe bis −150 dB. Die Größenordnung `1e-11` entsteht
   am echten Rechenweg erst mit einer Dynamik, die dieser Korpus nicht trägt.
   Der Fall setzt sie deshalb ein, **mit genau der Funktion, die die Zusage
   trägt**, und sagt das an Ort und Stelle. Abschnitt A desselben Falls misst
   den vollen Produktpfad an dem, was die Bühne wirklich liefert: eine
   gerechnete `bandpassung` mit **sechzehn** signifikanten Stellen, die ohne
   Deckel am Riegel fällt. Abschnitt C ist die Gegenprobe — dieselbe
   Projektion mit der alten Rundung wird **nicht** ausgeliefert.
3. **`wire_zahl` liegt in `broker/src/vertrag.rs`, nicht in einer eigenen
   Datei.** Der Auftrag sagt „Ort neben `vertrag.rs`, damit Vertrag und Deckel
   beieinander liegen". Dieselbe Datei ist das Maximum an „beieinander": die
   Funktion entscheidet ihren letzten Schritt gegen `textriegel_bytes`, und
   ein zweites Modul hätte diese Bindung nur verlängert.
4. **Der Deckel gilt jetzt auch dem Proposal.** WN3-02 nennt „`zahl()` und
   ALLE f64-Felder des Befunds, der Maskierung und des Proposals";
   `proposal_verdrahtung.rs` führte ein **eigenes** `zahl()` ohne jeden
   Stellendeckel. Das ist kein zusätzlicher Punkt, sondern dieselbe Ursache an
   der zweiten Stelle — beide Funktionen rufen jetzt dieselbe.
5. **`textriegel_bytes` prüft `signifikante_stellen > MAX_SIGNIFIKANT` statt
   `> 15`.** Eine Konstante statt einer Ziffer, weil Deckel und Riegel nun in
   derselben Datei stehen und dieselbe Zahl meinen. Kein Verhaltenswechsel.

### 10.8 Prüfliste `tools/dirigent/pruefliste.md`, abgehakt für diese Runde

| Abschnitt | Wo in dieser Runde gemessen |
|---|---|
| **A** Rückstau und Prioritätsklassen | **WN3-01** ist die Fortsetzung der WN-05-Zeile: der abgewiesene oder konfliktbehaftete Auftrag bleibt im Register — und sein Wiederholungsinhalt jetzt auch. Der Deckel des Mitschnitts ist dieselbe Zahl wie die Kapazität der Queue, nicht eine zweite Politik |
| **B** Lebenszyklus | **WN3-01**: `erzeugen ↔ freigeben` liegen in einem Satz. Ein Eintrag entsteht mit dem Urteil und fällt mit dem ACK, das den Auftrag abschließt; eine Wiederholung schließt ihn nicht ab, und der Test misst genau diesen Unterschied (B10, „genau einmal") |
| **C** Verträge und Längen | **WN3-02**: „NaN/Inf/Grenzwerte an jeder Zahl, die über den Draht geht" — hier die vierte Regel des Textriegels an **jedem** der 19 f64-Felder, und die Byteinstanz misst sie in allen drei Sprachen |
| **D** Bau- und Prüfriegel | N-29 bleibt die benannte Landmine: alle C++-Beine dieser Runde sind nach einem `cmake --build` mit **geprüftem Exitcode** gefahren, und das Rohprotokoll trägt je Bein den Zeitstempel des gemessenen Binaries |
| **E** Behauptung ≤ Messung | Beide Regeln haben ihren Rotbeweis, und jeder fällt an der Zeile, die die Zusage trägt: WN3-01 an „das ERSTE Urteil ist nach dem zweiten noch wiederholbar", WN3-02 an „`2.6999999999999997e-11` trägt 17 signifikante Stellen" und „eine Projektion mit Rangkomponenten um 1e-11 wird ausgeliefert". Der WN3-01-Beweis benennt ausdrücklich die Zeilen, die **grün bleiben** — sie sind Wachen, kein Beleg |
| **F** Änderungssatz | Sender und Rückweg in einem Satz (WN3-01: `ControlClient`, `PluginProcessor`, B10, B29); Erzeuger, Riegel, Fixture und alle drei Sprachverbraucher ebenfalls (WN3-02: `vertrag.rs`, beide Verdrahtungen, `erzeuge_v3_fixtures.py`, A5, B3c, `contract_cross_language.rs`) |
---

## 11. Wiederprüfung 3, Konvergenzentscheid und Konvergenzrunde (07.09.2026)
...
|---|---|
| Prüfer | Codex `gpt-6-astra`, Effort **max**, **lesend** |
| Thread | `01a07ba0-5ab5-7f93-8cc3-f6ce2289bf81` |
| `HEAD` vor und nach dem Lauf | `0f595a2e5f56797d86de3d5dcf21e2ba74680bf4` (unverändert, auch der Worktree) |
| Dauer | 9 min (2026-09-07T13:28:21 bis 13:37:46), `EXIT=0` |
| Geprüfter Diff | `38ef05f...0f595a2` (Variante B, die Fixe der Nacharbeit 3) |
| **Urteil** | **NEEDS_WORK** — WP2-1 bleibt bei Sättigung offen. **1 Befund** |
| Geschlossen bestätigt | **WP2-2** (der Wire-Deckel am TEXT: `broker/src/vertrag.rs`, die Aufrufer in `hypothese_verdrahtung.rs` und `proposal_verdrahtung.rs`, gemessen von `sonde014_nacharbeit3.rs` und `contract_cross_language.rs`) |
| Rohurteil | `docs/beweise/roh/SONDE-014-wiederpruefung-3-0f595a2.txt` |
| Auftrag | `docs/beweise/roh/SONDE-014-wiederpruefung-3-auftrag.txt` |
| Auftrag der Konvergenzrunde | `docs/beweise/roh/SONDE-014-konvergenzrunde-auftrag.txt` |
| Startstand der Konvergenzrunde | `7cc79d73b274434d1c9dd24fec71445da3a38ded`, Worktree sauber |

**Was der Prüfer gemessen hat:** 43 Rust-Tests über vorhandene Binaries, B10
374/374, B29 183/183, Schema-, Identitäts-, State-/Golden-, Null- und
Audio-/Queue-Tests; A5 598 Prüfungen und A8 392 Dateien bytegleich unter
Python 3.14; die Python-Spiegelprobe erhielt 99 977 zuvor vertragsgültige
Werte unverändert.

**Was er nicht gemessen hat** (wörtlich): „erfolgreicher Cargo-/SQLite-Re-Subscribe-Lauf
wegen Schreibschutz, Python 3.13 wegen Startfehler, gekoppelter
Sättigungs-/ACK-Gegenbeweis und vollständiger Kanon/G5/FL-Lauf". Der offene
Befund ist **lesend hergeleitet**; die Konvergenzrunde hat ihn an der Quelle
nachvollzogen und mit dem Rotbeweis in §11.4 auch gemessen.

### 11.2 Der Konvergenzentscheid des Dirigenten, wörtlich

Das Rundenbudget von drei Nacharbeitsrunden ist verbraucht (Nacharbeit 1 →
Wiederprüfung 1: 5 Befunde; Nacharbeit 2 → Wiederprüfung 2: 2 Befunde;
Nacharbeit 3 → Wiederprüfung 3: 1 Befund). Der Dirigent hat den einen
verbliebenen Befund an der Quelle und am wörtlichen Matrixtext eingeordnet
und die Konvergenzrunde beauftragt. Aus
`docs/beweise/roh/SONDE-014-konvergenzrunde-auftrag.txt`:

> **WP3-1 (Rest von WP2-1/WP1-1/EP-10)** — „WP2-1 bleibt bei Sättigung offen:
> Nach 65 `assistentAntwort(..., &urteil, ...)` ohne ACK wird der erste
> Mitschnitt gelöscht, obwohl dessen Auftrag weiter aussteht. Die 64
> Queueplätze begrenzen nicht `inFlight`: Geschriebene Aufträge bleiben bis
> zum ACK registriert, und selbst bei Queueüberlauf hält
> `sendePersistenzP0()` den zusätzlichen Auftrag
> (`ControlClient.cpp:1212–1234`). Ein späteres `konflikt`-ACK der ersten
> Kennung bekommt deshalb einen leeren Wiederholungstext und entfernt das
> unpersistierte Urteil endgültig (`ControlClient.cpp:1333–1364`). Das
> verletzt M-73/WN3-01 „Freigabe erst nach Abschluss". Der ausgeführte
> B29-Test bestätigt diese vorzeitige Löschung sogar als Sollverhalten
> (`Sonde014AssistentTest.cpp:1029–1039`)."
> (eq-copilot/plugin/src/PluginProcessor.cpp:2039-2056: Deckel `kCapP0` auf
> `urteilMitschnitte`, Verdrängung des ältesten; Dirigent an der Quelle
> bestätigt.)
>
> **Einordnung: DEFEKT.** Gebrochen ist der Matrixnachtrag zu M-73 aus §10.6
> (WN3-01: „Eintrag beim Erzeugen, Löschung erst bei `angewandt`,
> `idempotentWiederholt` oder endgültigem Fehlschlag"), sowie der
> Rotbeweisteil von M-73 („nie stillschweigend gelöscht") und die
> CLAUDE.md-Invariante „State bleibt verlustfrei"; ein Test (B29 „verdrängt
> wird der ÄLTESTE") misst den Bruch als Soll. Der Deckel „64 P0-Plätze"
> stammt aus der Regel WN3-01 des Dirigenten und war falsch: die
> P0-Kapazität begrenzt die Queue, nicht das In-Flight-Register.
>
> **Ursache (nicht Punktkorrektur):** Derselbe ausstehende Auftrag lebt in
> ZWEI Registern mit getrennten Deckeln — `inFlight` im ControlClient (ohne
> Deckel, Auftragstext liegt dort) und `urteilMitschnitte` im Prozessor
> (gedeckelt). Das ist die „zweite still konkurrierende Wahrheit" aus M-71.
>
> **Entscheid E-15 (Technik, Dirigent):** Es gibt genau EIN Register für
> ausstehende persistenzpflichtige Aufträge — das In-Flight-Register des
> ControlClient. Der Wiederholungsinhalt für den frischen Kopf wird aus dem
> dort gehaltenen Auftrag gewonnen (der gespeicherte `json` trägt alle
> Felder; für die Wiederholung wird ausschließlich `kopf.base_revision` durch
> die zuletzt gemeldete Revision ersetzt — entweder durch Neubau des Kopfes
> aus dem gespeicherten Text oder durch ein Feld am In-Flight-Eintrag, das
> der Hook liest). Das separate Register `urteilMitschnitte` samt Deckel
> entfällt. Ein Eintrag lebt bis `angewandt`, `idempotentWiederholt` oder
> endgültigem Fehlschlag nach dem Versuchsdeckel (drei Versuche, §9.6). Eine
> Zulassungsgrenze für neue persistenzpflichtige Aufträge, falls nötig,
> greift VOR dem Erzeugen (Abweisung nach M-73-Politik, WN-05: Rückgabewert
> `false`, `beiP0Verworfen`), nie durch Verdrängen eines offenen Auftrags.

**E-15 steht damit als sechzehnter Entscheid dieses Tickets** neben E-01 bis
E-14. Er ist der einzige, der eine Regel einer Vorrunde ausdrücklich als
**irrig** zurücknimmt: der Deckel „64 P0-Plätze" aus WN3-01 (§10.6).

### 11.3 Zuordnung: Befund → Regel → geänderte Stelle → Rotbeweis

| Befund | Zusage | Regel und was gebaut wurde | Gemessen an | Rotbeweis |
|---|---|---|---|---|
| **WP3-1** | M-73, §10.6 (M-73 „Nacharbeit 3"), M-71 („kein Objekt besitzt zwei still konkurrierende Wahrheiten"), CLAUDE.md „State bleibt verlustfrei" | **KR-01** (Umsetzung von E-15) — der Prozessor hält **kein** Register mehr. `Urteilmitschnitt`, `urteilMitschnitte`, `urteilMutex`, `urteilAbgeschlossen` und die zwei Testhaken sind fort; der Prozessor setzt `setzeAuftragAbgeschlossenHook` nicht mehr (N-33). Der Wiederholungsinhalt kommt aus dem Auftrag, den `inFlight` ohnehin hält: die neue freie Funktion `nakama::ipc::auftragMitBasisRevision` ersetzt darin **genau die eine Zahl**, die der Broker abgelehnt hat, und lässt alles andere bytegleich. `urteilMitFrischemKopf` nimmt den Auftragstext als Parameter und ist damit **zustandsfrei** — es gibt nichts mehr zu deckeln und nichts freizugeben. Die **Politik** bleibt im Prozessor: wiederholt wird ein `user_verdict`, weil ein Userurteil nicht verloren gehen darf (M-73/E-09); ein fremder Befehlstyp bekommt keinen frischen Kopf | **(a)** `Sonde014AssistentTest.cpp` Abschnitt „KR-01" (**B29**, am echten Hookrumpf): `kCapP0 + 4` Urteile ohne ACK, **68 von 68** einzeln wiederholbar, das erste wie das letzte unter der eigenen Kennung; Bytegleichheit bis auf `base_revision`; fremder Befehlstyp und fremde Kennung fallen. **(b)** `IpcTestMain.cpp::kr01_*` (**B10**, am echten Draht): `kCapP0 + 1` gleichzeitig ausstehende Aufträge, `konflikt` auf die **ERSTE** Kennung, Wiederholung mit frischem Kopf unter derselben Kennung, `angewandt` gibt frei (`inFlight` 65 → 64, genau eine Meldung), die übrigen 64 unberührt; dazu **acht Ränder** von `auftragMitBasisRevision`, alle fail-closed. **(c)** die bestehenden WN3-01-Fälle in B10 bleiben grün | `roh/SONDE-014-rot-KR-01.txt` |

### 11.4 Der Rotbeweis, und was er NICHT sagt

Der alte Deckel mit Verdrängung ist auf dem Fixstand `2ef235e` an **beiden**
Stellen wieder eingesetzt worden: (A) als zweites, gedeckeltes Register der
ausstehenden Kennungen im Prozessor — die Fassung der Nacharbeit 3, reduziert
auf das, was die Zusage trägt; (B) als derselbe Deckel auf das **eine**
Register angewandt, in `sendePersistenzP0`. Beide Beine fallen, und zwar an
den Zeilen, die die Zusage tragen:

| Bein | Zahl | Rote Zeilen |
|---|---|---|
| **B29** | 181/185 (statt 185/185) | „das ERSTE von `kCapP0 + 4` ist noch wiederholbar - nichts wurde verdraengt" · „jedes unter SEINER eigenen `command_id`" · „ALLE `kCapP0 + 4` ausstehenden Auftraege sind wiederholbar (**64 von 68**)" · „auch das aelteste offene Urteil ueberlebt die Saettigung" |
| **B10** | 4 Fälle rot | `kr01_kcap_plus_eins_auftraege_stehen_gleichzeitig_aus` [**64 im Register**] · `kr01_der_erste_auftrag_wird_mit_frischem_kopf_wiederholt` [**leerer Wiederholungstext**] · `kr01_erst_angewandt_gibt_den_ersten_auftrag_frei` [0 gemeldet] · `kr01_die_uebrigen_auftraege_bleiben_unberuehrt` |

**Die Zahl benennt den Bruch:** der Deckel verdrängt genau die vier ältesten
von 68, und im Register stehen 64 statt 65. Das ist das Verhalten aus WP3-1,
nicht irgendein Fehlschlag.

**Was grün bleibt, ist kein Beleg** (Prüfliste E). Die drei
`kr01_wire_*`-Zeilen messen die Textfunktion selbst, nicht das Register; in
B29 bleiben der Zwei-Urteil-Fall und „und das LETZTE ebenso" grün — zwei
Aufträge reißen keinen 64er-Deckel, und der letzte ist der, den ein Deckel
gerade **nicht** verdrängt. Alle drei sind Regressionswachen. Der Rotbeweis
benennt sie ausdrücklich.

### 11.5 Die Beine, gemessen

Nur die **betroffenen** Beine — kein voller Kanon; der läuft beim
Ticketabschluss. Der Diff dieser Runde berührt `ControlClient` und
`PluginProcessor`, also **jedes C++-Bein, das den v3-Steuerpfad baut oder
benutzt**; die Liste ist die aus §10.5 ohne die Beine ohne Bezug. **Kein
Rust-, Schema- oder Fixturediff** — A4, A4-SI, A5, A8 und B3c sind in dieser
Runde nicht betroffen und nicht gefahren. Rohprotokoll:
`docs/beweise/roh/SONDE-014-nacharbeit-4-2ef235e.txt`, gefahren auf dem
Endstand `2ef235e`, **alle grün**. Alle Binaries sind unmittelbar davor mit
geprüftem Exitcode gebaut worden (N-29); das Protokoll trägt je Bein den
Zeitstempel des gemessenen Binaries.

| Bein | Was | Zahl |
|---|---|---|
| **A1** | `EqCopNullTest` | `NULLTEST OK` |
| **A3** | `EqCopMarkierungTest` | `MARKIERUNGSTEST OK` |
| **B1** | `EqCopIdentityTest` | 120 Prüfungen, 0 Fehler |
| **B2** | `EqCopStateMigrationTest` | 180 Prüfungen, 0 Fehler |
| **B4** | `EqCopQueueStressTest` | 121 Prüfungen, 0 Fehler |
| **B5** | `EqCopAnalysisGoldenTest` | 248 bestanden, 0 Fehler |
| **B8** | `EqCopLebenslaufTest` | 79 Prüfungen, 0 Fehler |
| **B10** | `EqCopIpcTest` | **381** Prüfungen, 0 Fehler (von 374 — drei Randfälle der Wire-Funktion und vier Fälle der Sättigung) |
| **B13** | `EqCopSonde012SourcesModelTest` | 79/79 grün |
| **B14** | `EqCopSonde012ProjectReloadTest` | 12/12 grün |
| **B23** | `EqCopSonde013PassageStateTest` | 343 bestanden, 0 gescheitert |
| **B27** | `EqCopSonde014IntentTest` | 210 Prüfungen, 0 Fehler |
| **B28** | `EqCopSonde014BefundTest` | 60/60 grün |
| **B29** | `EqCopSonde014AssistentTest` | **185/185** grün (von 183 — der Abschnitt KR-01 ersetzt den Deckelteil von WN3-01) |

### 11.6 Matrixzeilen, in dieser Runde nachgezogen

Die alte Fassung bleibt als Verlauf stehen; der Nachtrag steht darunter und
ist als **Konvergenzrunde** markiert.

| Zeile | Nachtrag |
|---|---|
| **M-73** | **Konvergenzrunde (KR-01, Entscheid E-15):** es gibt genau **EIN** Register für ausstehende persistenzpflichtige Aufträge — das In-Flight-Register des ControlClients. Der Wiederholungsinhalt eines `user_verdict` kommt aus dem dort gehaltenen Auftrag; ersetzt wird ausschließlich `kopf.base_revision`. Ein Eintrag lebt bis `angewandt`, `idempotent_wiederholt` oder endgültigem Fehlschlag nach dem Versuchsdeckel — **ein offener Auftrag wird nie verdrängt**. Eine Zulassungsgrenze, falls je nötig, greift **vor** dem Erzeugen (Abweisung nach WN-05: Rückgabewert `false`, `beiP0Verworfen`). ⚠️ **Der Deckel „64 P0-Plätze" aus dem Nachtrag der Nacharbeit 3 (§10.6) ist hiermit als IRRIG zurückgenommen:** die P0-Kapazität begrenzt die Queue, nicht das In-Flight-Register — geschriebene Aufträge bleiben bis zum ACK registriert, und selbst bei Queueüberlauf hält `sendePersistenzP0` den zusätzlichen Auftrag. Die alte Fassung bleibt als Verlauf lesbar, ist aber keine Vorgabe mehr |
| **M-71** | **Konvergenzrunde:** die Zeile verbietet, dass ein Objekt „zwei still konkurrierende Wahrheiten" besitzt. WP3-1 war genau dieser Fall auf der **Main-Seite**, nicht zwischen Main und Store: derselbe ausstehende Auftrag lebte in `ControlClient::inFlight` **und** in `PluginProcessor::urteilMitschnitte`, mit getrennten Lebenszyklen und getrennten Deckeln. Zwei Register bedeuten zwangsläufig, dass eines das andere überlebt. Die Zeile gilt seit dieser Runde ausdrücklich auch **innerhalb** einer Seite, nicht nur zwischen den beiden Wahrheitsorten aus §33.5 |

### 11.7 Abweichungen dieser Runde, benannt

1. **Es gibt KEINE Zulassungsgrenze bei `kCapP0`.** E-15 lässt sie zu („falls
   nötig"), die Messung schließt sie aus: der geforderte Fall (a) verlangt,
   dass `kCapP0 + 4` Aufträge ausstehen **und alle wiederholbar bleiben** —
   eine Grenze bei 64 würde die Aufträge 65 bis 68 abweisen und genau die
   Zeile brechen, die die Zusage trägt. `inFlight` bleibt damit
   unbeschränkt; das war es vor dieser Runde auch, und der Prüfer hat es
   nicht als Defekt geführt, sondern als Argument benutzt. Wächst es je zu
   einem Problem, greift die Grenze nach E-15 **vor** dem Erzeugen, nie
   durch Verdrängen.
2. **`setzeAuftragAbgeschlossenHook` hat keinen Produktkonsumenten mehr.**
   Sein einziger Zweck war die Freigabe des zweiten Registers. Er bleibt als
   Meldeschiene des ControlClients bestehen, weil er die einzige Stelle ist,
   an der **je Kennung** sichtbar wird, dass ein Auftrag sein Register
   verlässt — und der Auftrag der Konvergenzrunde verlangt ausdrücklich, dass
   die bestehenden WN3-01-Fälle grün bleiben. Als **N-33** in §7.11 geführt.
3. **Der B10-Fall braucht zwei neue Schalter im Testdouble**
   (`V3TestServer::ackNurFuer` und `ackNachtragen`). Ohne sie quittierte der
   Server **jeden** Auftrag sofort beim Empfang — es stand nie mehr als einer
   aus, und der Sättigungsfall war am echten Draht gar nicht herstellbar.
   Genau diese Lücke im Testdouble ist der Grund, warum WP3-1 drei Runden
   überlebt hat: die Zusage „ein offener Auftrag verliert nie seine
   Wiederholungsdaten" war nie **unter Sättigung** gemessen worden. Der Fall
   wartet außerdem nach jedem Send, bis der Server den Auftrag gesehen hat —
   sonst läuft die 64er-Queue voll, der Client bricht nach WN-05 ab, und der
   Test misst einen Überlauf statt der Registersättigung.
4. **Drei tote Parameter der Vorrunde fallen mit derselben Ursache.**
   `v3UserVerdictJson` nahm eine `commandIdVorgabe` und eine `baseRevision`,
   `versuchKopfJson` eine `baseRevision` — alle drei existierten
   ausschließlich für den Neubau des Wiederholungstextes. Nach E-15 hatte
   keiner von ihnen noch einen Aufrufer; ihre Doku hätte eine Zusage
   behauptet, die der Code nicht mehr hält (Prüfliste E). Kein Neben-Refactor,
   sondern das Ende derselben Änderung.
5. **Die Zählzeile in §7.11 war falsch** („29 Zeilen: 18 behoben, 11 offen"
   bei tatsächlich 32 Zeilen) und **N-30 fehlte** in der Aufzählung der
   behobenen. Beim Eintragen von N-33 an der Tabelle nachgezählt: **33
   Zeilen, 19 behoben, 14 offen**.
6. **`auftragMitBasisRevision` liegt in `ControlClient.h/.cpp`, nicht im
   Prozessor.** Sie ist eine Textoperation am Wire-Auftrag und braucht kein
   Prozessorwissen; dort liegen auch `commandIdAusAuftrag` und
   `commandAckArtLesen`, deren fail-closed-Muster sie übernimmt. Der Gewinn
   ist die Messung: **B10 ruft die echte Funktion**, nicht eine Nachbildung
   im Test — die bestehenden Hook-Lambdas der Nacharbeiten 2 und 3 bildeten
   die Ersetzung bis hierher mit `find`/`replace` nach.

### 11.8 Prüfliste `tools/dirigent/pruefliste.md`, abgehakt für diese Runde

| Abschnitt | Wo in dieser Runde gemessen |
|---|---|
| **A** Rückstau und Prioritätsklassen | „nie stillschweigend Akzeptiertes löschen" — hier zum ersten Mal **unter Sättigung** gemessen: `kCapP0 + 1` gleichzeitig ausstehende P0 am echten Draht (B10), `kCapP0 + 4` am Prozessorhook (B29). Der Deckel der Vorrunde verwechselte Queue-Kapazität mit Registergröße; die Politik bei *voll* bleibt unverändert die aus WN-05 (abweisen, melden, nicht löschen) |
| **B** Lebenszyklus | `erzeugen ↔ freigeben` bleibt in einem Satz, aber jetzt an **einem** Ort: ein Eintrag entsteht mit `sendePersistenzP0` und fällt mit dem ACK, das ihn abschließt. B10 misst beides an derselben Kennung — 65 im Register, `konflikt` hält, `angewandt` gibt frei, genau eine Meldung |
| **C** Verträge und Längen | `auftragMitBasisRevision` entscheidet am **Text**, nicht an einer Struktur, und ist fail-closed auf jedem Rand: acht Fälle (kein Kopf, zwei Köpfe, zwei `base_revision`, Zahl vor dem Kopf, keine Ziffer, `base_revision` nur als Textwert, leerer Text, fehlende Zahl) liefern leer — dann wiederholt der Client gar nicht |
| **D** Bau- und Prüfriegel | N-29: alle 14 Beine sind nach einem `cmake --build` mit **geprüftem Exitcode** gefahren, und das Rohprotokoll trägt je Bein den Zeitstempel des gemessenen Binaries. Der Rotstand ist danach mit `git checkout --` zurückgenommen und der Endstand neu gebaut worden |
| **E** Behauptung ≤ Messung | Der Rotbeweis fällt an den Zeilen, die die Zusage tragen, und die **Zahlen** benennen den Bruch (64 von 68, 64 im Register statt 65, leerer Wiederholungstext). Die grün bleibenden Zeilen sind ausdrücklich als Wachen benannt. „Geänderte Zusage — drei Stellen": die Hookdoku in `ControlClient.h`, die Feld- und Funktionsdoku in `PluginProcessor.h` und dieser Manifestabschnitt sind gemeinsam nachgezogen; `git grep -n 'urteilMitschnitte\|Urteilmitschnitt' eq-copilot/plugin` trifft nur noch **Verlaufstext** in zwei Kommentaren |
| **F** Änderungssatz | Sender und Rückweg in einem Satz: `ControlClient` (die Funktion und beide Hookdokus), `PluginProcessor` (das entfallene Register und der zustandsfreie Rumpf), das Testdouble `V3TestServer.h` und beide Beine B10 und B29 liegen in **einem** Commit `2ef235e` |
...
**Lauf:** 2026-09-07 04:49 | **Runner:** `tools/beweise.ps1` | **Urteil:** GRUEN - 60/60 Kanon-Laeufe bestanden | 2 geplante Pruefung(en) noch nicht gebaut | 1 stillgelegte(s) Bein(e), siehe Uebersicht | **Exitcode:** 0 | **Rohausgabe:** [roh/SONDE-014-c053be8.md](roh/SONDE-014-c053be8.md)
...
| # | Behauptung | Befehl | Ergebnis | Dauer | Rohausgabe |
|---|---|---|---|---|---|
| A1 | Passthrough ist bitgleich; 0 Samples Latenz, 0 Tail; NaN/Inf werden gezaehlt, aber nicht veraendert. | `eq-copilot\build\plugin\EqCopNullTest_artefacts\Release\EqCopNullTest.exe` | [OK] Exit 0 | 0,10 s | [A1](roh/SONDE-014-c053be8.md#a1) |
| A2 | AnalyseEngine deckt sich mit der eingefrorenen Offline-Referenz (Fixture-SHA-256 als Determinismus-Riegel). | `eq-copilot\build\plugin\EqCopGoldenTest_artefacts\Release\EqCopGoldenTest.exe eq-copilot\fixtures` | [OK] Exit 0 | 9,59 s | [A2](roh/SONDE-014-c053be8.md#a2) |
| A3 | Hoer-Markierung bleibt verriegelt: Render/Freilauf bitgleich, Analyse-Abgriff sitzt vor der Faerbung, und der U10-Term ist gedeckt - OHNE Playhead faerbt bei sonst voller Erlaubnis kein Sample (T11, mit Gegenprobe bei laufendem Transport). | `eq-copilot\build\plugin\EqCopMarkierungTest_artefacts\Release\EqCopMarkierungTest.exe` | [OK] Exit 0 | 7,78 s | [A3](roh/SONDE-014-c053be8.md#a3) |
| A4 | Broker-Vertragstests: eingefrorene v2/v3-Vertraege sowie SONDE-011 Phase B mit Coordinator/Session, monotoner Liveness/Eviction, SQLite-Migration 1, Single-Writer, Projektionen, Snapshot-Outbox, dauerhaften Konfliktriegeln, produktiver v2+v3-Verdrahtung und der nicht isolationspflichtigen Killmatrix. Seit SONDE-013 zusaetzlich die Fassungsleiter (jede Minorfassung wird aus der committeten zurueckgebaut, der Leser der Fassung 1 lehnt jede Neuerung der Fassung 2 ab, Fassung 0 erbt den Rueckbau) und der Empfaenger des evidence_snapshot: fremde Adresse verworfen, offene Intervention sperrt statt abzuschwaechen, nach Ende und Nachlauf nimmt er wieder an. Seit SONDE-014 zusaetzlich der Intent- und Assistentenspiegel (Koaleszierung je Quelle/Scope, keine Rechnung vor der Vollstaendigkeitsmarke) und der URSACHENPFAD: aus paralleler Telemetrie entsteht nie Aussageklasse 2 oder 3, das Screening reicht hoechstens fuenf Kandidaten weiter, fehlende Coverage und falsches Alignment sind ein GATE vor der Gewichtung und tragen einen Grund aus der geschlossenen Achtermenge, eine Passage unter GATE_MINDEST_FENSTER traegt keine starke Aussage (mit Gegenprobe an der Kante 7/8), eine Ruecknahme invalidiert die abhaengigen Hypothesen deterministisch, und hundert Laeufe ueber dieselben Bytes liefern bytegleich dieselbe Rangfolge. Seit Etappe F dazu die Proposal-Policy: ein Vorschlag entsteht MIT seinem Befund und traegt die fuenfzehn Felder aus 42.1 plus revert, der Rueckweg ist ein FELD mit drei Werten (dsp_revert faellt), in P5 ist jede Aktion manual, keine Aenderung und mehr Daten sind vollstaendige Objekte, der Zielbereich kommt aus dem Band des Befunds statt aus dem groessten Banddelta, ein geschuetztes Band ist eine HARTE Constraint mit Gegenprobe, ein stop_if auf einem nicht messbaren Guardrail meldet MORE DATA, und ueber fuenfhundert zufaellige Eingaenge wird kein Hard Cap und keine engere Usergrenze ueberschritten. Der Guardrail-Rechner LIEST seit E-05 den Zielbereich aus experiment_begin.ziel; ohne ihn bleibt die Heuristik und das Resultat traegt ziel_geraten - beide Pfade mit verschiedener Zahl gemessen. | `cargo test --manifest-path broker/Cargo.toml --color never` | [OK] Exit 0 | 160,16 s | [A4](roh/SONDE-014-c053be8.md#a4) |
| A4-SI | SONDE-011 Phase-B-Systemintegration auf Probe-Pipenamen: echter C++-ControlClient wiederholt persistenzpflichtige Befehle ueber Brokerkills mit derselben command_id; Store/Coordinator liefern nur absolute session_snapshot-Pushes, koaleszieren Snapshot-Schuld, halten Locks aus externer Arbeit heraus und bereinigen Eviction/Nonce vor spaeterem Push. | `cargo test --manifest-path broker/Cargo.toml --color never --test store_crash_matrix -- --ignored --test-threads=1` | [OK] Exit 0 | 12,47 s | [A4-SI](roh/SONDE-014-c053be8.md#a4-si) |
| A4b | C++-PipeClient: stop/reconnect und ganze Frames sind zeitlich begrenzt, SQOS ist Identification, Peerbytes sind UTF-8/NUL-sauber, ACK-Sequenzen streng und u64-Zaehler wire-sicher. | `eq-copilot\build\plugin\EqCopPipeClientTest_artefacts\Release\EqCopPipeClientTest.exe` | [OK] Exit 0 | 65,71 s | [A4b](roh/SONDE-014-c053be8.md#a4b) |
| A5 | Referenzbein (jsonschema, draft 2020-12): Schema haelt die Engine-Teilmenge ein, Textriegel deckt jede gemessene Kante, jedes Fixture wird wie im Manifest klassifiziert, jede Definition hat ein Negativfixture. Seit SONDE-013 zusaetzlich der Fassungsschritt: der aus dem Register zurueckgebaute Leser der Fassung 1 LEHNT jede Neuerung der Fassung 2 ab (drei Experimentfamilien, evidence_snapshot.ereignisse/.stereo, zwei neue Invalidierungsgruende), und die Summe der registrierten Familien stimmt mit dem oneOf ueberein. | `py -3.13 tools\eq-copilot\pruefe_v3_vertrag.py --abdeckung` | [OK] Exit 0 | 3,03 s | [A5](roh/SONDE-014-c053be8.md#a5) |
| A6 | Beide Bandgitter sind bytegleich zur Neuerzeugung; 221 Baender, 64 Gruppen als exakte Partition. | `py -3.13 tools\eq-copilot\erzeuge_bandgitter.py --pruefen` | [OK] Exit 0 | 0,13 s | [A6](roh/SONDE-014-c053be8.md#a6) |
| A7 | Quantisierungsvertrag bytegleich zur Neuerzeugung; Rundung, Saettigung und Nichtendliches als Testvektoren. | `py -3.13 tools\eq-copilot\erzeuge_quantisierung.py --pruefen` | [OK] Exit 0 | 0,14 s | [A7](roh/SONDE-014-c053be8.md#a7) |
| A8 | Fixture-Korpus und MANIFEST bytegleich zur Neuerzeugung; keine verwaiste Datei. | `py -3.13 tools\eq-copilot\erzeuge_v3_fixtures.py --pruefen` | [OK] Exit 0 | 0,25 s | [A8](roh/SONDE-014-c053be8.md#a8) |
| A9 | Codegen-Drift ist 0: die Neugenerierung aus dem .fbs ist bytegleich zum committeten C++- und Rust-Code; flatc, C++-Header und Rust-Crate tragen dieselbe gepinnte Version; jedes Tabellenfeld traegt eine explizite Feld-ID. | `py -3.13 tools\eq-copilot\pruefe_flatc_drift.py` | [OK] Exit 0 | 0,26 s | [A9](roh/SONDE-014-c053be8.md#a9) |
| A10 | Binaerer Fixture-Korpus und sein MANIFEST bytegleich zur Neuerzeugung; keine verwaiste Datei; sechs NAK-29-Transportrelationen, band_stereo ID 10 samt saturated-/Grenzfaellen und integration_samples ID 14 (voller Rahmen, duenner Rahmen, gesendete 0 als Senderfehler) sind in beiden Lesern gedeckt. | `py -3.13 tools\eq-copilot\erzeuge_fb_fixtures.py --pruefen` | [OK] Exit 0 | 2,40 s | [A10](roh/SONDE-014-c053be8.md#a10) |
| A11 | Die fuenf v2-Vertraege (ipc v2, measurement v1, report v1, snapshot v3, aggregat v1) sind gueltiges JSON und gueltige JSON-Schemas; ihre $id-Familie ist eingefroren. | `py -3.13 tools\eq-copilot\pruefe_v2_schemas.py` | [OK] Exit 0 | 0,25 s | [A11](roh/SONDE-014-c053be8.md#a11) |
| A12 | Parameterbestand (109 IDs, §53.8) haelt den Vertrag; RFC-8785-Zahlenvektoren tragen den RFC-Text und werden von rfc8785 bestaetigt; State-Fixture-Korpus und MANIFEST bytegleich zur Neuerzeugung. | `py -3.13 tools\eq-copilot\erzeuge_state_fixtures.py --pruefen` | [OK] Exit 0 | 0,26 s | [A12](roh/SONDE-014-c053be8.md#a12) |
| A13 | Capabilityreport FL: die zehn Bits aus §53.6 entsprechen der v3-Vertragsform und stehen so, wie die Rohdaten der Termine A und B sie tragen; jedes supported hat einen Termin, jedes unsupported seinen festen Fallback. | `py -3.13 tools\eq-copilot\pruefe_host_capabilities.py` | [OK] Exit 0 | 0,30 s | [A13](roh/SONDE-014-c053be8.md#a13) |
| A14 | Der gemeinsame Kern traegt keine Bundle-Identitaet (Entwurf §53.4): NakamaKern.lib wird vor der Messung geloescht und von MSBuild neu erzeugt (jede Kernquelle uebersetzt, Objekte und Lib juenger als der Zeitanker, Objektzahl = Quellzahl), enthaelt danach keinen eingefrorenen Identitaetswert aus plugin-identities-v1.json (Text in ASCII/UTF-16LE, Viercodes als Integer beider Byteordnungen, CIDs roh und COM-vertauscht) und genau die erwarteten Kernobjekte ohne JUCE-Modulobjekt; die Gegenprobe findet die Pflichtnadeln im gebauten Gen-Bundle, sonst waere das Schweigen ueber den Kern wertlos. Fehlende Voraussetzung (kein Neubau, Artefakt nicht auffindbar, --nur-messen) endet mit Exit 3, mit registriertem Befund mit 2, nie mit 0. Seit NAK-100 (30.08.2026) ohne K1b-Textscan, Ortsriegel, JUCE-Baum-Riegel und Frischewachen (Haertung NAK-103). | `py -3.13 tools\eq-copilot\pruefe_kern_identitaetsfrei.py` | [OK] Exit 0 | 6,14 s | [A14](roh/SONDE-014-c053be8.md#a14) |
| A17 | Installer-Manifest: keine zweite Identitaet (kein Viercode, keine Class-ID, kein Produkt- oder Bundlename ausser im Pfad), jeder Quellpfad ist der aus Ziel + Identitaetsdatei nachgerechnete Bundle-Ordner, `art` ist eine geschlossene Menge, jedes aktive Ziel genau einmal und jedes stillgelegte benannt mit lesbarer Marke, Broker aus dem Crate-Namen, Zielverzeichnisse geschuetzt, Signaturzeile ehrlich, Rueckweg samt NAK-41-Riegel und hash_art vollstaendig; jede der 15 Regeln faellt an einem verdorbenen Manifest, die konkreten Umgehungen fallen einzeln. [4] vergleicht Artefakthashes im Kanon weich und mit --release hart; [4b] berichtet den installierten Stand; [5] kreuzprueft den Ordner-Hash; [6] faehrt die produktive C++-WinVerifyTrust-/Thumbprint-Kette mit dem OS-vertrauenswuerdigen Signerzertifikat einer signierten Windows-Fixture fuer gueltig und falsch sowie einer unsigned Temp-Kopie fuer fehlend, ohne den Zertifikatsspeicher zu aendern. Jede gelesene JSON-Datei wird vor dem Zugriff strukturell geprueft; unerwartete Ausnahmen enden kontrolliert. | `py -3.13 tools\eq-copilot\pruefe_installer_manifest.py` | [OK] Exit 0 | 1,13 s | [A17](roh/SONDE-014-c053be8.md#a17) |
| A18 | Gegenpfad installieren<->Rueckweg gefahren (Sandbox, nichts installiert): Erstinstallation traegt moduleinfo.json, ein Tausch ersetzt statt zu mischen, -Pruefen sieht den ganzen Ordner, der Rueckweg stellt den Vorzustand bytegleich her und laesst KEIN leeres .vst3-Gehaeuse stehen, selbst angelegte Ordner verschwinden nur leer, der NAK-41-Riegel greift und zerstoert seine eigene Wiederholungsquelle nicht, eine dritte Artefaktsorte bricht ab. | `py -3.13 tools\eq-copilot\pruefe_installer_gegenpfad.py` | [OK] Exit 0 | 38,53 s | [A18](roh/SONDE-014-c053be8.md#a18) |
| A19 | BandGridZahlen.h ist bytegleich aus den zwei eingefrorenen Gitterfixturen erzeugt; die 64 Live-Gruppen partitionieren die 221 Feinbaender lueckenlos und ueberschneidungsfrei, und die groben Kanten sind bitgleiche Kopien feiner Kanten (kein zweites Filterbank-Gitter). | `py -3.13 tools\eq-copilot\erzeuge_bandgitter_header.py --pruefen` | [OK] Exit 0 | 0,13 s | [A19](roh/SONDE-014-c053be8.md#a19) |
| A20 | Envelope-Fixture-Korpus und MANIFEST bytegleich zur Neuerzeugung; keine verwaiste Datei; jede der 14 Envelope-Regeln hat mindestens ein Negativfixture. | `py -3.13 tools\eq-copilot\erzeuge_envelope_fixtures.py --pruefen` | [OK] Exit 0 | 0,32 s | [A20](roh/SONDE-014-c053be8.md#a20) |
| A21 | v3-Envelope unter Zufall: 20 000 Zufallspuffer bringen den Pruefer nie aus dem Tritt und JEDER angenommene Frame erfuellt jede Kopfregel; 3000 gekippte P2-Payloadbits fallen einzeln an der CRC; feindliche Laengen (0, 15, ueber der Grenze, 0xFFFFFFFF) und die u32-Grenze von 16+payload_len enden in der erwarteten Fehlerklasse, ohne Absturz und ohne Eingabeallokation in Groesse der behaupteten Laenge; 300 Runden Fragmentierung (byteweise und in Zufallshaeppchen) liefern exakt dieselben Frames; ein kaputter Frame beendet den Strom statt zu resynchronisieren; die Ratengrenze haelt unter Flut. | `cargo test --manifest-path broker/Cargo.toml --test transport_fuzz --color never` | [OK] Exit 0 | 0,35 s | [A21](roh/SONDE-014-c053be8.md#a21) |
| A22 | Ende-zu-Ende ueber die PROBE-Pipe, zwei Sprachen ein Draht: 32 echte C++-Sondenpaare koppeln sich am echten Rust-Listener (32 Control + 32 Telemetry, jede Telemetrieverbindung ueber link_id + challenge + gleiche runtime_nonce), fluten P2 bis die Schleuse mit Cap 2 nachweislich ersetzt, und WAEHRENDDESSEN geht kein einziger P0-Frame verloren; die P0-Antwortlatenz bleibt unter der Schranke. Keine Verbindung wird wegen Envelope, Rate oder P0-Ueberlauf geschlossen. | `py -3.13 tools\eq-copilot\pruefe_ipc_last.py` | [OK] Exit 0 | 10,01 s | [A22](roh/SONDE-014-c053be8.md#a22) |
| A24 | G3-SOAK Dauerlauf ueber eine ausschliessliche Probe-Pipe: 1 Main mit subscribe_session und echtem SourcesModel plus 16 Sondenpaare und 16 echte SondeProcessor am Ganzblockpfad laufen gegen den echten Rust-Coordinator, waehrend ein Viertel der Sonden langsam liest und der Broker mitten im Lauf getoetet und neu gestartet wird. Gemessen: Mitgliedschaft und fuehrendes_main driften nie, kein P0 geht ausserhalb der Neustartfenster verloren und seine ACK-p95 bleibt unter 1.000 ms, kein Mitglied wird ausserhalb der Fenster stale oder evicted, der Snapshot ist nach jedem Neustart binnen 60 s wieder vollstaendig und die alte broker_epoch kommt nie wieder, Working Set beider Prozesse waechst je Generation um hoechstens max(10 %, 16 MiB), und der Sondenpfad verliert keinen Ganzblock. Beide Programme verweigern Produktions- und Golden-Pipename mit Exit 3, gefahren vor dem Lauf. Seit SONDE-013 laeuft dabei der Evidenzpfad mit: jede Sonde baut oberhalb einer kleinen P1-Fuellstandsschwelle GAR KEINEN evidence_snapshot mehr und zaehlt den verworfenen Analyseframe, statt die in EINTRAEGEN gedeckelte P1-Queue mit 10-KiB-Nachrichten zu fuellen. | `py -3.13 tools\eq-copilot\pruefe_session_soak.py --sonden 16 --minuten 2 --neustarts 1` | [OK] Exit 0 | 148,61 s | [A24](roh/SONDE-014-c053be8.md#a24) |
| A28 | Der P5-Evaluationskorpus ist reproduzierbar (Muster A25): der Erzeuger baut jede Datei BYTEGLEICH neu, --pruefen vergleicht den committeten Bestand gegen die Neuerzeugung samt SHA-256 im Manifest, und eine verwaiste Datei faellt. Zusaetzlich der Hygieneriegel aus NAK-182 R2: der Bezeichner des Kettenbeins steht WOERTLICH in seiner Datei, sonst waere der Name ein Etikett. | `py -3.13 tools\eq-copilot\erzeuge_p5_korpus.py --pruefen` | [OK] Exit 0 | 0,13 s | [A28](roh/SONDE-014-c053be8.md#a28) |
| A29 | Das Sammelbein des P5-Exit-Gates (59 Punkt 6, 36.4, M-64 bis M-70, R2). Es ist das dritte Glied einer KETTE: der Korpus traegt die Wahrheit, broker/tests/sonde014_p5_korpus.rs faehrt jede Sitzung durch p1 und schreibt die TATSAECHLICH ausgegebene Hypothese, und dieses Bein haelt beides gegeneinander - eine falsche starke Produktbehauptung aendert den Korpus nicht, sie faellt am Vergleich. Precision und Recall stehen JE URSACHENKLASSE, dazu Brier, Kalibrierung, Coverage und Enthaltungsrate; die vier Riegel (falsche_starke, falsche_schwache, precision und recall in [0,1]) laufen je Klasse und ueber die Gesamtmenge. Die Schwelle aus M-31 ist AUSGABE: gesucht wird die niedrigste Sicherheitsstufe, deren Riegel halten. Der Startwert von GATE_MINDEST_FENSTER wird an den zwei Passagensitzungen kalibriert. Ohne frische Ergebnisdatei meldet das Bein Voraussetzung-fehlt (Exit 3) statt gruen. | `py -3.13 tools\eq-copilot\pruefe_p5_korpus.py` | [OK] Exit 0 | 0,13 s | [A29](roh/SONDE-014-c053be8.md#a29) |
| A30 | Der Selbsttest des P5-Sammelbeins (M-68, Muster A27). Er laeuft OHNE Repo-Fixture: die Faelle entstehen im Speicher und laufen durch DIESELBEN Funktionen, die das Sammelbein fuehrt. Jede Erwartung laeuft mit ihrem GEGENTEIL - eine falsche starke Behauptung und die richtige daneben, eine Enthaltung und dieselbe Menge ohne sie, ein leerer Satz und ein voller. Die vier Riegel werden synthetisch gefuettert und muessen fallen: precision > 1, recall > 1 und brier > 1 sind ueber den Korpusweg strukturell unerreichbar, und eine Wache ohne ausfuehrbaren Negativtest ist keine gemessene Zusage. Zuletzt die Schwellensuche in beide Richtungen. | `py -3.13 tools\eq-copilot\pruefe_p5_korpus.py --selbsttest` | [OK] Exit 0 | 0,12 s | [A30](roh/SONDE-014-c053be8.md#a30) |
| A25 | Der P4-Referenzkorpus ist reproduzierbar (M-80): der Erzeuger baut jede Datei BYTEGLEICH neu, --pruefen vergleicht den committeten Bestand gegen die Neuerzeugung samt MANIFEST und meldet jede verwaiste Datei. Dasselbe Muster wie A6, A7, A8, A10, A12 und A20; die gitattributes-Regel haelt die Zeilenenden. Seit NAK-182 weist der Erzeuger ausserdem ab, was der Korpus nicht tragen darf: eine Wahrheit ausserhalb der geschlossenen Menge, eine fehlende `quelle` und einen Bezeichner, der in der genannten Datei nicht woertlich steht. Die zwei Mengen KEINE_BEHAUPTUNG und KEINE_STARKE sowie die Zeile `nicht_gemessen` reisen im MANIFEST mit, damit der Pruefer sie von dort liest statt aus einer zweiten Kopie. | `py -3.13 tools\eq-copilot\erzeuge_p4_korpus.py --pruefen` | [OK] Exit 0 | 0,19 s | [A25](roh/SONDE-014-c053be8.md#a25) |
| A26 | Das Sammelbein des P4-Exit-Gates (§58, §49.4, M-79/M-81 bis M-85): vier Klassen - Referenzkorpus, Loop-/Seek-/PDC-Goldens, adversariale Vergleichsfixtures und Stereo-Goldens -, alle muessen bestehen, und jedes genannte Bein steht wirklich im Kanon-Runner. Neben Precision und Recall zaehlen Kalibrierung, Brier Score, Coverage, Enthaltungsrate und die Zahl FALSCHER Behauptungen; die muss null sein. Eine Enthaltung ist dabei kein Fehler - §49.4 woertlich: ein konservatives unsicher ist besser als eine ueberzeugende falsche Ursache. Seit NAK-182 liest das Bein zwei geschlossene Wahrheitsmengen AUS DEM MANIFEST: auf KEINE_BEHAUPTUNG (unbekannt, unvergleichbar, zeitvariabel) ist jede Aussage falsch, auch die schwache; auf den zwei Werten, die nur in KEINE_STARKE stehen (nicht_kausal, nicht_exakt), ist es die starke. Zaehler und Nenner von Recall lesen dieselbe Menge, Precision und Recall sind als Quoten geriegelt, jeder Korpusfall nennt eine Quelldatei samt woertlichem Bezeichner und wird dort gesucht, die fuenf geschlossenen Mengen des v3-Vertrags werden auf kausale Bezeichner geprueft (Entscheid G4 §8), und die in P4 NICHT gemessene Zusage M-85 Ziel 1 wird im Kopf gedruckt statt still zu fehlen. | `py -3.13 tools\eq-copilot\pruefe_p4_korpus.py` | [OK] Exit 0 | 0,21 s | [A26](roh/SONDE-014-c053be8.md#a26) |
| A27 | Der Selbsttest des Exit-Gate-Beins (NAK-182 R1, MP1-6). Er laeuft OHNE Repo-Fixture: die Faelle entstehen im Speicher und laufen durch dieselben Funktionen, die A26 fuehrt. Auf dem Korpusweg fallen eine STARKE Aussage auf jedem Wert aus KEINE_STARKE und eine SCHWACHE auf jedem Wert aus KEINE_BEHAUPTUNG; eine schwache Aussage auf nicht_kausal oder nicht_exakt bleibt gruen - genau das trennt die zwei Mengen. Auf dem Kennzahlweg bekommt die Riegelfunktion synthetische Kennzahlen direkt eingespeist, weil Recall und Precision ueber 1 nach der Zweimengenlogik strukturell unerreichbar sind und die Wachen trotzdem einen Weg zu fallen brauchen. Dazu ein erfundener Bezeichner, ein Pfad ins Leere, eine fehlende Vertragsmenge und ein kausaler Enumwert. Seit Nacharbeit 1 laeuft auch S-07 durch die echte Validierung: ein synthetischer Fall mit einer Wahrheit ausserhalb ERLAUBTE_WAHRHEITEN geht durch dieselbe Funktion _pruefe_wahrheiten, die A26 auf den geladenen Korpus anwendet, und muss genau eine rote Zeile mit dem Fallnamen ergeben; sein Gegenteil keine. Jede Erwartung laeuft MIT ihrem Gegenteil - sonst waere der Selbsttest auch dann gruen, wenn ein Riegel immer rot meldete. | `py -3.13 tools\eq-copilot\pruefe_p4_korpus.py --selbsttest` | [OK] Exit 0 | 0,14 s | [A27](roh/SONDE-014-c053be8.md#a27) |
| A23 | SONDE-012 E-L06 integriert ueber eine ausschliessliche Probe-Pipe: synthetische C++-Quellen senden vollstaendige Messfenster durch den echten Rust-Coordinator an das echte Main-SourcesModel. Der Endpunkt ist dessen Revision samt Anzeige-Invalidierung. Bei 16 und 32 Quellen liegt p95 fuer 2048/4096 Samples unter 300 ms und fuer 16384 Samples unter 750 ms, jeweils ab dem ersten Sample des Fensters. | `py -3.13 tools\eq-copilot\pruefe_sonde012_sources_latency.py` | [OK] Exit 0 | 4,71 s | [A23](roh/SONDE-014-c053be8.md#a23) |
| A15 | STILLGELEGT - mass bis 28.08.2026 Nakama Suna (NkPr): Passthrough bitgleich ueber drei Samplerates und fuenf Blockgroessen, 0 Samples Latenz, kein Tail, kein Hostparameter; Bundlevertrag laesst nur passive_probe zu; speichern-laden-speichern bytegleich. | `(nicht gefahren)` | [STILLGELEGT] seit 2026-08-28 (S9b/SONDE-007c): das Ziel NakamaSuna ist stillgelegt - Suna ist in Nakama Probeeq aufgegangen (design/abnahmen/2026-08-28-suna-stilllegung-vorgezogen.md). Weder gebaut noch gefahren; die Zeile bleibt sichtbar, damit die Kanonzahl nicht still sinkt. | - | - |
| A16 | Nakama Probeeq (NkAc): heute ebenfalls Passthrough bitgleich (die EQ-DSP kommt in P6), 0 Samples Latenz, kein Tail, kein Hostparameter; Bundlevertrag laesst nur active_probe zu; speichern-laden-speichern bytegleich. Seit der T3-Nacharbeit 29.08.2026 (G1 §4.2) faehrt dasselbe Bein die Gate-7-Kette AM GEBAUTEN BUNDLE Nakama Probeeq - Klasse active_probe, denn die Sondenschale traegt genau EINE Klasse je Uebersetzung: ein sonst gueltiger Stand mit measurement_position=post_fader_contribution kommt ueber setStateInformation read-only zurueck, die Instanz bleibt neutral, die Originalbytes gehen unveraendert an den Host zurueck und ein erneutes Laden waescht nichts; auch eine bereits klassifizierte Instanz faellt beim Nachreichen desselben Standes auf neutral zurueck; Gegenprobe mit insert laedt normal. Zusaetzlich misst dasselbe Bein direkt an der oeffentlichen positionErlaubt, dass post_fader_contribution fuer alle vier Klassen abgelehnt wird - das gemeinsame Ergebnis von Capability-Vorpruefung und Klassenmatrix, ohne die beiden Haelften zu trennen. Die vollstaendige 16er-Matrix samt Bundlevertraegen misst B2. | `eq-copilot\build\plugin\EqCopProbeeqNullTest_artefacts\Release\EqCopProbeeqNullTest.exe` | [OK] Exit 0 | 0,12 s | [A16](roh/SONDE-014-c053be8.md#a16) |
| B1 | Bundle-Identitaet (CIDs, JUCE_VST3_CAN_REPLACE_VST2=0) eingefroren. | `eq-copilot\build\plugin\EqCopIdentityTest_artefacts\Release\EqCopIdentityTest.exe` | [OK] Exit 0 | 0,12 s | [B1](roh/SONDE-014-c053be8.md#b1) |
| B2 | State-Schema 2: Roundtrip bytegleich, Schema-1-Migration rein und golden, unbekanntes Major read-only mit Originalbytes, Duplicate erkennbar und aufloesbar, Host-Dirty; alle vier Klassen sperren post_fader_contribution; NAK-40-Aliasvektoren adressieren die bytegleich erhaltene Legacy-instance_id ohne Alias im State; Parametertabelle und RFC-8785-state_hash sprachuebergreifend. | `eq-copilot\build\plugin\EqCopStateMigrationTest_artefacts\Release\EqCopStateMigrationTest.exe` | [OK] Exit 0 | 1,18 s | [B2](roh/SONDE-014-c053be8.md#b2) |
| B3 | Hostkontext (Anwesenheit, Parameterpunkte, Buslatenz) wird gemessen, nicht geraten; Quellhash-Gate des JUCE-Patches gruen. | `eq-copilot\build\plugin\EqCopHostContextTest_artefacts\Release\EqCopHostContextTest.exe` | [OK] Exit 0 | 0,05 s | [B3](roh/SONDE-014-c053be8.md#b3) |
| B3b | Termin-B-Messgeraet: Passthrough bitgleich, Sprung-/Automations-/Latenzmessung inkl. Fehlalarm-Riegel, Bericht-Rueckweg, 0 Allokationen. | `eq-copilot\build\plugin\EqCopHostProbeTest_artefacts\Release\EqCopHostProbeTest.exe` | [OK] Exit 0 | 0,07 s | [B3b](roh/SONDE-014-c053be8.md#b3b) |
| B3c | v3-Vertrag: C++ klassifiziert JSON- und FlatBuffers-Korpus wie das Manifest (Urteil UND Verletzungsmenge), einschliesslich Boolean/RFC-6901-Discriminatoren, NAK-29 in beiden Darstellungen und band_stereo ID 10; Bandgitter und Quantisierung bitgleich. Seit SONDE-013 misst dasselbe Bein integration_samples ID 14 ueber Encoder und Leser: gesetzt kommt Bit UND Wert zurueck, Abwesenheit bleibt gueltig und ist KEINE 0, und eine gesendete 0 faellt als Senderfehler. | `eq-copilot\build\plugin\EqCopSchemaTest_artefacts\Release\EqCopSchemaTest.exe` | [OK] Exit 0 | 0,39 s | [B3c](roh/SONDE-014-c053be8.md#b3c) |
| B4 | StampedAudioQueue und Ein-Block-Quarantaene: Ganzblockaufnahme bitgleich ueber jeden Ringumlauf, Ueberlauf BEIDER Ringe verwirft den ganzen Block und nie eine Teilmenge, Oversize ueber der Slotkapazitaet faellt fuer die Analyse und laesst Audio unberuehrt, Flush (numSamples 0) ist kein Verlust, Mono dupliziert L, Mehrfach-Tap-Layout traegt; Quarantaene versiegelt erst mit bewiesener Fortsetzung, Seek und Transportkante verwerfen genau EINEN Block, stehende Projektzeit (FL-Teilpuffer) ist kein Bruch, Projektzeit-Ueberlauf und negative Zeit sind behandelt; Worker-Publikation folgt monotonen 50-/250-ms-Deadlines statt Batchzahl, holt nach Pausen nicht auf und laesst wartende Reset-/Frame-Aufrufer vor; verdrahtet: Passthrough bitgleich ueber 18 Blockgroessen von 1 bis 16384, 0 Samples Latenz, kein Tail, 0 Allokationen im Audiothread ueber 4000 Bloecke wechselnder Groesse mit Transportkanten UND ueber 2000 weitere mit wechselnder Hoer-Markierung, Ein- und Ausfade und Interventionsring (SONDE-013 M-74), und die Engine bekommt den Strom bis auf den Block in Quarantaene. | `eq-copilot\build\plugin\EqCopQueueStressTest_artefacts\Release\EqCopQueueStressTest.exe` | [OK] Exit 0 | 3,48 s | [B4](roh/SONDE-014-c053be8.md#b4) |
| B9 | Fixed-memory Loudness (§48.1): der LoudnessAccumulator deckt sich mit der ausgebauten Vektorrechnung innerhalb ±0,1 LU (Entwurf §49) ueber konstante, rampende, zufaellige und einstuendige Korpora sowie ueber Stille unter dem absoluten Gate; Kurz-LUFS ist BITGLEICH; ein adversarialer Sweep legt 1000 Bloecke in den Grenzbin des relativen Gates und die selbstgemeldete Schranke unsicherheitLu() deckt jeden Lauf; eine Million Zellen laufen mit 0 Allokationen durch, waehrend die Gegenprobe (alte Rechnung) allozert; NaN/Inf-Zellen sind gezaehlt statt still als 0 verbucht und l_j == -70,0 exakt bleibt wertgleich; ueber dem Feingitter traegt ein OBERBAND aus Bins von 1 LU bis ueber lautheit(DBL_MAX) - mit ZWEI Pegeln darin (Korpus des T2-Pruefers), einem adversarialen Sweep im Oberband-Grenzbin, beiden Richtungen der Naht zwischen den Aufloesungen und der Gegenprobe, dass kein Block durch das Raster faellt. | `eq-copilot\build\plugin\EqCopLoudnessGoldenTest_artefacts\Release\EqCopLoudnessGoldenTest.exe` | [OK] Exit 0 | 0,16 s | [B9](roh/SONDE-014-c053be8.md#b9) |
| B5 | FeatureEngine v2 haelt Zeit-, Validity-, Event- und Bandvertraege: Bandgitter und alle Quantisierungsvektoren bitgleich zum v3-Vertrag, Bitmap LSB-first mit Fuellbits 0, FFT gegen Parseval und einen Sinus auf der Binmitte, K-Gewichtung ueber 20 Hz..20 kHz unter 0,1 dB an der BS.1770-Referenzkette; Drop/Seek(laufend UND gestoppt)/Loop-Wrap/moeglicher Straddle/Transportkante/Sampleratewechsel/Neuanlauf/Beweislagewechsel trennen JEDES offene Fenster - auch den K-Filterzustand, bitgleich gemessen -, waehrend FL-Teilstuecke mit stehender Projektzeit lokal weiterlaufen, und ein Drop zaehlt als Segment, nicht als Epoche. Seit NAK-182 misst ein Sweep zusaetzlich die ZEITLAGE: ein bekannter Impuls bei Stromsample 206336 laeuft ueber die fuenf Blockgroessen 1, 333, 512, 2048 und 16384 mal die fuenf Sampleraten 44,1 / 48 / 88,2 / 96 und 192 kHz, und der gemeldete stromSample ist je Samplerate ueber alle fuenf Blockgroessen IDENTISCH und liegt innerhalb einer Fensterlaenge (4096 Samples) vor dem Impuls. Die Auswahl des Ereignisses kennt die Sollzeit NICHT - gemessen wird das staerkste Flussereignis des Laufs, und dass es unzweifelhaft das staerkste ist, ist eine eigene Zusage. | `eq-copilot\build\plugin\EqCopAnalysisGoldenTest_artefacts\Release\EqCopAnalysisGoldenTest.exe` | [OK] Exit 0 | 5,41 s | [B5](roh/SONDE-014-c053be8.md#b5) |
| B6 | Aktiver DSP-Kern liefert die eingefrorene Referenzantwort. | `eq-copilot\build\plugin\EqCopDspGoldenTest_artefacts\Release\EqCopDspGoldenTest.exe` | [GEPLANT] geplant (ab P6) | - | - |
| B7 | Apply/Revert ist transaktional - kein halber Zustand ueberlebt. | `eq-copilot\build\plugin\EqCopTransactionTest_artefacts\Release\EqCopTransactionTest.exe` | [GEPLANT] geplant (ab P6) | - | - |
| B10 | C++-v3-Vertrag und SONDE-011 Phase B: Envelope/CRC/Pipetoken und begrenzte P0/P1/P2-Politiken bleiben gruen; das In-Flight-Register gibt persistente Befehle erst bei angewandt, idempotent_wiederholt oder endgueltigem Fehler frei und reiht vor ACK dieselbe command_id wieder ein; Autostart verbindet zuerst, prueft Manifest-SHA-256 und bei gesetztem Thumbprint WinVerifyTrust plus Signer, spawnt verborgen und mutex-idempotent, haelt Backoff/Timeout/Cooldown-Grenzen und beendet keinen Brokerprozess. Seit SONDE-013 nimmt die C++-Vertragsengine die drei Experimentfamilien aus den committeten Fixtures an, lehnt einen fremden execution_mode an derselben Engine ab, und ein experiment_manual_result laeuft als persistenzpflichtiger P0-Befehl durch das In-Flight-Register wie jede andere steuernde Nachricht. | `eq-copilot\build\plugin\EqCopIpcTest_artefacts\Release\EqCopIpcTest.exe` | [OK] Exit 0 | 213,83 s | [B10](roh/SONDE-014-c053be8.md#b10) |
| B11 | Probeeq uebernimmt JUCE updateTrackProperties ausschliesslich auf dem Message-Thread; gueltige Hostnamen reisen codepointgetreu in heartbeat.runtime, leer/Whitespace/121 Codepoints/C0/C1 gelten als Fehlen; Hostvorrang veraendert das gespeicherte User-Label nicht, Clear stellt dessen Rueckfall her. Persistierte Messpunkte insert/pre/post und Betrieb active/suspended/offline reisen ohne Synthese; der lokale C++-Pfad behauptet nicht, dass FL den Callback liefert. | `eq-copilot\build\plugin\EqCopSonde012HostChannelContextTest_artefacts\Release\EqCopSonde012HostChannelContextTest.exe` | [OK] Exit 0 | 1,00 s | [B11](roh/SONDE-014-c053be8.md#b11) |
| B12 | Probeeq fuehrt Audio ueber die vorallokierte Ganzblockqueue zum Analyseworker und P2: LUFS-I reist nur atomar mit endlicher unsicherheitLu und ohne Status; collecting/gated reisen ohne Zahlenpaar; halbe, nichtendliche oder statusbehaftete Paare werden nicht serialisiert. Seek, Loop, Oversize-Drop und Kontinuitaetsbruch starten eine leere Reihe; der gemessene Audiopfad alloziert dabei 0-mal und verwirft bei Ueberlast nur Analyse. | `eq-copilot\build\plugin\EqCopSonde012LoudnessSourceTest_artefacts\Release\EqCopSonde012LoudnessSourceTest.exe` | [OK] Exit 0 | 1,60 s | [B12](roh/SONDE-014-c053be8.md#b12) |
| B13 | Gen/Main ersetzt sein Quellenmodell durch absolute session_snapshot-Sichten und haelt Mitgliedschaft, Control, Messung, Namensherkunft und Capability-Evidenz getrennt; Frischegrenzen, Messpunkte, Betrieb, Fehlerkanal, Lautheitspaar, Hostvorrang, Sortierung und Hauptziel werden einzeln gemessen. Die integrierte 16-/32-Quellen-Zeitmessung gehoert A23. | `eq-copilot\build\plugin\EqCopSonde012SourcesModelTest_artefacts\Release\EqCopSonde012SourcesModelTest.exe` | [OK] Exit 0 | 0,11 s | [B13](roh/SONDE-014-c053be8.md#b13) |
| B14 | MainProject Save/Load erhaelt bestaetigte Quellidentitaet und User-Label, aber weder Control-Liveness noch Runtime-Nonce oder Messframe; Join, Benennen und Unbind melden je echte persistente Aenderung Host-Dirty, No-op, Save und Load nicht; Reload baut einen frischen subscribe_session-Auftrag. | `eq-copilot\build\plugin\EqCopSonde012ProjectReloadTest_artefacts\Release\EqCopSonde012ProjectReloadTest.exe` | [OK] Exit 0 | 0,19 s | [B14](roh/SONDE-014-c053be8.md#b14) |
| B15 | EqCopShot rendert den deklarierten SONDE-012-Sichtsatz bei exakt 760x430: 0/1/16 Quellen, fresh/partial/stale/disconnected/invalid, Namens- und Lautheitsgegenpfade, alle Diagnosezustaende, Label-/Unnamed-Rueckfall, Findings, genau ein Hauptziel mit Referenzen sowie das deaktivierte Label-Feld eines nicht fuehrenden Main. | `eq-copilot\build\plugin\EqCopShot_artefacts\Release\EqCopShot.exe --sonde012-suite eq-copilot/build/sonde012-shots` | [OK] Exit 0 | 2,23 s | [B15](roh/SONDE-014-c053be8.md#b15) |
| B20 | Gesamtklasse nach §34.3 (M-06): die vier Klassen sind geordnet, und `deckeln` ist ein Minimum, kein Mittelwert. Jeder der vier harten Maengel deckelt EINZELN auf schwach, ohne gegen die drei guten Nachbarquellen verrechnet zu werden; zwei Maengel ergeben in allen zwoelf Paarungen unbrauchbar. Was ein Erzeuger nicht beurteilen kann, deckelt ebenso auf mittel - eine Sonde mit PERFEKTER Abdeckung kommt deshalb nur auf mittel, weil sie Session, Passage und Alignment nicht sieht; das ist die Regel hinter dem Literal, das Etappe B an einer Stelle gesetzt hatte. Die zwei Abdeckungsschwellen und die Fensterschwelle fallen je an ihrer Kante und knapp darunter (Muster C-09). Die tragende Zusage ist eine INVARIANTE ueber den ganzen Raum: in 1536 Uebergaengen ueber alle 256 Bitkombinationen in drei Basislagen hebt ein zusaetzlicher harter Mangel die Klasse NIE - und alle vier Klassen kommen darin wirklich vor, die Invariante ist also nicht trivial erfuellt. Ein Mittelwert koennte diese Zusage nicht halten. | `eq-copilot\build\plugin\EqCopSonde013QualityClassTest_artefacts\Release\EqCopSonde013QualityClassTest.exe` | [OK] Exit 0 | 0,06 s | [B20](roh/SONDE-014-c053be8.md#b20) |
| B22 | Content-Fingerprint einer Passage (§32.4, M-26/M-27/M-31): er entsteht erst ab genug Material und traegt die Zahl seiner Fenster mit; dasselbe Material zweimal ergibt BITGLEICH denselben Fingerprint, derselbe Akkord in zwei Lautstaerken bleibt ueber 0,95 aehnlich (jeder Verlauf ist auf sein eigenes Maximum normiert), ein anderer Akkord ist messbar unaehnlicher und Rauschen deutlich. Die adversariale Rueckrechenprobe zeigt nicht, dass eine Rueckrechnung schwer waere, sondern dass die Information nicht da ist: 76 Byte fuer 204800 Samples, und ein Sinus und ein Dreieck derselben Grundfrequenz sind sich AEHNLICH, obwohl sie voellig anders klingen - der Fingerprint ist bewusst nicht injektiv, und alle drei Verlaeufe sind Energien ohne Phase. Das Fingerprintfenster ueberbrueckt keine Epochengrenze: nach einer Stromluecke traegt die Engine den Fingerprint des NEUEN Materials (Aehnlichkeit 1,00 zur neuen Referenz, 0,00 zur alten), und der Fensterzaehler faellt mit - bei einer Ueberbrueckung waeren es doppelt so viele. Die Aehnlichkeit selbst ist ein MINIMUM ueber die drei Verlaeufe und kein Mittelwert; zwei Fingerprints ohne Bit sind nicht aehnlich, sondern gar nichts. | `eq-copilot\build\plugin\EqCopSonde013FingerprintGoldenTest_artefacts\Release\EqCopSonde013FingerprintGoldenTest.exe` | [OK] Exit 0 | 0,93 s | [B22](roh/SONDE-014-c053be8.md#b22) |
| B23 | Die manuelle Passage als Projektintent im MainProjectState (§33.5, M-25/M-69). Das neue persistente Feld `manual_passages_v1` traegt seine Fassung im Namen; ein Altstand ohne das Feld laedt normal, ein unbekanntes Zusatzfeld aus einer spaeteren Fassung zerstoert den Leser nicht und steht unveraendert im naechsten Save, und Save/Load ist ueber zwei Runden bytegleich - auch am oberen int64-Rand und mit leerer Liste (die Eigenschaft entfaellt dann, statt als leeres Array zu reisen). Jede persistente Aenderung meldet GENAU einmal Host-Dirty, das Vergessen wie das Merken; ein read-only-Stand verweigert beides und gibt seine Originalbytes zurueck. Was hier NICHT reist, ist Absicht: Fingerprint, Quellenset, Abdeckung und Epoche sind Messergebnisse und bleiben im Store, sonst behauptete ein Projekt nach dem Loeschen der Datenbank weiter, es gebe Evidenz. Jede Grenze wird von beiden Seiten gefahren - was die Produkt-API ablehnt, lehnt auch der Leser ab, und zwar fail-closed als read-only statt still korrigiert. | `eq-copilot\build\plugin\EqCopSonde013PassageStateTest_artefacts\Release\EqCopSonde013PassageStateTest.exe` | [OK] Exit 0 | 11,51 s | [B23](roh/SONDE-014-c053be8.md#b23) |
| B24 | PRE/POST auf der Audioseite (§38.3/§38.4, M-18/M-20/M-24). Die Magnitude-Squared Coherence ist 1 fuer JEDE lineare zeitinvariante Kette und faellt genau dann, wenn die Kette nichtlinear oder zeitvariabel ist: identische Kette, reiner Gain von +15 dB und ein linearer Tiefpass bleiben fast ueberall ueber der 0,8-Schwelle aus §38.3 - Kompression, Modulation, Saturation und wechselnde Latenz fallen darunter, und die beiden Gruppen ueberlappen nicht. Deshalb traegt keine der vier adversarialen Ketten eine statische EQ-Behauptung. Der Vergleichspegel wird vorab gemessen und eingefroren: sechs Sekunden mit +18 dB und zwei Sekunden Stille aendern ihn um kein Tausendstel, denn eine mitlaufende Regelung wuerde selbst zum hoerbaren Prozessor; ohne genug Material friert er gar nicht erst ein, und NaN/Inf verriegeln statt ihn zu vergiften. Hoerbares Delta ist ohne nachgewiesenes Compare-Routing gesperrt - der Raum aus drei binaeren Nachweisen wird VOLLSTAENDIG abgefahren, genau eine der acht Kombinationen ist frei, und in P4 gibt es kein Compare-Routing. | `eq-copilot\build\plugin\EqCopSonde013PrePostGoldenTest_artefacts\Release\EqCopSonde013PrePostGoldenTest.exe` | [OK] Exit 0 | 1,02 s | [B24](roh/SONDE-014-c053be8.md#b24) |
| B25 | Unsicherheit und Mehrfachtestung (§43.2, M-45). Der Block-Bootstrap ist deterministisch, enthaelt den Mittelwert und liefert bei bloeckigem Material ein BREITERES Intervall als ein Bootstrap ueber Einzelwerte - benachbarte Deltas sind korreliert, und wer Unabhaengigkeit annimmt, macht aus Rauschen eine belastbare Aenderung. Leere oder unmoegliche Eingaben ergeben KEIN Intervall statt eines um null. Bei 221 gleichverteilten p-Werten meldet der naive Scan zweistellig viele Baender und die FDR-Korrektur kein einziges, waehrend 20 klare Treffer durchkommen; die Grenze p_(k) = k/m*q faellt inklusiv an ihrem Wert. Cluster verlangen zusammenhaengende Baender - drei verstreute ergeben keinen, vier benachbarte schon, und auch am linken und rechten Rand. | `eq-copilot\build\plugin\EqCopSonde013ExperimentGoldenTest_artefacts\Release\EqCopSonde013ExperimentGoldenTest.exe` | [OK] Exit 0 | 0,06 s | [B25](roh/SONDE-014-c053be8.md#b25) |
| B26 | Die zwei Kanten des Blindvergleichs (§43.1, §15, M-43/M-44). Ohne eingefrorenen Vergleichspegel wird KEIN Klangurteil angenommen - lauter klingt besser, und ein A/B ohne Pegelabgleich misst genau das; ein noch laufender Pegel zaehlt nicht als Abgleich. Die Blindreihenfolge wird vor dem Urteil gebunden und laesst sich nicht drehen; vor dem Urteil gibt der Typ sie GAR NICHT heraus, und der Ausgabeparameter bleibt unberuehrt statt still einen lesbaren Wert zu tragen. Erst das Urteil deckt genau die gebundene Reihenfolge auf, in beide Richtungen geprueft. Ein zweites Urteil und ein spaeterer Pegel aendern nichts mehr; jede Sperre traegt ein Wort, und der Passagenwechsel raeumt Urteil, Abgleich und Bindung gemeinsam ab. | `eq-copilot\build\plugin\EqCopSonde013ExperimentUiTest_artefacts\Release\EqCopSonde013ExperimentUiTest.exe` | [OK] Exit 0 | 0,48 s | [B26](roh/SONDE-014-c053be8.md#b26) |
| B21 | RT→Control-Ring fuer hoerbare Eingriffe (M-37 bis M-39, §34.2): ein Begin steht SOFORT zur Abholung bereit, ohne Kadenzfenster - der Unterschied zum 1-Hz-Heartbeat-Bit, das ein 380-Sample-Ereignispaar nie gesehen haette. Ein Ende traegt einen Nachlauf, der mindestens so lang ist wie der Eingriff selbst, UND dessen Dauer, damit ein Empfaenger die Konservativitaet pruefen statt sie glauben kann. Der Ueberlauf ist die schaerfste Zusage: dieser Ring verwendet KEIN drop-oldest, das aelteste Ereignis steht unveraendert an erster Stelle, der Ueberlauf ist sticky gemeldet und gezaehlt, der Rest kommt lueckenlos aufsteigend heraus, und das Sticky-Bit heilt nicht von selbst - nur resync() loescht es. 200 Runden Schreiben, Lesen und Abfragen erzeugen NULL Allokationen, mit Zaehler gemessen statt behauptet (M-74). Sequenzen am u64-Rand kommen unveraendert zurueck, und zuruecksetzen() leert Ring, Sticky-Bit und Zaehler gemeinsam. | `eq-copilot\build\plugin\EqCopSonde013InterventionRingTest_artefacts\Release\EqCopSonde013InterventionRingTest.exe` | [OK] Exit 0 | 0,07 s | [B21](roh/SONDE-014-c053be8.md#b21) |
| B19 | Bandweise Stereoevidenz (§40.1, §40.3, M-08/M-10/M-11/M-12): die fuenf Klassen aus §40.3 treffen ihre ANALYTISCH bekannte Antwort - Mono ergibt Korrelation 1, Kohaerenz 1, Phase 0 und Folddown 0 dB innerhalb der 0,25 dB aus §40.3; Polaritaetsinvertierung ergibt Korrelation -1 bei Kohaerenz 1 (die Kohaerenz misst den Zusammenhang, nicht das Vorzeichen) und eine Monosumme, die an die Vertragsgrenze laeuft statt zu schweigen; eine bekannte Laufzeit ergibt eine Phase, die der Formel +2*pi*f*tau folgt, an drei Traegerfrequenzen gemessen; unkorrelierte Kanaele fallen in Korrelation und Kohaerenz, und bei niedriger Kohaerenz entsteht keine Lag- oder Polaritaetsempfehlung. Seit NAK-182 faehrt ein Sweep dieselben fuenf Klassen und den Folddown ueber die 18 Blockgroessen 1, 2, 3, 7, 15, 16, 31, 64, 127, 128, 333, 512, 1024, 2048, 4096, 8192, 12345 und 16384 - je Blockgroesse dieselbe Antwort, je Blockgroesse ein wirklich entstandenes Evidenzfenster und vergleichbar viele gemittelte Fenster (Freiheitsgrade innerhalb 20 Prozent des Medians). Das ist eine AUSWAHL aus 1 bis 16384 und keine Erschoepfung: die Obergrenze ist die Slotkapazitaet des Layouts, 256 zum Beispiel bleibt ungemessen. Seit Nacharbeit 1 wertet der Sweep bei bekannter Laufzeit ALLE DREI Traeger aus - 300, 900 und 2000 Hz, je Blockgroesse mit Praesenzbit und Phasenfehler gegen +2*pi*f*tau innerhalb 0,25 rad -, und der Unkorreliert-Fall misst je Blockgroesse zusaetzlich, dass KEIN Band mit Basis eine Phase traegt; das sind dieselben Felder, die der 512er-Abschnitt fuer M-12 nutzt. | `eq-copilot\build\plugin\EqCopSonde013StereoGoldenTest_artefacts\Release\EqCopSonde013StereoGoldenTest.exe` | [OK] Exit 0 | 1,92 s | [B19](roh/SONDE-014-c053be8.md#b19) |
| B17 | True Peak nach ITU-R BS.1770-5 (M-02): der 8-fach-Polyphaseninterpolator trifft die fuenf True-Peak-Testfaelle aus EBU Tech 3341 (15 bis 19) innerhalb der SCHAERFEREN Toleranz aus §49.3, also +/-0,1 dB statt der +0,2/-0,4 der Norm; gemessen wird gegen die ANALYTISCHE Referenz - die Signale sind Sinus mit definierter Frequenz, Amplitude und Phase, und der wahre Scheitel eines Sinus IST seine Amplitude, also steht keine zweite eigene Implementierung als Vergleich dahinter. Der Gegenbeleg zeigt, dass ein Detektor ohne Ueberabtastung bei Testfall 16 um 3,01 dB zu optimistisch waere. Der Sampleraten-Sweep ueber 44,1/48/88,2/96/192 kHz haelt dieselbe Zusage, weil die EBU-Frequenzen an fs gebunden sind. Die 8-fach-Entscheidung wird als ZAHL getroffen: die geschlossene Fehlerschranke der Ueberabtastung haelt bei fs/4 mit Faktor 8 (-0,042 dB) und reisst mit Faktor 4 (-0,169 dB). Raender: Stille ergibt exakt 0, ein NaN bleibt nicht im Filterzustand, ein Gleichanteil bleibt bitgenau er selbst (jede der acht Phasen hat DC-Verstaerkung 1, nicht nur die Gesamtsumme 8), und ohne vorbereiten() misst der Detektor gar nicht, statt zu raten. | `eq-copilot\build\plugin\EqCopSonde013TruePeakGoldenTest_artefacts\Release\EqCopSonde013TruePeakGoldenTest.exe` | [OK] Exit 0 | 0,11 s | [B17](roh/SONDE-014-c053be8.md#b17) |
| B18 | Loudnessfenster, Headroom und Dynamik (M-01, M-03, M-04, M-07, M-09): Momentary (400 ms) und Short-term (3 s) sind wirklich zwei Fenster - bei stehendem Pegel gleich, 0,8 s nach einem Pegelsprung mehr als 5 LU auseinander, danach wieder beieinander; nach 0,6 s traegt der Frame Momentary und KEIN Short-term. integration_samples passt im Dauerbetrieb zur 10-Hz-Kadenz und faellt beim ersten Rahmen nach einer Grenze messbar kleiner aus. PSR rechnet gegen das True-Peak-Maximum DESSELBEN 3-s-Fensters, nicht gegen den Sample-Peak des 100-ms-Rahmens; die Engine setzt selbst kein PLR, weil LUFS-I erst im Sondenprozessor zugemischt wird. Headroom ist eine Verteilung: zwei Signale mit gleichem Maximum trennen sich um mehr als 10 dB im P50. Crest steht in zwei Fenstern und trennt dichte kleine Spitzen von einer einzelnen grossen. LRA gibt es nach 30 s NICHT, nach 75 s mit passender Spanne, bei Material ohne Dynamik nahe null und nach 90 s Stille gar nicht - die 60-s-Schwelle zaehlt gegatetes Material, keine Wanduhr. NaN und Inf im Eingang erzeugen in keiner der neun neuen Metrikstellen einen nichtendlichen Wert. Ein verworfener Analyseblock schliesst auch die neuen Fenster, und keines von ihnen ueberbrueckt eine Transportgrenze. | `eq-copilot\build\plugin\EqCopSonde013DynamicsTest_artefacts\Release\EqCopSonde013DynamicsTest.exe` | [OK] Exit 0 | 3,94 s | [B18](roh/SONDE-014-c053be8.md#b18) |
| B16 | Evidenzpfad (§33.2): der aus einem echten FeatureFrame erzeugte evidence_snapshot passiert Textriegel und dieselbe Vertragsengine wie B3c; P10/P50/P95 trennen ein springendes von einem ruhigen Signal gleicher mittlerer Lautheit (Spanne P95-P10 um mehr als 6 dB verschieden) und halten in JEDEM Band mit Bit die Ordnung P10<=P50<=P95; die Abdeckung faellt messbar, sobald ganze Analysefenster in Stille liegen, und die Konvergenz faellt bei wanderndem Pegel; der Ereignisstrom traegt Fluss- und Peakbit getrennt samt Verlustzaehler, ein Ereignis fremder Epoche oder ohne Anker entsteht gar nicht. Seit NAK-182 misst dasselbe Bein die C++-Haelfte der fokussierten 0,01-dB-Evidenz (M-83 Satz 2), seit Nacharbeit 1 vollstaendig am SERIALISIERTEN Snapshot: PRE und POST laufen durch den echten Serialisierer, und jede Zahl kommt aus verteilung.p50 des eigenen Wire-Textes - Encoding-Wort, Ganzzahlen und Praesenzbits. Daraus kommt ein bekannter Gain von 3,00 dB je Band mit Bit innerhalb 0,1 dB zurueck, und eine Leiter aus 20 Pegeln im Abstand 0,01 dB - je ein eigener Enginelauf samt Serialisierung - ergibt 20 streng monotone Ganzzahlen, deren Nachbarn sich um genau 1 unterscheiden. Material (Frequenz, Samplerate, Amplitude, Blockgroesse, Laufbegrenzung), Pegel, Gain und Aufloesung kommen aus den ZAHLEN der Fixture evidenz-0p01-paar-wire-v1.json, nicht aus ihren Bytes und nicht aus lokalen Konstanten. | `eq-copilot\build\plugin\EqCopSonde013EventWireTest_artefacts\Release\EqCopSonde013EventWireTest.exe` | [OK] Exit 0 | 0,51 s | [B16](roh/SONDE-014-c053be8.md#b16) |
| B27 | Der musikalische Intent als Projektintent im MainProjectState (§37.1, U22, M-01 bis M-09/M-11). Die Rollenmenge ist GESCHLOSSEN und hat genau fuenf Werte; ein sechster faellt in der Produkt-API UND im Leser, statt still auf einen bekannten Zweig abgebildet zu werden. Die §37.1-Belegung ist ABGELEITET und damit total und injektiv: alle fuenf Rollen kommen ueber den Roundtrip zurueck, keine zwei teilen sich eine Belegung (alle zwanzig geordneten Paare), und eine fremde Belegung gehoert zu keiner Rolle. Schutzangaben sind ORTHOGONAL zur Rolle - eine Quelle ohne Rolle kann Attack geschuetzt haben, und keiner der fuenf Rollenwechsel loescht einen Schutzbereich. Die Rolle bewusst-verschmolzen ist ein globales Veto gegen Entmaskierung; eine ausdrueckliche gerichtete Beziehung hebt es NUR fuer dieses Paar auf, nicht fuer ein drittes. Die Konfliktregeln sind eine geordnete Liste, kein Score: alle zehn Paarungen der fuenf Stufen fallen in beiden Leserichtungen, hundert Vermutungen schlagen die Schutzgrenze nie, und innerhalb Stufe 2 gewinnt das Spezifischere. Ein Zyklus im fuehrt_vor-Graphen erreicht die Persistenz NIE unmarkiert - die Pruefung laeuft beim Speichern, der Leser weist einen von Hand gebauten Zyklus als read-only ab, und derselbe Schluss als gleichrangig gespeichert laedt und kommt als gleichrangig zurueck. Eine abgeleitete Vermutung ueberschreibt einen Userwert nie, der umgekehrte Weg gilt. Derselbe Bus traegt verschiedene Rollen in zwei Passagen ohne Datenverlust, passagespezifisch vor global. Dazu die fuenf Teile der State-Invariante: Fassung im Namen, Altstand ohne die Felder laedt bytegleich, eine unbekannte Eigenschaft ueberlebt, Save/Load ueber zwei Runden bytegleich, und jede echte Aenderung meldet GENAU einmal Host-Dirty, waehrend No-op, abgewiesener Wert, Laden und read-only schweigen. Jede Grenze faellt von BEIDEN Seiten (17 Leserfaelle samt NaN/Inf-Konfidenz, Revision 0, Bandrand 0/221 und Selbstbeziehung), und die volle 256er-Liste, die die API erzeugt, laedt der eigene Leser. Zuletzt M-11 am Produktpfad: zwei echte Prozessoren mit demselben Strom, einer mit vollem Intent, liefern bitgleiche Evidenzbaender, Perzentile, Livebaender, metrics_version und NaN-Zaehler - mit Gegenprobe, dass die Baender wirklich Werte tragen. | `eq-copilot\build\plugin\EqCopSonde014IntentTest_artefacts\Release\EqCopSonde014IntentTest.exe` | [OK] Exit 0 | 0,43 s | [B27](roh/SONDE-014-c053be8.md#b27) |
| B29 | Die Zustandsmaschine des AssistantStep im Main (46.1, E-07/E-08, M-55 bis M-62). Die Zustandsmenge hat ACHT Werte, jeder kommt ueber seinen eigenen Rueckweg zurueck, ein neunter faellt. Nach preview fuehrt KEINE Kante - weder hin noch zurueck -, ein gespeicherter preview-Schritt ist ein Lesefehler statt eines stillen Sprungs, und die Produkt-API setzt ihn nicht; die Gegenprobe mit proposal laedt normal. Jeder der acht Zustaende traegt fuenf Angaben (Eintritt, Evidenz, Useraktion, Timeout ueber 0, sichere Rueckkante), auch preview - der erste Zustand ist seine eigene Rueckkante. Der Deckel ist STRUKTURELL: ein zweiter Startversuch bei offenem Schritt wird abgewiesen, nicht eingereiht, und erst nach dem terminalen Abbruch beginnt ein neuer. Die vier Gegenpfade laufen einzeln: Zurueck geht auf die Rueckkante, Ueberspringen auf den naechsten Zustand, Resume ist eine FRAGE ohne Revisionssprung, und Verwerfen ist terminal statt geloescht - danach gibt es kein Resume mehr. Die drei benannten Ergebnisse aus 46.2 sind eigene Ergebnisse mit Objekt; dasselbe zweimal hebt keine Revision. Die harten Gates greifen VOR der Gewichtung: drei Kandidaten mit perfektem Rang und je einem gerissenen Gate verlassen die Liste, ein bescheidener bleibt. Verdrahtet am echten Prozessor mit Host-Dirty genau einmal je echter Aenderung, Rekonstruktion aus dem gespeicherten MainProject und bytegleichem Save/Load; jede Grenze faellt von beiden Seiten, und ein Altstand ohne die Eigenschaft laedt normal und schreibt sie nicht. | `eq-copilot\build\plugin\EqCopSonde014AssistentTest_artefacts\Release\EqCopSonde014AssistentTest.exe` | [OK] Exit 0 | 0,18 s | [B29](roh/SONDE-014-c053be8.md#b29) |
| B28 | Die Befundzustaende auf der Gen-Seite (Abnahme U21, M-29 bis M-35). Die drei Sicherheitsstufen sind auf GENAU DREI Zustaende abgebildet, und die Abbildung ist ein FELD: ein vierter Wert macht den ganzen Snapshot ungueltig, statt still auf einen bekannten zu fallen. Nur READY TO SEND erlaubt HOLD TO AUDITION und SEND DRAFT - die Sperre liegt am Befund im Modell, nicht an einer ausgegrauten Schaltflaeche. Messqualitaet der Passage und Sicherheit des Befunds bleiben zwei Felder aus zwei Quellen: ein Befund mit confidence.class hoch, dessen Zustand more_data sagt, bleibt nicht handelbar. Alternativen sind EIGENE Befunde mit eigenem Zustand und reisen als IDs; ein Freitext faellt. Der Beleg ist die markierte Zone - Bandrand 0 und 221 gueltig, leeres Intervall und 222 nicht -, und ein Belegtextfeld gibt es nicht. Die drei Anzeigezeilen sind drei eigene Felder; eine vierte oder eine leere faellt. Die acht Ausschlussgruende kommen mit ihrem Grund an, ein neunter faellt. Jede Zahl faellt an ihrer Grenze und nicht erst danach. Zuletzt die Fassungsleiter: ein Leser der Fassung 2 lehnt findings ab, Abwesenheit heisst keine Befunde, und ein Sitzungswechsel raeumt sie ab. Seit Etappe E dazu der Maskierungswert AM Befund: er benennt Frequenzbereich und beide Quellen, gueltig und herabgesetzt sind zwei eigene Bits, Abwesenheit ist etwas anderes als ein ungueltiger Wert, und ein Objekt beliebiger Form faellt - sechs Formen einzeln geprueft. Eine Zeichenanweisung (Achse, Zoom, Farbe) faellt am Vertrag, auch im Maskierungswert. | `eq-copilot\build\plugin\EqCopSonde014BefundTest_artefacts\Release\EqCopSonde014BefundTest.exe` | [OK] Exit 0 | 0,14 s | [B28](roh/SONDE-014-c053be8.md#b28) |
| B8 | Lifecycle-Klassifikation §53.5 bleibt erhalten; SONDE-011 startet den Broker nur ueber state::Lebenslauf::darfBrokerStarten() bei Main plus offenem Editor. Alle Negativzustaende lassen den Launcher unberuehrt, und die instrumentierte Gegenprobe misst null Broker-Lifecycle-Aufrufe aus processBlock beziehungsweise dem Audiothread. | `eq-copilot\build\plugin\EqCopLebenslaufTest_artefacts\Release\EqCopLebenslaufTest.exe` | [OK] Exit 0 | 0,29 s | [B8](roh/SONDE-014-c053be8.md#b8) |
...
**Lauf:** 2026-09-07 14:46 | **Runner:** `tools/beweise.ps1` | **Urteil:** GRUEN - 60/60 Kanon-Laeufe bestanden | 2 geplante Pruefung(en) noch nicht gebaut | 1 stillgelegte(s) Bein(e), siehe Uebersicht | **Exitcode:** 0 | **Rohausgabe:** [roh/SONDE-014-4df8855.md](roh/SONDE-014-4df8855.md)

### Kopf - woran gemessen wurde

| Feld | Wert |
|---|---|
| Zeitpunkt | 2026-09-07 14:46:36 +02:00 |
| Rechner | SCHUBBINATOR200 \| Windows 10.0.26200.0 |
| Zweig | master |
| Commit | 4df8855 SONDE-014 Wiederpruefung 4 (Konvergenzrunde): Astra max PASS, Thread 01a07bdf |
| Commit (voll) | 4df88554940234a72f520e0dabff6bfcb50e790a |
| Arbeitsbaum | sauber |
| JUCE gepinnt | 8.0.9 |
| JUCE auf Platte | 8.0.9-dirty |
| FL Studio | FL Studio 2025 25.2.5.5319 \| FL Studio 2026 26.1.4.5589 |
...
| # | Behauptung | Befehl | Ergebnis | Dauer | Rohausgabe |
|---|---|---|---|---|---|
| A1 | Passthrough ist bitgleich; 0 Samples Latenz, 0 Tail; NaN/Inf werden gezaehlt, aber nicht veraendert. | `eq-copilot\build\plugin\EqCopNullTest_artefacts\Release\EqCopNullTest.exe` | [OK] Exit 0 | 0,07 s | [A1](roh/SONDE-014-4df8855.md#a1) |
| A2 | AnalyseEngine deckt sich mit der eingefrorenen Offline-Referenz (Fixture-SHA-256 als Determinismus-Riegel). | `eq-copilot\build\plugin\EqCopGoldenTest_artefacts\Release\EqCopGoldenTest.exe eq-copilot\fixtures` | [OK] Exit 0 | 12,01 s | [A2](roh/SONDE-014-4df8855.md#a2) |
| A3 | Hoer-Markierung bleibt verriegelt: Render/Freilauf bitgleich, Analyse-Abgriff sitzt vor der Faerbung, und der U10-Term ist gedeckt - OHNE Playhead faerbt bei sonst voller Erlaubnis kein Sample (T11, mit Gegenprobe bei laufendem Transport). | `eq-copilot\build\plugin\EqCopMarkierungTest_artefacts\Release\EqCopMarkierungTest.exe` | [OK] Exit 0 | 28,67 s | [A3](roh/SONDE-014-4df8855.md#a3) |
| A4 | Broker-Vertragstests: eingefrorene v2/v3-Vertraege sowie SONDE-011 Phase B mit Coordinator/Session, monotoner Liveness/Eviction, SQLite-Migration 1, Single-Writer, Projektionen, Snapshot-Outbox, dauerhaften Konfliktriegeln, produktiver v2+v3-Verdrahtung und der nicht isolationspflichtigen Killmatrix. Seit SONDE-013 zusaetzlich die Fassungsleiter (jede Minorfassung wird aus der committeten zurueckgebaut, der Leser der Fassung 1 lehnt jede Neuerung der Fassung 2 ab, Fassung 0 erbt den Rueckbau) und der Empfaenger des evidence_snapshot: fremde Adresse verworfen, offene Intervention sperrt statt abzuschwaechen, nach Ende und Nachlauf nimmt er wieder an. Seit SONDE-014 zusaetzlich der Intent- und Assistentenspiegel (Koaleszierung je Quelle/Scope, keine Rechnung vor der Vollstaendigkeitsmarke) und der URSACHENPFAD: aus paralleler Telemetrie entsteht nie Aussageklasse 2 oder 3, das Screening reicht hoechstens fuenf Kandidaten weiter, fehlende Coverage und falsches Alignment sind ein GATE vor der Gewichtung und tragen einen Grund aus der geschlossenen Achtermenge, eine Passage unter GATE_MINDEST_FENSTER traegt keine starke Aussage (mit Gegenprobe an der Kante 7/8), eine Ruecknahme invalidiert die abhaengigen Hypothesen deterministisch, und hundert Laeufe ueber dieselben Bytes liefern bytegleich dieselbe Rangfolge. Seit Etappe F dazu die Proposal-Policy: ein Vorschlag entsteht MIT seinem Befund und traegt die fuenfzehn Felder aus 42.1 plus revert, der Rueckweg ist ein FELD mit drei Werten (dsp_revert faellt), in P5 ist jede Aktion manual, keine Aenderung und mehr Daten sind vollstaendige Objekte, der Zielbereich kommt aus dem Band des Befunds statt aus dem groessten Banddelta, ein geschuetztes Band ist eine HARTE Constraint mit Gegenprobe, ein stop_if auf einem nicht messbaren Guardrail meldet MORE DATA, und ueber fuenfhundert zufaellige Eingaenge wird kein Hard Cap und keine engere Usergrenze ueberschritten. Der Guardrail-Rechner LIEST seit E-05 den Zielbereich aus experiment_begin.ziel; ohne ihn bleibt die Heuristik und das Resultat traegt ziel_geraten - beide Pfade mit verschiedener Zahl gemessen. | `cargo test --manifest-path broker/Cargo.toml --color never` | [OK] Exit 0 | 962,83 s | [A4](roh/SONDE-014-4df8855.md#a4) |
| A4-SI | SONDE-011 Phase-B-Systemintegration auf Probe-Pipenamen: echter C++-ControlClient wiederholt persistenzpflichtige Befehle ueber Brokerkills mit derselben command_id; Store/Coordinator liefern nur absolute session_snapshot-Pushes, koaleszieren Snapshot-Schuld, halten Locks aus externer Arbeit heraus und bereinigen Eviction/Nonce vor spaeterem Push. | `cargo test --manifest-path broker/Cargo.toml --color never --test store_crash_matrix -- --ignored --test-threads=1` | [OK] Exit 0 | 13,62 s | [A4-SI](roh/SONDE-014-4df8855.md#a4-si) |
| A4b | C++-PipeClient: stop/reconnect und ganze Frames sind zeitlich begrenzt, SQOS ist Identification, Peerbytes sind UTF-8/NUL-sauber, ACK-Sequenzen streng und u64-Zaehler wire-sicher. | `eq-copilot\build\plugin\EqCopPipeClientTest_artefacts\Release\EqCopPipeClientTest.exe` | [OK] Exit 0 | 66,66 s | [A4b](roh/SONDE-014-4df8855.md#a4b) |
| A5 | Referenzbein (jsonschema, draft 2020-12): Schema haelt die Engine-Teilmenge ein, Textriegel deckt jede gemessene Kante, jedes Fixture wird wie im Manifest klassifiziert, jede Definition hat ein Negativfixture. Seit SONDE-013 zusaetzlich der Fassungsschritt: der aus dem Register zurueckgebaute Leser der Fassung 1 LEHNT jede Neuerung der Fassung 2 ab (drei Experimentfamilien, evidence_snapshot.ereignisse/.stereo, zwei neue Invalidierungsgruende), und die Summe der registrierten Familien stimmt mit dem oneOf ueberein. | `py -3.13 tools\eq-copilot\pruefe_v3_vertrag.py --abdeckung` | [OK] Exit 0 | 3,54 s | [A5](roh/SONDE-014-4df8855.md#a5) |
| A6 | Beide Bandgitter sind bytegleich zur Neuerzeugung; 221 Baender, 64 Gruppen als exakte Partition. | `py -3.13 tools\eq-copilot\erzeuge_bandgitter.py --pruefen` | [OK] Exit 0 | 0,17 s | [A6](roh/SONDE-014-4df8855.md#a6) |
| A7 | Quantisierungsvertrag bytegleich zur Neuerzeugung; Rundung, Saettigung und Nichtendliches als Testvektoren. | `py -3.13 tools\eq-copilot\erzeuge_quantisierung.py --pruefen` | [OK] Exit 0 | 0,17 s | [A7](roh/SONDE-014-4df8855.md#a7) |
| A8 | Fixture-Korpus und MANIFEST bytegleich zur Neuerzeugung; keine verwaiste Datei. | `py -3.13 tools\eq-copilot\erzeuge_v3_fixtures.py --pruefen` | [OK] Exit 0 | 0,29 s | [A8](roh/SONDE-014-4df8855.md#a8) |
| A9 | Codegen-Drift ist 0: die Neugenerierung aus dem .fbs ist bytegleich zum committeten C++- und Rust-Code; flatc, C++-Header und Rust-Crate tragen dieselbe gepinnte Version; jedes Tabellenfeld traegt eine explizite Feld-ID. | `py -3.13 tools\eq-copilot\pruefe_flatc_drift.py` | [OK] Exit 0 | 0,51 s | [A9](roh/SONDE-014-4df8855.md#a9) |
| A10 | Binaerer Fixture-Korpus und sein MANIFEST bytegleich zur Neuerzeugung; keine verwaiste Datei; sechs NAK-29-Transportrelationen, band_stereo ID 10 samt saturated-/Grenzfaellen und integration_samples ID 14 (voller Rahmen, duenner Rahmen, gesendete 0 als Senderfehler) sind in beiden Lesern gedeckt. | `py -3.13 tools\eq-copilot\erzeuge_fb_fixtures.py --pruefen` | [OK] Exit 0 | 2,87 s | [A10](roh/SONDE-014-4df8855.md#a10) |
| A11 | Die fuenf v2-Vertraege (ipc v2, measurement v1, report v1, snapshot v3, aggregat v1) sind gueltiges JSON und gueltige JSON-Schemas; ihre $id-Familie ist eingefroren. | `py -3.13 tools\eq-copilot\pruefe_v2_schemas.py` | [OK] Exit 0 | 0,34 s | [A11](roh/SONDE-014-4df8855.md#a11) |
| A12 | Parameterbestand (109 IDs, §53.8) haelt den Vertrag; RFC-8785-Zahlenvektoren tragen den RFC-Text und werden von rfc8785 bestaetigt; State-Fixture-Korpus und MANIFEST bytegleich zur Neuerzeugung. | `py -3.13 tools\eq-copilot\erzeuge_state_fixtures.py --pruefen` | [OK] Exit 0 | 0,42 s | [A12](roh/SONDE-014-4df8855.md#a12) |
| A13 | Capabilityreport FL: die zehn Bits aus §53.6 entsprechen der v3-Vertragsform und stehen so, wie die Rohdaten der Termine A und B sie tragen; jedes supported hat einen Termin, jedes unsupported seinen festen Fallback. | `py -3.13 tools\eq-copilot\pruefe_host_capabilities.py` | [OK] Exit 0 | 0,31 s | [A13](roh/SONDE-014-4df8855.md#a13) |
| A14 | Der gemeinsame Kern traegt keine Bundle-Identitaet (Entwurf §53.4): NakamaKern.lib wird vor der Messung geloescht und von MSBuild neu erzeugt (jede Kernquelle uebersetzt, Objekte und Lib juenger als der Zeitanker, Objektzahl = Quellzahl), enthaelt danach keinen eingefrorenen Identitaetswert aus plugin-identities-v1.json (Text in ASCII/UTF-16LE, Viercodes als Integer beider Byteordnungen, CIDs roh und COM-vertauscht) und genau die erwarteten Kernobjekte ohne JUCE-Modulobjekt; die Gegenprobe findet die Pflichtnadeln im gebauten Gen-Bundle, sonst waere das Schweigen ueber den Kern wertlos. Fehlende Voraussetzung (kein Neubau, Artefakt nicht auffindbar, --nur-messen) endet mit Exit 3, mit registriertem Befund mit 2, nie mit 0. Seit NAK-100 (30.08.2026) ohne K1b-Textscan, Ortsriegel, JUCE-Baum-Riegel und Frischewachen (Haertung NAK-103). | `py -3.13 tools\eq-copilot\pruefe_kern_identitaetsfrei.py` | [OK] Exit 0 | 8,01 s | [A14](roh/SONDE-014-4df8855.md#a14) |
| A17 | Installer-Manifest: keine zweite Identitaet (kein Viercode, keine Class-ID, kein Produkt- oder Bundlename ausser im Pfad), jeder Quellpfad ist der aus Ziel + Identitaetsdatei nachgerechnete Bundle-Ordner, `art` ist eine geschlossene Menge, jedes aktive Ziel genau einmal und jedes stillgelegte benannt mit lesbarer Marke, Broker aus dem Crate-Namen, Zielverzeichnisse geschuetzt, Signaturzeile ehrlich, Rueckweg samt NAK-41-Riegel und hash_art vollstaendig; jede der 15 Regeln faellt an einem verdorbenen Manifest, die konkreten Umgehungen fallen einzeln. [4] vergleicht Artefakthashes im Kanon weich und mit --release hart; [4b] berichtet den installierten Stand; [5] kreuzprueft den Ordner-Hash; [6] faehrt die produktive C++-WinVerifyTrust-/Thumbprint-Kette mit dem OS-vertrauenswuerdigen Signerzertifikat einer signierten Windows-Fixture fuer gueltig und falsch sowie einer unsigned Temp-Kopie fuer fehlend, ohne den Zertifikatsspeicher zu aendern. Jede gelesene JSON-Datei wird vor dem Zugriff strukturell geprueft; unerwartete Ausnahmen enden kontrolliert. | `py -3.13 tools\eq-copilot\pruefe_installer_manifest.py` | [OK] Exit 0 | 1,37 s | [A17](roh/SONDE-014-4df8855.md#a17) |
| A18 | Gegenpfad installieren<->Rueckweg gefahren (Sandbox, nichts installiert): Erstinstallation traegt moduleinfo.json, ein Tausch ersetzt statt zu mischen, -Pruefen sieht den ganzen Ordner, der Rueckweg stellt den Vorzustand bytegleich her und laesst KEIN leeres .vst3-Gehaeuse stehen, selbst angelegte Ordner verschwinden nur leer, der NAK-41-Riegel greift und zerstoert seine eigene Wiederholungsquelle nicht, eine dritte Artefaktsorte bricht ab. | `py -3.13 tools\eq-copilot\pruefe_installer_gegenpfad.py` | [OK] Exit 0 | 42,21 s | [A18](roh/SONDE-014-4df8855.md#a18) |
| A19 | BandGridZahlen.h ist bytegleich aus den zwei eingefrorenen Gitterfixturen erzeugt; die 64 Live-Gruppen partitionieren die 221 Feinbaender lueckenlos und ueberschneidungsfrei, und die groben Kanten sind bitgleiche Kopien feiner Kanten (kein zweites Filterbank-Gitter). | `py -3.13 tools\eq-copilot\erzeuge_bandgitter_header.py --pruefen` | [OK] Exit 0 | 0,16 s | [A19](roh/SONDE-014-4df8855.md#a19) |
| A20 | Envelope-Fixture-Korpus und MANIFEST bytegleich zur Neuerzeugung; keine verwaiste Datei; jede der 14 Envelope-Regeln hat mindestens ein Negativfixture. | `py -3.13 tools\eq-copilot\erzeuge_envelope_fixtures.py --pruefen` | [OK] Exit 0 | 0,34 s | [A20](roh/SONDE-014-4df8855.md#a20) |
| A21 | v3-Envelope unter Zufall: 20 000 Zufallspuffer bringen den Pruefer nie aus dem Tritt und JEDER angenommene Frame erfuellt jede Kopfregel; 3000 gekippte P2-Payloadbits fallen einzeln an der CRC; feindliche Laengen (0, 15, ueber der Grenze, 0xFFFFFFFF) und die u32-Grenze von 16+payload_len enden in der erwarteten Fehlerklasse, ohne Absturz und ohne Eingabeallokation in Groesse der behaupteten Laenge; 300 Runden Fragmentierung (byteweise und in Zufallshaeppchen) liefern exakt dieselben Frames; ein kaputter Frame beendet den Strom statt zu resynchronisieren; die Ratengrenze haelt unter Flut. | `cargo test --manifest-path broker/Cargo.toml --test transport_fuzz --color never` | [OK] Exit 0 | 0,36 s | [A21](roh/SONDE-014-4df8855.md#a21) |
| A22 | Ende-zu-Ende ueber die PROBE-Pipe, zwei Sprachen ein Draht: 32 echte C++-Sondenpaare koppeln sich am echten Rust-Listener (32 Control + 32 Telemetry, jede Telemetrieverbindung ueber link_id + challenge + gleiche runtime_nonce), fluten P2 bis die Schleuse mit Cap 2 nachweislich ersetzt, und WAEHRENDDESSEN geht kein einziger P0-Frame verloren; die P0-Antwortlatenz bleibt unter der Schranke. Keine Verbindung wird wegen Envelope, Rate oder P0-Ueberlauf geschlossen. | `py -3.13 tools\eq-copilot\pruefe_ipc_last.py` | [OK] Exit 0 | 10,98 s | [A22](roh/SONDE-014-4df8855.md#a22) |
| A24 | G3-SOAK Dauerlauf ueber eine ausschliessliche Probe-Pipe: 1 Main mit subscribe_session und echtem SourcesModel plus 16 Sondenpaare und 16 echte SondeProcessor am Ganzblockpfad laufen gegen den echten Rust-Coordinator, waehrend ein Viertel der Sonden langsam liest und der Broker mitten im Lauf getoetet und neu gestartet wird. Gemessen: Mitgliedschaft und fuehrendes_main driften nie, kein P0 geht ausserhalb der Neustartfenster verloren und seine ACK-p95 bleibt unter 1.000 ms, kein Mitglied wird ausserhalb der Fenster stale oder evicted, der Snapshot ist nach jedem Neustart binnen 60 s wieder vollstaendig und die alte broker_epoch kommt nie wieder, Working Set beider Prozesse waechst je Generation um hoechstens max(10 %, 16 MiB), und der Sondenpfad verliert keinen Ganzblock. Beide Programme verweigern Produktions- und Golden-Pipename mit Exit 3, gefahren vor dem Lauf. Seit SONDE-013 laeuft dabei der Evidenzpfad mit: jede Sonde baut oberhalb einer kleinen P1-Fuellstandsschwelle GAR KEINEN evidence_snapshot mehr und zaehlt den verworfenen Analyseframe, statt die in EINTRAEGEN gedeckelte P1-Queue mit 10-KiB-Nachrichten zu fuellen. | `py -3.13 tools\eq-copilot\pruefe_session_soak.py --sonden 16 --minuten 2 --neustarts 1` | [OK] Exit 0 | 149,37 s | [A24](roh/SONDE-014-4df8855.md#a24) |
| A28 | Der P5-Evaluationskorpus ist reproduzierbar (Muster A25): der Erzeuger baut jede Datei BYTEGLEICH neu, --pruefen vergleicht den committeten Bestand gegen die Neuerzeugung samt SHA-256 im Manifest, und eine verwaiste Datei faellt. Zusaetzlich der Hygieneriegel aus NAK-182 R2: der Bezeichner des Kettenbeins steht WOERTLICH in seiner Datei, sonst waere der Name ein Etikett. | `py -3.13 tools\eq-copilot\erzeuge_p5_korpus.py --pruefen` | [OK] Exit 0 | 0,17 s | [A28](roh/SONDE-014-4df8855.md#a28) |
| A29 | Das Sammelbein des P5-Exit-Gates (59 Punkt 6, 36.4, M-64 bis M-70, R2). Es ist das dritte Glied einer KETTE: der Korpus traegt die Wahrheit, broker/tests/sonde014_p5_korpus.rs faehrt jede Sitzung durch p1 und schreibt die TATSAECHLICH ausgegebene Hypothese, und dieses Bein haelt beides gegeneinander - eine falsche starke Produktbehauptung aendert den Korpus nicht, sie faellt am Vergleich. Precision und Recall stehen JE URSACHENKLASSE, dazu Brier, Kalibrierung, Coverage und Enthaltungsrate; die vier Riegel (falsche_starke, falsche_schwache, precision und recall in [0,1]) laufen je Klasse und ueber die Gesamtmenge. Die Schwelle aus M-31 ist AUSGABE: gesucht wird die niedrigste Sicherheitsstufe, deren Riegel halten. Der Startwert von GATE_MINDEST_FENSTER wird an den zwei Passagensitzungen kalibriert. Ohne frische Ergebnisdatei meldet das Bein Voraussetzung-fehlt (Exit 3) statt gruen. | `py -3.13 tools\eq-copilot\pruefe_p5_korpus.py` | [OK] Exit 0 | 0,27 s | [A29](roh/SONDE-014-4df8855.md#a29) |
| A30 | Der Selbsttest des P5-Sammelbeins (M-68, Muster A27). Er laeuft OHNE Repo-Fixture: die Faelle entstehen im Speicher und laufen durch DIESELBEN Funktionen, die das Sammelbein fuehrt. Jede Erwartung laeuft mit ihrem GEGENTEIL - eine falsche starke Behauptung und die richtige daneben, eine Enthaltung und dieselbe Menge ohne sie, ein leerer Satz und ein voller. Die vier Riegel werden synthetisch gefuettert und muessen fallen: precision > 1, recall > 1 und brier > 1 sind ueber den Korpusweg strukturell unerreichbar, und eine Wache ohne ausfuehrbaren Negativtest ist keine gemessene Zusage. Zuletzt die Schwellensuche in beide Richtungen. | `py -3.13 tools\eq-copilot\pruefe_p5_korpus.py --selbsttest` | [OK] Exit 0 | 0,16 s | [A30](roh/SONDE-014-4df8855.md#a30) |
| A25 | Der P4-Referenzkorpus ist reproduzierbar (M-80): der Erzeuger baut jede Datei BYTEGLEICH neu, --pruefen vergleicht den committeten Bestand gegen die Neuerzeugung samt MANIFEST und meldet jede verwaiste Datei. Dasselbe Muster wie A6, A7, A8, A10, A12 und A20; die gitattributes-Regel haelt die Zeilenenden. Seit NAK-182 weist der Erzeuger ausserdem ab, was der Korpus nicht tragen darf: eine Wahrheit ausserhalb der geschlossenen Menge, eine fehlende `quelle` und einen Bezeichner, der in der genannten Datei nicht woertlich steht. Die zwei Mengen KEINE_BEHAUPTUNG und KEINE_STARKE sowie die Zeile `nicht_gemessen` reisen im MANIFEST mit, damit der Pruefer sie von dort liest statt aus einer zweiten Kopie. | `py -3.13 tools\eq-copilot\erzeuge_p4_korpus.py --pruefen` | [OK] Exit 0 | 0,21 s | [A25](roh/SONDE-014-4df8855.md#a25) |
| A26 | Das Sammelbein des P4-Exit-Gates (§58, §49.4, M-79/M-81 bis M-85): vier Klassen - Referenzkorpus, Loop-/Seek-/PDC-Goldens, adversariale Vergleichsfixtures und Stereo-Goldens -, alle muessen bestehen, und jedes genannte Bein steht wirklich im Kanon-Runner. Neben Precision und Recall zaehlen Kalibrierung, Brier Score, Coverage, Enthaltungsrate und die Zahl FALSCHER Behauptungen; die muss null sein. Eine Enthaltung ist dabei kein Fehler - §49.4 woertlich: ein konservatives unsicher ist besser als eine ueberzeugende falsche Ursache. Seit NAK-182 liest das Bein zwei geschlossene Wahrheitsmengen AUS DEM MANIFEST: auf KEINE_BEHAUPTUNG (unbekannt, unvergleichbar, zeitvariabel) ist jede Aussage falsch, auch die schwache; auf den zwei Werten, die nur in KEINE_STARKE stehen (nicht_kausal, nicht_exakt), ist es die starke. Zaehler und Nenner von Recall lesen dieselbe Menge, Precision und Recall sind als Quoten geriegelt, jeder Korpusfall nennt eine Quelldatei samt woertlichem Bezeichner und wird dort gesucht, die fuenf geschlossenen Mengen des v3-Vertrags werden auf kausale Bezeichner geprueft (Entscheid G4 §8), und die in P4 NICHT gemessene Zusage M-85 Ziel 1 wird im Kopf gedruckt statt still zu fehlen. | `py -3.13 tools\eq-copilot\pruefe_p4_korpus.py` | [OK] Exit 0 | 0,17 s | [A26](roh/SONDE-014-4df8855.md#a26) |
| A27 | Der Selbsttest des Exit-Gate-Beins (NAK-182 R1, MP1-6). Er laeuft OHNE Repo-Fixture: die Faelle entstehen im Speicher und laufen durch dieselben Funktionen, die A26 fuehrt. Auf dem Korpusweg fallen eine STARKE Aussage auf jedem Wert aus KEINE_STARKE und eine SCHWACHE auf jedem Wert aus KEINE_BEHAUPTUNG; eine schwache Aussage auf nicht_kausal oder nicht_exakt bleibt gruen - genau das trennt die zwei Mengen. Auf dem Kennzahlweg bekommt die Riegelfunktion synthetische Kennzahlen direkt eingespeist, weil Recall und Precision ueber 1 nach der Zweimengenlogik strukturell unerreichbar sind und die Wachen trotzdem einen Weg zu fallen brauchen. Dazu ein erfundener Bezeichner, ein Pfad ins Leere, eine fehlende Vertragsmenge und ein kausaler Enumwert. Seit Nacharbeit 1 laeuft auch S-07 durch die echte Validierung: ein synthetischer Fall mit einer Wahrheit ausserhalb ERLAUBTE_WAHRHEITEN geht durch dieselbe Funktion _pruefe_wahrheiten, die A26 auf den geladenen Korpus anwendet, und muss genau eine rote Zeile mit dem Fallnamen ergeben; sein Gegenteil keine. Jede Erwartung laeuft MIT ihrem Gegenteil - sonst waere der Selbsttest auch dann gruen, wenn ein Riegel immer rot meldete. | `py -3.13 tools\eq-copilot\pruefe_p4_korpus.py --selbsttest` | [OK] Exit 0 | 0,35 s | [A27](roh/SONDE-014-4df8855.md#a27) |
| A23 | SONDE-012 E-L06 integriert ueber eine ausschliessliche Probe-Pipe: synthetische C++-Quellen senden vollstaendige Messfenster durch den echten Rust-Coordinator an das echte Main-SourcesModel. Der Endpunkt ist dessen Revision samt Anzeige-Invalidierung. Bei 16 und 32 Quellen liegt p95 fuer 2048/4096 Samples unter 300 ms und fuer 16384 Samples unter 750 ms, jeweils ab dem ersten Sample des Fensters. | `py -3.13 tools\eq-copilot\pruefe_sonde012_sources_latency.py` | [OK] Exit 0 | 5,62 s | [A23](roh/SONDE-014-4df8855.md#a23) |
| A15 | STILLGELEGT - mass bis 28.08.2026 Nakama Suna (NkPr): Passthrough bitgleich ueber drei Samplerates und fuenf Blockgroessen, 0 Samples Latenz, kein Tail, kein Hostparameter; Bundlevertrag laesst nur passive_probe zu; speichern-laden-speichern bytegleich. | `(nicht gefahren)` | [STILLGELEGT] seit 2026-08-28 (S9b/SONDE-007c): das Ziel NakamaSuna ist stillgelegt - Suna ist in Nakama Probeeq aufgegangen (design/abnahmen/2026-08-28-suna-stilllegung-vorgezogen.md). Weder gebaut noch gefahren; die Zeile bleibt sichtbar, damit die Kanonzahl nicht still sinkt. | - | - |
| A16 | Nakama Probeeq (NkAc): heute ebenfalls Passthrough bitgleich (die EQ-DSP kommt in P6), 0 Samples Latenz, kein Tail, kein Hostparameter; Bundlevertrag laesst nur active_probe zu; speichern-laden-speichern bytegleich. Seit der T3-Nacharbeit 29.08.2026 (G1 §4.2) faehrt dasselbe Bein die Gate-7-Kette AM GEBAUTEN BUNDLE Nakama Probeeq - Klasse active_probe, denn die Sondenschale traegt genau EINE Klasse je Uebersetzung: ein sonst gueltiger Stand mit measurement_position=post_fader_contribution kommt ueber setStateInformation read-only zurueck, die Instanz bleibt neutral, die Originalbytes gehen unveraendert an den Host zurueck und ein erneutes Laden waescht nichts; auch eine bereits klassifizierte Instanz faellt beim Nachreichen desselben Standes auf neutral zurueck; Gegenprobe mit insert laedt normal. Zusaetzlich misst dasselbe Bein direkt an der oeffentlichen positionErlaubt, dass post_fader_contribution fuer alle vier Klassen abgelehnt wird - das gemeinsame Ergebnis von Capability-Vorpruefung und Klassenmatrix, ohne die beiden Haelften zu trennen. Die vollstaendige 16er-Matrix samt Bundlevertraegen misst B2. | `eq-copilot\build\plugin\EqCopProbeeqNullTest_artefacts\Release\EqCopProbeeqNullTest.exe` | [OK] Exit 0 | 0,13 s | [A16](roh/SONDE-014-4df8855.md#a16) |
| B1 | Bundle-Identitaet (CIDs, JUCE_VST3_CAN_REPLACE_VST2=0) eingefroren. | `eq-copilot\build\plugin\EqCopIdentityTest_artefacts\Release\EqCopIdentityTest.exe` | [OK] Exit 0 | 0,10 s | [B1](roh/SONDE-014-4df8855.md#b1) |
| B2 | State-Schema 2: Roundtrip bytegleich, Schema-1-Migration rein und golden, unbekanntes Major read-only mit Originalbytes, Duplicate erkennbar und aufloesbar, Host-Dirty; alle vier Klassen sperren post_fader_contribution; NAK-40-Aliasvektoren adressieren die bytegleich erhaltene Legacy-instance_id ohne Alias im State; Parametertabelle und RFC-8785-state_hash sprachuebergreifend. | `eq-copilot\build\plugin\EqCopStateMigrationTest_artefacts\Release\EqCopStateMigrationTest.exe` | [OK] Exit 0 | 1,41 s | [B2](roh/SONDE-014-4df8855.md#b2) |
| B3 | Hostkontext (Anwesenheit, Parameterpunkte, Buslatenz) wird gemessen, nicht geraten; Quellhash-Gate des JUCE-Patches gruen. | `eq-copilot\build\plugin\EqCopHostContextTest_artefacts\Release\EqCopHostContextTest.exe` | [OK] Exit 0 | 0,10 s | [B3](roh/SONDE-014-4df8855.md#b3) |
| B3b | Termin-B-Messgeraet: Passthrough bitgleich, Sprung-/Automations-/Latenzmessung inkl. Fehlalarm-Riegel, Bericht-Rueckweg, 0 Allokationen. | `eq-copilot\build\plugin\EqCopHostProbeTest_artefacts\Release\EqCopHostProbeTest.exe` | [OK] Exit 0 | 0,13 s | [B3b](roh/SONDE-014-4df8855.md#b3b) |
| B3c | v3-Vertrag: C++ klassifiziert JSON- und FlatBuffers-Korpus wie das Manifest (Urteil UND Verletzungsmenge), einschliesslich Boolean/RFC-6901-Discriminatoren, NAK-29 in beiden Darstellungen und band_stereo ID 10; Bandgitter und Quantisierung bitgleich. Seit SONDE-013 misst dasselbe Bein integration_samples ID 14 ueber Encoder und Leser: gesetzt kommt Bit UND Wert zurueck, Abwesenheit bleibt gueltig und ist KEINE 0, und eine gesendete 0 faellt als Senderfehler. | `eq-copilot\build\plugin\EqCopSchemaTest_artefacts\Release\EqCopSchemaTest.exe` | [OK] Exit 0 | 0,47 s | [B3c](roh/SONDE-014-4df8855.md#b3c) |
| B4 | StampedAudioQueue und Ein-Block-Quarantaene: Ganzblockaufnahme bitgleich ueber jeden Ringumlauf, Ueberlauf BEIDER Ringe verwirft den ganzen Block und nie eine Teilmenge, Oversize ueber der Slotkapazitaet faellt fuer die Analyse und laesst Audio unberuehrt, Flush (numSamples 0) ist kein Verlust, Mono dupliziert L, Mehrfach-Tap-Layout traegt; Quarantaene versiegelt erst mit bewiesener Fortsetzung, Seek und Transportkante verwerfen genau EINEN Block, stehende Projektzeit (FL-Teilpuffer) ist kein Bruch, Projektzeit-Ueberlauf und negative Zeit sind behandelt; Worker-Publikation folgt monotonen 50-/250-ms-Deadlines statt Batchzahl, holt nach Pausen nicht auf und laesst wartende Reset-/Frame-Aufrufer vor; verdrahtet: Passthrough bitgleich ueber 18 Blockgroessen von 1 bis 16384, 0 Samples Latenz, kein Tail, 0 Allokationen im Audiothread ueber 4000 Bloecke wechselnder Groesse mit Transportkanten UND ueber 2000 weitere mit wechselnder Hoer-Markierung, Ein- und Ausfade und Interventionsring (SONDE-013 M-74), und die Engine bekommt den Strom bis auf den Block in Quarantaene. | `eq-copilot\build\plugin\EqCopQueueStressTest_artefacts\Release\EqCopQueueStressTest.exe` | [OK] Exit 0 | 3,72 s | [B4](roh/SONDE-014-4df8855.md#b4) |
| B9 | Fixed-memory Loudness (§48.1): der LoudnessAccumulator deckt sich mit der ausgebauten Vektorrechnung innerhalb ±0,1 LU (Entwurf §49) ueber konstante, rampende, zufaellige und einstuendige Korpora sowie ueber Stille unter dem absoluten Gate; Kurz-LUFS ist BITGLEICH; ein adversarialer Sweep legt 1000 Bloecke in den Grenzbin des relativen Gates und die selbstgemeldete Schranke unsicherheitLu() deckt jeden Lauf; eine Million Zellen laufen mit 0 Allokationen durch, waehrend die Gegenprobe (alte Rechnung) allozert; NaN/Inf-Zellen sind gezaehlt statt still als 0 verbucht und l_j == -70,0 exakt bleibt wertgleich; ueber dem Feingitter traegt ein OBERBAND aus Bins von 1 LU bis ueber lautheit(DBL_MAX) - mit ZWEI Pegeln darin (Korpus des T2-Pruefers), einem adversarialen Sweep im Oberband-Grenzbin, beiden Richtungen der Naht zwischen den Aufloesungen und der Gegenprobe, dass kein Block durch das Raster faellt. | `eq-copilot\build\plugin\EqCopLoudnessGoldenTest_artefacts\Release\EqCopLoudnessGoldenTest.exe` | [OK] Exit 0 | 0,18 s | [B9](roh/SONDE-014-4df8855.md#b9) |
| B5 | FeatureEngine v2 haelt Zeit-, Validity-, Event- und Bandvertraege: Bandgitter und alle Quantisierungsvektoren bitgleich zum v3-Vertrag, Bitmap LSB-first mit Fuellbits 0, FFT gegen Parseval und einen Sinus auf der Binmitte, K-Gewichtung ueber 20 Hz..20 kHz unter 0,1 dB an der BS.1770-Referenzkette; Drop/Seek(laufend UND gestoppt)/Loop-Wrap/moeglicher Straddle/Transportkante/Sampleratewechsel/Neuanlauf/Beweislagewechsel trennen JEDES offene Fenster - auch den K-Filterzustand, bitgleich gemessen -, waehrend FL-Teilstuecke mit stehender Projektzeit lokal weiterlaufen, und ein Drop zaehlt als Segment, nicht als Epoche. Seit NAK-182 misst ein Sweep zusaetzlich die ZEITLAGE: ein bekannter Impuls bei Stromsample 206336 laeuft ueber die fuenf Blockgroessen 1, 333, 512, 2048 und 16384 mal die fuenf Sampleraten 44,1 / 48 / 88,2 / 96 und 192 kHz, und der gemeldete stromSample ist je Samplerate ueber alle fuenf Blockgroessen IDENTISCH und liegt innerhalb einer Fensterlaenge (4096 Samples) vor dem Impuls. Die Auswahl des Ereignisses kennt die Sollzeit NICHT - gemessen wird das staerkste Flussereignis des Laufs, und dass es unzweifelhaft das staerkste ist, ist eine eigene Zusage. | `eq-copilot\build\plugin\EqCopAnalysisGoldenTest_artefacts\Release\EqCopAnalysisGoldenTest.exe` | [OK] Exit 0 | 6,28 s | [B5](roh/SONDE-014-4df8855.md#b5) |
| B6 | Aktiver DSP-Kern liefert die eingefrorene Referenzantwort. | `eq-copilot\build\plugin\EqCopDspGoldenTest_artefacts\Release\EqCopDspGoldenTest.exe` | [GEPLANT] geplant (ab P6) | - | - |
| B7 | Apply/Revert ist transaktional - kein halber Zustand ueberlebt. | `eq-copilot\build\plugin\EqCopTransactionTest_artefacts\Release\EqCopTransactionTest.exe` | [GEPLANT] geplant (ab P6) | - | - |
| B10 | C++-v3-Vertrag und SONDE-011 Phase B: Envelope/CRC/Pipetoken und begrenzte P0/P1/P2-Politiken bleiben gruen; das In-Flight-Register gibt persistente Befehle erst bei angewandt, idempotent_wiederholt oder endgueltigem Fehler frei und reiht vor ACK dieselbe command_id wieder ein; Autostart verbindet zuerst, prueft Manifest-SHA-256 und bei gesetztem Thumbprint WinVerifyTrust plus Signer, spawnt verborgen und mutex-idempotent, haelt Backoff/Timeout/Cooldown-Grenzen und beendet keinen Brokerprozess. Seit SONDE-013 nimmt die C++-Vertragsengine die drei Experimentfamilien aus den committeten Fixtures an, lehnt einen fremden execution_mode an derselben Engine ab, und ein experiment_manual_result laeuft als persistenzpflichtiger P0-Befehl durch das In-Flight-Register wie jede andere steuernde Nachricht. | `eq-copilot\build\plugin\EqCopIpcTest_artefacts\Release\EqCopIpcTest.exe` | [OK] Exit 0 | 273,37 s | [B10](roh/SONDE-014-4df8855.md#b10) |
| B11 | Probeeq uebernimmt JUCE updateTrackProperties ausschliesslich auf dem Message-Thread; gueltige Hostnamen reisen codepointgetreu in heartbeat.runtime, leer/Whitespace/121 Codepoints/C0/C1 gelten als Fehlen; Hostvorrang veraendert das gespeicherte User-Label nicht, Clear stellt dessen Rueckfall her. Persistierte Messpunkte insert/pre/post und Betrieb active/suspended/offline reisen ohne Synthese; der lokale C++-Pfad behauptet nicht, dass FL den Callback liefert. | `eq-copilot\build\plugin\EqCopSonde012HostChannelContextTest_artefacts\Release\EqCopSonde012HostChannelContextTest.exe` | [OK] Exit 0 | 1,01 s | [B11](roh/SONDE-014-4df8855.md#b11) |
| B12 | Probeeq fuehrt Audio ueber die vorallokierte Ganzblockqueue zum Analyseworker und P2: LUFS-I reist nur atomar mit endlicher unsicherheitLu und ohne Status; collecting/gated reisen ohne Zahlenpaar; halbe, nichtendliche oder statusbehaftete Paare werden nicht serialisiert. Seek, Loop, Oversize-Drop und Kontinuitaetsbruch starten eine leere Reihe; der gemessene Audiopfad alloziert dabei 0-mal und verwirft bei Ueberlast nur Analyse. | `eq-copilot\build\plugin\EqCopSonde012LoudnessSourceTest_artefacts\Release\EqCopSonde012LoudnessSourceTest.exe` | [OK] Exit 0 | 1,73 s | [B12](roh/SONDE-014-4df8855.md#b12) |
| B13 | Gen/Main ersetzt sein Quellenmodell durch absolute session_snapshot-Sichten und haelt Mitgliedschaft, Control, Messung, Namensherkunft und Capability-Evidenz getrennt; Frischegrenzen, Messpunkte, Betrieb, Fehlerkanal, Lautheitspaar, Hostvorrang, Sortierung und Hauptziel werden einzeln gemessen. Die integrierte 16-/32-Quellen-Zeitmessung gehoert A23. | `eq-copilot\build\plugin\EqCopSonde012SourcesModelTest_artefacts\Release\EqCopSonde012SourcesModelTest.exe` | [OK] Exit 0 | 0,09 s | [B13](roh/SONDE-014-4df8855.md#b13) |
| B14 | MainProject Save/Load erhaelt bestaetigte Quellidentitaet und User-Label, aber weder Control-Liveness noch Runtime-Nonce oder Messframe; Join, Benennen und Unbind melden je echte persistente Aenderung Host-Dirty, No-op, Save und Load nicht; Reload baut einen frischen subscribe_session-Auftrag. | `eq-copilot\build\plugin\EqCopSonde012ProjectReloadTest_artefacts\Release\EqCopSonde012ProjectReloadTest.exe` | [OK] Exit 0 | 0,22 s | [B14](roh/SONDE-014-4df8855.md#b14) |
| B15 | EqCopShot rendert den deklarierten SONDE-012-Sichtsatz bei exakt 760x430: 0/1/16 Quellen, fresh/partial/stale/disconnected/invalid, Namens- und Lautheitsgegenpfade, alle Diagnosezustaende, Label-/Unnamed-Rueckfall, Findings, genau ein Hauptziel mit Referenzen sowie das deaktivierte Label-Feld eines nicht fuehrenden Main. | `eq-copilot\build\plugin\EqCopShot_artefacts\Release\EqCopShot.exe --sonde012-suite eq-copilot/build/sonde012-shots` | [OK] Exit 0 | 2,94 s | [B15](roh/SONDE-014-4df8855.md#b15) |
| B20 | Gesamtklasse nach §34.3 (M-06): die vier Klassen sind geordnet, und `deckeln` ist ein Minimum, kein Mittelwert. Jeder der vier harten Maengel deckelt EINZELN auf schwach, ohne gegen die drei guten Nachbarquellen verrechnet zu werden; zwei Maengel ergeben in allen zwoelf Paarungen unbrauchbar. Was ein Erzeuger nicht beurteilen kann, deckelt ebenso auf mittel - eine Sonde mit PERFEKTER Abdeckung kommt deshalb nur auf mittel, weil sie Session, Passage und Alignment nicht sieht; das ist die Regel hinter dem Literal, das Etappe B an einer Stelle gesetzt hatte. Die zwei Abdeckungsschwellen und die Fensterschwelle fallen je an ihrer Kante und knapp darunter (Muster C-09). Die tragende Zusage ist eine INVARIANTE ueber den ganzen Raum: in 1536 Uebergaengen ueber alle 256 Bitkombinationen in drei Basislagen hebt ein zusaetzlicher harter Mangel die Klasse NIE - und alle vier Klassen kommen darin wirklich vor, die Invariante ist also nicht trivial erfuellt. Ein Mittelwert koennte diese Zusage nicht halten. | `eq-copilot\build\plugin\EqCopSonde013QualityClassTest_artefacts\Release\EqCopSonde013QualityClassTest.exe` | [OK] Exit 0 | 0,18 s | [B20](roh/SONDE-014-4df8855.md#b20) |
| B22 | Content-Fingerprint einer Passage (§32.4, M-26/M-27/M-31): er entsteht erst ab genug Material und traegt die Zahl seiner Fenster mit; dasselbe Material zweimal ergibt BITGLEICH denselben Fingerprint, derselbe Akkord in zwei Lautstaerken bleibt ueber 0,95 aehnlich (jeder Verlauf ist auf sein eigenes Maximum normiert), ein anderer Akkord ist messbar unaehnlicher und Rauschen deutlich. Die adversariale Rueckrechenprobe zeigt nicht, dass eine Rueckrechnung schwer waere, sondern dass die Information nicht da ist: 76 Byte fuer 204800 Samples, und ein Sinus und ein Dreieck derselben Grundfrequenz sind sich AEHNLICH, obwohl sie voellig anders klingen - der Fingerprint ist bewusst nicht injektiv, und alle drei Verlaeufe sind Energien ohne Phase. Das Fingerprintfenster ueberbrueckt keine Epochengrenze: nach einer Stromluecke traegt die Engine den Fingerprint des NEUEN Materials (Aehnlichkeit 1,00 zur neuen Referenz, 0,00 zur alten), und der Fensterzaehler faellt mit - bei einer Ueberbrueckung waeren es doppelt so viele. Die Aehnlichkeit selbst ist ein MINIMUM ueber die drei Verlaeufe und kein Mittelwert; zwei Fingerprints ohne Bit sind nicht aehnlich, sondern gar nichts. | `eq-copilot\build\plugin\EqCopSonde013FingerprintGoldenTest_artefacts\Release\EqCopSonde013FingerprintGoldenTest.exe` | [OK] Exit 0 | 1,03 s | [B22](roh/SONDE-014-4df8855.md#b22) |
| B23 | Die manuelle Passage als Projektintent im MainProjectState (§33.5, M-25/M-69). Das neue persistente Feld `manual_passages_v1` traegt seine Fassung im Namen; ein Altstand ohne das Feld laedt normal, ein unbekanntes Zusatzfeld aus einer spaeteren Fassung zerstoert den Leser nicht und steht unveraendert im naechsten Save, und Save/Load ist ueber zwei Runden bytegleich - auch am oberen int64-Rand und mit leerer Liste (die Eigenschaft entfaellt dann, statt als leeres Array zu reisen). Jede persistente Aenderung meldet GENAU einmal Host-Dirty, das Vergessen wie das Merken; ein read-only-Stand verweigert beides und gibt seine Originalbytes zurueck. Was hier NICHT reist, ist Absicht: Fingerprint, Quellenset, Abdeckung und Epoche sind Messergebnisse und bleiben im Store, sonst behauptete ein Projekt nach dem Loeschen der Datenbank weiter, es gebe Evidenz. Jede Grenze wird von beiden Seiten gefahren - was die Produkt-API ablehnt, lehnt auch der Leser ab, und zwar fail-closed als read-only statt still korrigiert. | `eq-copilot\build\plugin\EqCopSonde013PassageStateTest_artefacts\Release\EqCopSonde013PassageStateTest.exe` | [OK] Exit 0 | 11,95 s | [B23](roh/SONDE-014-4df8855.md#b23) |
| B24 | PRE/POST auf der Audioseite (§38.3/§38.4, M-18/M-20/M-24). Die Magnitude-Squared Coherence ist 1 fuer JEDE lineare zeitinvariante Kette und faellt genau dann, wenn die Kette nichtlinear oder zeitvariabel ist: identische Kette, reiner Gain von +15 dB und ein linearer Tiefpass bleiben fast ueberall ueber der 0,8-Schwelle aus §38.3 - Kompression, Modulation, Saturation und wechselnde Latenz fallen darunter, und die beiden Gruppen ueberlappen nicht. Deshalb traegt keine der vier adversarialen Ketten eine statische EQ-Behauptung. Der Vergleichspegel wird vorab gemessen und eingefroren: sechs Sekunden mit +18 dB und zwei Sekunden Stille aendern ihn um kein Tausendstel, denn eine mitlaufende Regelung wuerde selbst zum hoerbaren Prozessor; ohne genug Material friert er gar nicht erst ein, und NaN/Inf verriegeln statt ihn zu vergiften. Hoerbares Delta ist ohne nachgewiesenes Compare-Routing gesperrt - der Raum aus drei binaeren Nachweisen wird VOLLSTAENDIG abgefahren, genau eine der acht Kombinationen ist frei, und in P4 gibt es kein Compare-Routing. | `eq-copilot\build\plugin\EqCopSonde013PrePostGoldenTest_artefacts\Release\EqCopSonde013PrePostGoldenTest.exe` | [OK] Exit 0 | 1,20 s | [B24](roh/SONDE-014-4df8855.md#b24) |
| B25 | Unsicherheit und Mehrfachtestung (§43.2, M-45). Der Block-Bootstrap ist deterministisch, enthaelt den Mittelwert und liefert bei bloeckigem Material ein BREITERES Intervall als ein Bootstrap ueber Einzelwerte - benachbarte Deltas sind korreliert, und wer Unabhaengigkeit annimmt, macht aus Rauschen eine belastbare Aenderung. Leere oder unmoegliche Eingaben ergeben KEIN Intervall statt eines um null. Bei 221 gleichverteilten p-Werten meldet der naive Scan zweistellig viele Baender und die FDR-Korrektur kein einziges, waehrend 20 klare Treffer durchkommen; die Grenze p_(k) = k/m*q faellt inklusiv an ihrem Wert. Cluster verlangen zusammenhaengende Baender - drei verstreute ergeben keinen, vier benachbarte schon, und auch am linken und rechten Rand. | `eq-copilot\build\plugin\EqCopSonde013ExperimentGoldenTest_artefacts\Release\EqCopSonde013ExperimentGoldenTest.exe` | [OK] Exit 0 | 0,08 s | [B25](roh/SONDE-014-4df8855.md#b25) |
| B26 | Die zwei Kanten des Blindvergleichs (§43.1, §15, M-43/M-44). Ohne eingefrorenen Vergleichspegel wird KEIN Klangurteil angenommen - lauter klingt besser, und ein A/B ohne Pegelabgleich misst genau das; ein noch laufender Pegel zaehlt nicht als Abgleich. Die Blindreihenfolge wird vor dem Urteil gebunden und laesst sich nicht drehen; vor dem Urteil gibt der Typ sie GAR NICHT heraus, und der Ausgabeparameter bleibt unberuehrt statt still einen lesbaren Wert zu tragen. Erst das Urteil deckt genau die gebundene Reihenfolge auf, in beide Richtungen geprueft. Ein zweites Urteil und ein spaeterer Pegel aendern nichts mehr; jede Sperre traegt ein Wort, und der Passagenwechsel raeumt Urteil, Abgleich und Bindung gemeinsam ab. | `eq-copilot\build\plugin\EqCopSonde013ExperimentUiTest_artefacts\Release\EqCopSonde013ExperimentUiTest.exe` | [OK] Exit 0 | 0,49 s | [B26](roh/SONDE-014-4df8855.md#b26) |
| B21 | RT→Control-Ring fuer hoerbare Eingriffe (M-37 bis M-39, §34.2): ein Begin steht SOFORT zur Abholung bereit, ohne Kadenzfenster - der Unterschied zum 1-Hz-Heartbeat-Bit, das ein 380-Sample-Ereignispaar nie gesehen haette. Ein Ende traegt einen Nachlauf, der mindestens so lang ist wie der Eingriff selbst, UND dessen Dauer, damit ein Empfaenger die Konservativitaet pruefen statt sie glauben kann. Der Ueberlauf ist die schaerfste Zusage: dieser Ring verwendet KEIN drop-oldest, das aelteste Ereignis steht unveraendert an erster Stelle, der Ueberlauf ist sticky gemeldet und gezaehlt, der Rest kommt lueckenlos aufsteigend heraus, und das Sticky-Bit heilt nicht von selbst - nur resync() loescht es. 200 Runden Schreiben, Lesen und Abfragen erzeugen NULL Allokationen, mit Zaehler gemessen statt behauptet (M-74). Sequenzen am u64-Rand kommen unveraendert zurueck, und zuruecksetzen() leert Ring, Sticky-Bit und Zaehler gemeinsam. | `eq-copilot\build\plugin\EqCopSonde013InterventionRingTest_artefacts\Release\EqCopSonde013InterventionRingTest.exe` | [OK] Exit 0 | 0,08 s | [B21](roh/SONDE-014-4df8855.md#b21) |
| B19 | Bandweise Stereoevidenz (§40.1, §40.3, M-08/M-10/M-11/M-12): die fuenf Klassen aus §40.3 treffen ihre ANALYTISCH bekannte Antwort - Mono ergibt Korrelation 1, Kohaerenz 1, Phase 0 und Folddown 0 dB innerhalb der 0,25 dB aus §40.3; Polaritaetsinvertierung ergibt Korrelation -1 bei Kohaerenz 1 (die Kohaerenz misst den Zusammenhang, nicht das Vorzeichen) und eine Monosumme, die an die Vertragsgrenze laeuft statt zu schweigen; eine bekannte Laufzeit ergibt eine Phase, die der Formel +2*pi*f*tau folgt, an drei Traegerfrequenzen gemessen; unkorrelierte Kanaele fallen in Korrelation und Kohaerenz, und bei niedriger Kohaerenz entsteht keine Lag- oder Polaritaetsempfehlung. Seit NAK-182 faehrt ein Sweep dieselben fuenf Klassen und den Folddown ueber die 18 Blockgroessen 1, 2, 3, 7, 15, 16, 31, 64, 127, 128, 333, 512, 1024, 2048, 4096, 8192, 12345 und 16384 - je Blockgroesse dieselbe Antwort, je Blockgroesse ein wirklich entstandenes Evidenzfenster und vergleichbar viele gemittelte Fenster (Freiheitsgrade innerhalb 20 Prozent des Medians). Das ist eine AUSWAHL aus 1 bis 16384 und keine Erschoepfung: die Obergrenze ist die Slotkapazitaet des Layouts, 256 zum Beispiel bleibt ungemessen. Seit Nacharbeit 1 wertet der Sweep bei bekannter Laufzeit ALLE DREI Traeger aus - 300, 900 und 2000 Hz, je Blockgroesse mit Praesenzbit und Phasenfehler gegen +2*pi*f*tau innerhalb 0,25 rad -, und der Unkorreliert-Fall misst je Blockgroesse zusaetzlich, dass KEIN Band mit Basis eine Phase traegt; das sind dieselben Felder, die der 512er-Abschnitt fuer M-12 nutzt. | `eq-copilot\build\plugin\EqCopSonde013StereoGoldenTest_artefacts\Release\EqCopSonde013StereoGoldenTest.exe` | [OK] Exit 0 | 2,10 s | [B19](roh/SONDE-014-4df8855.md#b19) |
| B17 | True Peak nach ITU-R BS.1770-5 (M-02): der 8-fach-Polyphaseninterpolator trifft die fuenf True-Peak-Testfaelle aus EBU Tech 3341 (15 bis 19) innerhalb der SCHAERFEREN Toleranz aus §49.3, also +/-0,1 dB statt der +0,2/-0,4 der Norm; gemessen wird gegen die ANALYTISCHE Referenz - die Signale sind Sinus mit definierter Frequenz, Amplitude und Phase, und der wahre Scheitel eines Sinus IST seine Amplitude, also steht keine zweite eigene Implementierung als Vergleich dahinter. Der Gegenbeleg zeigt, dass ein Detektor ohne Ueberabtastung bei Testfall 16 um 3,01 dB zu optimistisch waere. Der Sampleraten-Sweep ueber 44,1/48/88,2/96/192 kHz haelt dieselbe Zusage, weil die EBU-Frequenzen an fs gebunden sind. Die 8-fach-Entscheidung wird als ZAHL getroffen: die geschlossene Fehlerschranke der Ueberabtastung haelt bei fs/4 mit Faktor 8 (-0,042 dB) und reisst mit Faktor 4 (-0,169 dB). Raender: Stille ergibt exakt 0, ein NaN bleibt nicht im Filterzustand, ein Gleichanteil bleibt bitgenau er selbst (jede der acht Phasen hat DC-Verstaerkung 1, nicht nur die Gesamtsumme 8), und ohne vorbereiten() misst der Detektor gar nicht, statt zu raten. | `eq-copilot\build\plugin\EqCopSonde013TruePeakGoldenTest_artefacts\Release\EqCopSonde013TruePeakGoldenTest.exe` | [OK] Exit 0 | 0,13 s | [B17](roh/SONDE-014-4df8855.md#b17) |
| B18 | Loudnessfenster, Headroom und Dynamik (M-01, M-03, M-04, M-07, M-09): Momentary (400 ms) und Short-term (3 s) sind wirklich zwei Fenster - bei stehendem Pegel gleich, 0,8 s nach einem Pegelsprung mehr als 5 LU auseinander, danach wieder beieinander; nach 0,6 s traegt der Frame Momentary und KEIN Short-term. integration_samples passt im Dauerbetrieb zur 10-Hz-Kadenz und faellt beim ersten Rahmen nach einer Grenze messbar kleiner aus. PSR rechnet gegen das True-Peak-Maximum DESSELBEN 3-s-Fensters, nicht gegen den Sample-Peak des 100-ms-Rahmens; die Engine setzt selbst kein PLR, weil LUFS-I erst im Sondenprozessor zugemischt wird. Headroom ist eine Verteilung: zwei Signale mit gleichem Maximum trennen sich um mehr als 10 dB im P50. Crest steht in zwei Fenstern und trennt dichte kleine Spitzen von einer einzelnen grossen. LRA gibt es nach 30 s NICHT, nach 75 s mit passender Spanne, bei Material ohne Dynamik nahe null und nach 90 s Stille gar nicht - die 60-s-Schwelle zaehlt gegatetes Material, keine Wanduhr. NaN und Inf im Eingang erzeugen in keiner der neun neuen Metrikstellen einen nichtendlichen Wert. Ein verworfener Analyseblock schliesst auch die neuen Fenster, und keines von ihnen ueberbrueckt eine Transportgrenze. | `eq-copilot\build\plugin\EqCopSonde013DynamicsTest_artefacts\Release\EqCopSonde013DynamicsTest.exe` | [OK] Exit 0 | 4,61 s | [B18](roh/SONDE-014-4df8855.md#b18) |
| B16 | Evidenzpfad (§33.2): der aus einem echten FeatureFrame erzeugte evidence_snapshot passiert Textriegel und dieselbe Vertragsengine wie B3c; P10/P50/P95 trennen ein springendes von einem ruhigen Signal gleicher mittlerer Lautheit (Spanne P95-P10 um mehr als 6 dB verschieden) und halten in JEDEM Band mit Bit die Ordnung P10<=P50<=P95; die Abdeckung faellt messbar, sobald ganze Analysefenster in Stille liegen, und die Konvergenz faellt bei wanderndem Pegel; der Ereignisstrom traegt Fluss- und Peakbit getrennt samt Verlustzaehler, ein Ereignis fremder Epoche oder ohne Anker entsteht gar nicht. Seit NAK-182 misst dasselbe Bein die C++-Haelfte der fokussierten 0,01-dB-Evidenz (M-83 Satz 2), seit Nacharbeit 1 vollstaendig am SERIALISIERTEN Snapshot: PRE und POST laufen durch den echten Serialisierer, und jede Zahl kommt aus verteilung.p50 des eigenen Wire-Textes - Encoding-Wort, Ganzzahlen und Praesenzbits. Daraus kommt ein bekannter Gain von 3,00 dB je Band mit Bit innerhalb 0,1 dB zurueck, und eine Leiter aus 20 Pegeln im Abstand 0,01 dB - je ein eigener Enginelauf samt Serialisierung - ergibt 20 streng monotone Ganzzahlen, deren Nachbarn sich um genau 1 unterscheiden. Material (Frequenz, Samplerate, Amplitude, Blockgroesse, Laufbegrenzung), Pegel, Gain und Aufloesung kommen aus den ZAHLEN der Fixture evidenz-0p01-paar-wire-v1.json, nicht aus ihren Bytes und nicht aus lokalen Konstanten. | `eq-copilot\build\plugin\EqCopSonde013EventWireTest_artefacts\Release\EqCopSonde013EventWireTest.exe` | [OK] Exit 0 | 0,61 s | [B16](roh/SONDE-014-4df8855.md#b16) |
| B27 | Der musikalische Intent als Projektintent im MainProjectState (§37.1, U22, M-01 bis M-09/M-11). Die Rollenmenge ist GESCHLOSSEN und hat genau fuenf Werte; ein sechster faellt in der Produkt-API UND im Leser, statt still auf einen bekannten Zweig abgebildet zu werden. Die §37.1-Belegung ist ABGELEITET und damit total und injektiv: alle fuenf Rollen kommen ueber den Roundtrip zurueck, keine zwei teilen sich eine Belegung (alle zwanzig geordneten Paare), und eine fremde Belegung gehoert zu keiner Rolle. Schutzangaben sind ORTHOGONAL zur Rolle - eine Quelle ohne Rolle kann Attack geschuetzt haben, und keiner der fuenf Rollenwechsel loescht einen Schutzbereich. Die Rolle bewusst-verschmolzen ist ein globales Veto gegen Entmaskierung; eine ausdrueckliche gerichtete Beziehung hebt es NUR fuer dieses Paar auf, nicht fuer ein drittes. Die Konfliktregeln sind eine geordnete Liste, kein Score: alle zehn Paarungen der fuenf Stufen fallen in beiden Leserichtungen, hundert Vermutungen schlagen die Schutzgrenze nie, und innerhalb Stufe 2 gewinnt das Spezifischere. Ein Zyklus im fuehrt_vor-Graphen erreicht die Persistenz NIE unmarkiert - die Pruefung laeuft beim Speichern, der Leser weist einen von Hand gebauten Zyklus als read-only ab, und derselbe Schluss als gleichrangig gespeichert laedt und kommt als gleichrangig zurueck. Eine abgeleitete Vermutung ueberschreibt einen Userwert nie, der umgekehrte Weg gilt. Derselbe Bus traegt verschiedene Rollen in zwei Passagen ohne Datenverlust, passagespezifisch vor global. Dazu die fuenf Teile der State-Invariante: Fassung im Namen, Altstand ohne die Felder laedt bytegleich, eine unbekannte Eigenschaft ueberlebt, Save/Load ueber zwei Runden bytegleich, und jede echte Aenderung meldet GENAU einmal Host-Dirty, waehrend No-op, abgewiesener Wert, Laden und read-only schweigen. Jede Grenze faellt von BEIDEN Seiten (17 Leserfaelle samt NaN/Inf-Konfidenz, Revision 0, Bandrand 0/221 und Selbstbeziehung), und die volle 256er-Liste, die die API erzeugt, laedt der eigene Leser. Zuletzt M-11 am Produktpfad: zwei echte Prozessoren mit demselben Strom, einer mit vollem Intent, liefern bitgleiche Evidenzbaender, Perzentile, Livebaender, metrics_version und NaN-Zaehler - mit Gegenprobe, dass die Baender wirklich Werte tragen. | `eq-copilot\build\plugin\EqCopSonde014IntentTest_artefacts\Release\EqCopSonde014IntentTest.exe` | [OK] Exit 0 | 0,42 s | [B27](roh/SONDE-014-4df8855.md#b27) |
| B29 | Die Zustandsmaschine des AssistantStep im Main (46.1, E-07/E-08, M-55 bis M-62). Die Zustandsmenge hat ACHT Werte, jeder kommt ueber seinen eigenen Rueckweg zurueck, ein neunter faellt. Nach preview fuehrt KEINE Kante - weder hin noch zurueck -, ein gespeicherter preview-Schritt ist ein Lesefehler statt eines stillen Sprungs, und die Produkt-API setzt ihn nicht; die Gegenprobe mit proposal laedt normal. Jeder der acht Zustaende traegt fuenf Angaben (Eintritt, Evidenz, Useraktion, Timeout ueber 0, sichere Rueckkante), auch preview - der erste Zustand ist seine eigene Rueckkante. Der Deckel ist STRUKTURELL: ein zweiter Startversuch bei offenem Schritt wird abgewiesen, nicht eingereiht, und erst nach dem terminalen Abbruch beginnt ein neuer. Die vier Gegenpfade laufen einzeln: Zurueck geht auf die Rueckkante, Ueberspringen auf den naechsten Zustand, Resume ist eine FRAGE ohne Revisionssprung, und Verwerfen ist terminal statt geloescht - danach gibt es kein Resume mehr. Die drei benannten Ergebnisse aus 46.2 sind eigene Ergebnisse mit Objekt; dasselbe zweimal hebt keine Revision. Die harten Gates greifen VOR der Gewichtung: drei Kandidaten mit perfektem Rang und je einem gerissenen Gate verlassen die Liste, ein bescheidener bleibt. Verdrahtet am echten Prozessor mit Host-Dirty genau einmal je echter Aenderung, Rekonstruktion aus dem gespeicherten MainProject und bytegleichem Save/Load; jede Grenze faellt von beiden Seiten, und ein Altstand ohne die Eigenschaft laedt normal und schreibt sie nicht. | `eq-copilot\build\plugin\EqCopSonde014AssistentTest_artefacts\Release\EqCopSonde014AssistentTest.exe` | [OK] Exit 0 | 0,22 s | [B29](roh/SONDE-014-4df8855.md#b29) |
| B28 | Die Befundzustaende auf der Gen-Seite (Abnahme U21, M-29 bis M-35). Die drei Sicherheitsstufen sind auf GENAU DREI Zustaende abgebildet, und die Abbildung ist ein FELD: ein vierter Wert macht den ganzen Snapshot ungueltig, statt still auf einen bekannten zu fallen. Nur READY TO SEND erlaubt HOLD TO AUDITION und SEND DRAFT - die Sperre liegt am Befund im Modell, nicht an einer ausgegrauten Schaltflaeche. Messqualitaet der Passage und Sicherheit des Befunds bleiben zwei Felder aus zwei Quellen: ein Befund mit confidence.class hoch, dessen Zustand more_data sagt, bleibt nicht handelbar. Alternativen sind EIGENE Befunde mit eigenem Zustand und reisen als IDs; ein Freitext faellt. Der Beleg ist die markierte Zone - Bandrand 0 und 221 gueltig, leeres Intervall und 222 nicht -, und ein Belegtextfeld gibt es nicht. Die drei Anzeigezeilen sind drei eigene Felder; eine vierte oder eine leere faellt. Die acht Ausschlussgruende kommen mit ihrem Grund an, ein neunter faellt. Jede Zahl faellt an ihrer Grenze und nicht erst danach. Zuletzt die Fassungsleiter: ein Leser der Fassung 2 lehnt findings ab, Abwesenheit heisst keine Befunde, und ein Sitzungswechsel raeumt sie ab. Seit Etappe E dazu der Maskierungswert AM Befund: er benennt Frequenzbereich und beide Quellen, gueltig und herabgesetzt sind zwei eigene Bits, Abwesenheit ist etwas anderes als ein ungueltiger Wert, und ein Objekt beliebiger Form faellt - sechs Formen einzeln geprueft. Eine Zeichenanweisung (Achse, Zoom, Farbe) faellt am Vertrag, auch im Maskierungswert. | `eq-copilot\build\plugin\EqCopSonde014BefundTest_artefacts\Release\EqCopSonde014BefundTest.exe` | [OK] Exit 0 | 0,14 s | [B28](roh/SONDE-014-4df8855.md#b28) |
| B8 | Lifecycle-Klassifikation §53.5 bleibt erhalten; SONDE-011 startet den Broker nur ueber state::Lebenslauf::darfBrokerStarten() bei Main plus offenem Editor. Alle Negativzustaende lassen den Launcher unberuehrt, und die instrumentierte Gegenprobe misst null Broker-Lifecycle-Aufrufe aus processBlock beziehungsweise dem Audiothread. | `eq-copilot\build\plugin\EqCopLebenslaufTest_artefacts\Release\EqCopLebenslaufTest.exe` | [OK] Exit 0 | 0,27 s | [B8](roh/SONDE-014-4df8855.md#b8) |
