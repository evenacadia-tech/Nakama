> **ARCHIV (21.08.2026). Produkt-/Umsetzungsplan 12.–16.08. (User 21.08.: „Archiv“). Kennt weder Sondenfamilie noch eigenständigen Broker; führt Tauri-Hub-App und Claude-Schicht als Produktteile — beides gilt nicht mehr. Keine Vorgabe mehr. Gültige Produktdefinition: CLAUDE.md (Wahrheitskern + Entscheide-Register); technischer Entwurf: docs/FL-Nakama-Sonden-Design-Entwurf.md.**
