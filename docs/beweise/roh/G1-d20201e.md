...
**Lauf:** 2026-08-30 20:29 | **Runner:** `tools/beweise.ps1` | **Urteil:** ROT - 1 von 32 Kanon-Laeufen fehlgeschlagen | 2 geplante Pruefung(en) noch nicht gebaut | 1 stillgelegte(s) Bein(e), siehe Uebersicht | **Exitcode:** 2
...
|---|---|---|---|
| `EqCopNullTest` | 2026-08-30 20:29:02 | `2D6EB87AD22D635C` | frisch (Bau bestaetigt) |
| `EqCopGoldenTest` | 2026-08-29 19:34:14 | `CC3B4291A48EBFA6` | frisch (Bau bestaetigt) |
| `EqCopMarkierungTest` | 2026-08-30 20:29:06 | `6EF084D2949C7352` | frisch (Bau bestaetigt) |
| `EqCopPipeClientTest` | 2026-08-29 19:34:53 | `349EB193563ED663` | frisch (Bau bestaetigt) |
| `EqCopProbeeqNullTest` | 2026-08-30 20:29:09 | `520DAD9320648565` | frisch (Bau bestaetigt) |
| `EqCopIdentityTest` | 2026-08-30 20:29:11 | `5CAB73759B57AEF6` | frisch (Bau bestaetigt) |
| `EqCopStateMigrationTest` | 2026-08-30 20:29:13 | `3541B83F504A5A99` | frisch (Bau bestaetigt) |
...
| `EqCopSchemaTest` | 2026-08-30 20:29:18 | `0530BAB3B1F69492` | frisch (Bau bestaetigt) |
| `EqCopQueueStressTest` | 2026-08-30 20:29:20 | `19D2F0D3F2DC6E2B` | frisch (Bau bestaetigt) |
| `EqCopLoudnessGoldenTest` | 2026-08-29 19:37:41 | `3BC12A458CB9D51E` | frisch (Bau bestaetigt) |
| `EqCopAnalysisGoldenTest` | 2026-08-30 20:29:24 | `D46D7501AE25565C` | frisch (Bau bestaetigt) |
| `EqCopIpcTest` | 2026-08-30 20:29:25 | `01339F313B1C5886` | frisch (Bau bestaetigt) |
| `EqCopLebenslaufTest` | 2026-08-30 20:29:27 | `4DE2460A20DA3DCD` | frisch (Bau bestaetigt) |
...
| A4 | Broker-Vertragstests gruen (Framing, Protokoll, Bindung, Aggregat, Server). | `cargo test --manifest-path broker/Cargo.toml --color never` | [ROT] Exit 101 | 3,91 s | [↓ A4](#a4) |
...
| A5 | Referenzbein (jsonschema, draft 2020-12): Schema haelt die Engine-Teilmenge ein, Textriegel deckt jede gemessene Kante, jedes Fixture wird wie im Manifest klassifiziert, jede Definition hat ein Negativfixture. | `py -3.13 tools\eq-copilot\pruefe_v3_vertrag.py --abdeckung` | [OK] Exit 0 | 2,62 s | [↓ A5](#a5) |
...
| A10 | Binaerer Fixture-Korpus und sein MANIFEST bytegleich zur Neuerzeugung; keine verwaiste Datei. | `py -3.13 tools\eq-copilot\erzeuge_fb_fixtures.py --pruefen` | [OK] Exit 0 | 1,70 s | [↓ A10](#a10) |
...
**Befehl:** `cargo test --manifest-path broker/Cargo.toml --color never` | **Exitcode:** 101 | **Dauer:** 3,91 s
...
test transport::server_v3::tests::abgeloestes_telemetrie_getrennt_haelt_control_getrennt_nicht_auf ... FAILED
...
---- transport::server_v3::tests::abgeloestes_telemetrie_getrennt_haelt_control_getrennt_nicht_auf stdout ----

thread 'transport::server_v3::tests::abgeloestes_telemetrie_getrennt_haelt_control_getrennt_nicht_auf' (10672) panicked at src\transport\server_v3.rs:2900:9:
...
test result: FAILED. 148 passed; 1 failed; 0 ignored; 0 measured; 0 filtered out; finished in 2.42s
```
...
**Befehl:** `py -3.13 tools\eq-copilot\erzeuge_fb_fixtures.py --pruefen` | **Exitcode:** 0 | **Dauer:** 1,70 s
...
**Befehl:** `py -3.13 tools\eq-copilot\pruefe_kern_identitaetsfrei.py` | **Exitcode:** 0 | **Dauer:** 5,10 s
...
[0] Frische - der Kern wurde fuer diese Messung neu gebaut
  ok      Kernartefakte geloescht und in 4.6s neu erzeugt (22 Dateien entfernt, 9 Uebersetzungseinheiten, 9 Objekte, Lib neu gelinkt)
...
[4] Auslieferungsstand  - Kanon: eine Abweichung ist ein Hinweis, kein Fehler
  hinweis main: Bau weicht vom festgeschriebenen Paket ab (nach Relink erwartet; vor einer Auslieferung --hashen)  [Manifest AC8102F23EDC7D7C | gebaut 5FEE7CB64BE1CC1D]
  hinweis active-probe: Bau weicht vom festgeschriebenen Paket ab (nach Relink erwartet; vor einer Auslieferung --hashen)  [Manifest 1DDC92E3B8525F1F | gebaut 276C55BDF3BC8DE6]
...
**Befehl:** `py -3.13 tools\eq-copilot\pruefe_installer_gegenpfad.py` | **Exitcode:** 0 | **Dauer:** 36,66 s
...
Probe-Pipe: \\.\pipe\evenacadia.nakama.v3.probe.last.24108.1788114860
  BEREIT \\.\pipe\evenacadia.nakama.v3.probe.last.24108.1788114860
SONDE-010 | Lastbein: 32 Sonden, 8 s, Pipe \\.\pipe\evenacadia.nakama.v3.probe.last.24108.1788114860
  verbunden: 32 Control, 32 Telemetrie
{"sonden":32,"sekunden":8,"p2_veroeffentlicht":132832,"p2_gesendet":94470,"p2_ersetzt":38366,"p2_abgelehnt":0,"p2_zu_gross":0,"p2_kollisionsloecher":0,"p2_neueste_verworfen":0,"p0_gesendet":10016,"p0_beantwortet":10016,"p0_latenz_max_ms":21,"p0_latenz_p99_ms":20,"p0_ueberlaeufe":0,"envelope_abweisungen":0}
  ...
  ok      es lag WIRKLICH Rueckstau an (Cap 2 hat ersetzt)  [38366 ersetzte P2-Frames]
...
Brokerbericht: {"abweisungen": 0, "acceptor_wartet_auf_instanz": 0, "angenommen": 64, "control_getrennt": 32, "control_verbindungen": 32, "geschlossen_bootstrap": 0, "geschlossen_envelope": 0, "geschlossen_familie": 0, "geschlossen_kopplung": 0, "geschlossen_p0_ueberlauf": 0, "geschlossen_rate": 0, "geschlossen_writer": 0, "ingress_hoechststand": 3, "ingress_p1_ueberlauf_trennt": 0, "ingress_p2_verworfen": 0, "letzter_grund": "", "p0": 10016, "p0_beantwortet": 10016, "p1": 0, "p2": 94470, "pipe": "\\\\.\\pipe\\evenacadia.nakama.v3.probe.last.24108.1788114860", "telemetrie_getrennt": 32, "telemetrie_verbindungen": 32}
  ...
  ok      und P2 ueber die zweiten Verbindungen  [94470]
  ...
  ok      es lag wirklich Rueckstau an  [38366 ersetzte P2-Frames]
...
```text
  ...
  ok      main: moduleinfo.json ist nicht aelter als plugin/CMakeLists.txt  [30 Aug 2026 8:29:54pm vs 29 Aug 2026 7:31:27pm]
  ...
  ok      active-probe: moduleinfo.json ist nicht aelter als plugin/CMakeLists.txt  [30 Aug 2026 8:30:22pm vs 29 Aug 2026 7:31:27pm]
...
Fixtures: C:\Users\phili\Projekte\Nakama\eq-copilot\fixtures\state
  ...
  ok      neue instance_id: 32 Hex, verschieden von beiden  [3d695fd8a7fc4a41968cf6e352218bdb]
  ...
  ok      frisch: instance_id ist hex32  [ae628c725d874619aaa1ce616898891e]
...
== J2 - Nebenlaeufig lesen, waehrend der Audiothread schreibt ==
  ok      der zweite Thread hat waehrenddessen wirklich geschrieben (26601 Bloecke)
...
**Befehl:** `eq-copilot\build\plugin\EqCopIpcTest_artefacts\Release\EqCopIpcTest.exe` | **Exitcode:** 0 | **Dauer:** 49,79 s
...
== E2 · P2-Schleuse: vorallokiert, ohne Allokation, replace-oldest ==
  ...
  ok      2 000 000 kleine Frames unter Flut: kein zerrissener Frame  [184774 geholt, 0 zerrissen, 1997076 ersetzt]
  ok      300 000 grosse Frames (8000 B) ebenso: kein zerrissener Frame  [17339 geholt, 0 zerrissen]
  ...
  ok      der Erzeuger traf den beanspruchten Slot WIRKLICH — und hat ihn nicht beschrieben  [7218 uebersprungene Positionen]
