...
| Kanon nachher | **GRUEN 45/45 auf `ab0251d`** — der Endstand der Etappe C, mit allen vier neuen Beinen (B17 bis B20). ⚠️ Der Lauf ist `-dirty` gestempelt: die zwei Dateien der beginnenden Etappe D lagen beim `git status` des Runners bereits im Baum. Er beweist damit die BEINE vollständig, aber nicht allein den Commit; die Beglaubigung ist der Lauf am Ende der Etappe D auf sauberem Baum — dasselbe Muster wie bei A/B (§10.1). Rohausgabe `docs/beweise/roh/SONDE-013-ab0251d-dirty.md`. Der Stand davor: GRUEN 41/41 auf `5397680`, Arbeitsbaum sauber, Rohausgabe `docs/beweise/roh/SONDE-013-5397680.md`. 2 geplante Beine noch nicht gebaut (B6, B7 ab P6), 1 stillgelegtes (A15). |
| Testanzahl | A5 467 Prüfungen · A3 61 · B3c 75 · B10 313 · B16 52 · B17 23 (neu) · B18 44 (neu) · B19 57 (neu) · B20 24 (neu) · B21 22 (neu) · B5 237 · Broker 203 Lib-Tests plus alle Integrationsbeine · JSON-Fixturekorpus 285 (75 gültig, 210 ungültig) · Binärkorpus 104 (20 gültig, 84 ungültig) · Envelope-Korpus 37. Alle Zahlen aus dem Lauf dieser Sitzung, nicht abgeschrieben. |
