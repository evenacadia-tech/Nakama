...
$kanon = @(
    ...
    [pscustomobject]@{
        ...
        AbPhase    = 'jetzt'
        Behauptung = 'AnalyseEngine deckt sich mit der eingefrorenen Offline-Referenz (Fixture-SHA-256 als Determinismus-Riegel). Seit NAK-380 Etappe 3: M1-Perzentile aus Teilbloecken zu acht Segmenten; Rauschen steht in jedem Band ruhig, eine bekannte Pegelbewegung wird innerhalb -0,5/+2,0 dB gelesen.'
    }
    [pscustomobject]@{
        Kuerzel    = 'A3'
