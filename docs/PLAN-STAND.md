...
**Stand:** 2026-08-24 · Quellstand `5d26002` · **12 von 36 abgenommen** · 4 gebaut · 20 offen

`█████████████▓▓▓▓▓░░░░░░░░░░░░░░░░░░░░░░` 33 % abgenommen · 44 % gebaut

**Als Nächstes:** **G1** `Gate` — Prüfrunde über P1 (C++- und Rust-Review + Codex).

**Wartet auf ein Urteil** (gebaut, nachgemessen, aber ohne PASS eines frischen Prüfers): `S5` · `S6` · `S8` · `S9`
