...
| Ticketpfade | Etappe 1: nur `docs/beweise/NAK-283.md`. Etappen 2 bis 6: die Pfade aus §3, je Etappe wörtlich im Auftrag. Beim Ticketabschluss zusätzlich `tools/beweise.ps1`, nur die Behauptungszeilen von A16, B7, B6 und A3 (§33.7 Punkt 1, §34). |
