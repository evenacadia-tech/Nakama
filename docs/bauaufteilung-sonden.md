...
- **Stand:** 2026-09-02 (Kopf und §1.4/§3/§6.4 mit PR2 nachgezogen)
...
(User-Auftrag 31.08.2026: „ignoriere bisherige design die entworfen wurden")
...
|---|---|---|
| Band-Belegung, atomare Slotfreigabe und wiederherstellbares Remove (`enabled = false` ≠ „Slot frei") | **S26–28**, gespiegelt in **S28b**, Bedienung **S31b** | Fünferblock 02, 4/5 und 5/5 (01.09.2026) |
| `Frame.band_dynamic_gain_db` — Nutzlast zum reservierten Namen | **S26–28** (IPC), **S28b** (lokal), Anzeige **S31b** | Fünferblock 01, 5/5 (01.09.2026); Reservierung in `eq-copilot/schemas/v3/reservierte-nachrichten-v1.json` |
| 10-Sekunden-Kandidat: ID, Timer, Nachricht, ACK, Reconnect, Kill, Ablauf | **S29–31** | Entscheid 23.08.2026 (Drei-Stufen-Geste), Blueprint §15 Punkt 12 |
