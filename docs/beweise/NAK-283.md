...
| Beweise | **20 von 20 Rotbeweisen** rot → grün mit bytegleicher Rücknahme — 18 Mutationen, dazu der Riegel M-43 gegen den Basis-SHA (Bilanz `docs/beweise/roh/NAK-283-etappe-4-rotbilanz.txt`, §33.2). **38 von 38 Beinen Exit 0**, 42 Ziele gebaut ohne Warnung auf einer geänderten Zeile (`docs/beweise/roh/NAK-283-etappe-4-beine.txt`, §33.4). Riegel M-43 am Arbeitsbaum 12 von 12. Kein Kanon, kein Laufzeit-Arm (Ende der Etappe 6). |
