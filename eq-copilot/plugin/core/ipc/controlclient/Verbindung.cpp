...
// ControlClient — Verbindung: aufbauen, halten, abbauen.
//
// NAK-225/S25d (09.09.2026), herausgeloest aus core/ipc/ControlClient.cpp.
// Inhalt:
//
//   Laufzeit::threadLauf, Laufzeit::eineVerbindung
//                        Der Clientthread und ein vollstaendiger
//                        Verbindungslauf: verbinden, Hello, Welcome oder
//                        Reject, lesen, schreiben, abbauen. eineVerbindung
//                        bleibt EINE Funktion (Register NAK-235: keine lange
//                        Funktion wird in diesem Ticket zerlegt).
//   Laufzeit::aufbauZug, aufbauAussageZurueckstellen, meldeLinkStatus
//                        Der Aufbauzug und die Aussage, die er nach aussen
//                        erst dann macht, wenn sie stimmt.
//   meldeAufbauUrteil, loescheAufbauUrteil, wireGenerationJetzt,
//   sterbendeGenerationJetzt, tlAufbauGeneration, tlLinkEndeGeneration
//                        Die Generationen: welcher Aufbau gerade gilt und
//                        welcher gerade stirbt.
//   Laufzeit::heartbeatSchritt
//                        Der Herzschlag, solange die Verbindung steht.
//   Laufzeit::sollAbbrechen, Laufzeit::kopplung, ControlClient::kopplung
//                        Abbruchfrage und Kopplungsstand.
//   linkAufbauFuerTest, linkEndeFuerTest, heartbeatSchrittFuerTest,
//   heartbeatTextFuerTest
//                        Die Griffe, mit denen die Beine den Lebenszyklus
//                        messen.
//
// Pruefliste B gilt hier woertlich: die Reihenfolge beim Verbinden ist
// festgelegt und gemessen (anmelden, Callback "verbunden" abgeschlossen, erst
// dann Welcome nach aussen); beim Trennen wird zuerst abgemeldet, dann werden
// Fristen und Joins gefahren; nach dem Schliessen wird nichts mehr geliefert.
