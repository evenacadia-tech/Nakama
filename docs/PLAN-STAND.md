...
> oder `tools/plan/` liegen Änderungen, die noch nicht in `d76cc8e` sind.
...
**Wartet auf ein Urteil** (gebaut, nachgemessen, aber ohne PASS eines frischen Prüfers): `S5` · `S6` · `S8`
