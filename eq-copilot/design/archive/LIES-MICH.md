...
| `nakama-spectral-field-vorentwurf.html` | Spectral Field, Codex-Vorentwurf (Codex-Besitz; Edits blockte vom 22.08. bis 12.09.2026 die `kreativ-schleuse.sh` mit dem ganzen Ordner — Hook am 12.09.2026 entfernt, der Extra-Wächter `guard-codex-besitz.sh` war schon mit Commit `ef1efee` entfallen) | alt | Codex 16.08. |
...
| `proben/probe-01…04.html`, `proben/render-probe.mjs`, `proben/renders/` | Vier Mechanismus-Proben zur Suche eines Hauptansicht-Inhalts (`prototyp-smoke2.png` war byteidentisch mit `prototyp-smoke.png`, am 12.09.2026 entfernt) | P01 Perkolation: Ästhetik abgenommen, als Dauerinhalt 18.08. verworfen („wasserfall aus farbigen pixeln"); P02–P04 verworfen (User) | 17.08. |
| `vorentwurf-renders/` (45) | Renders aus fünf Richtungen (HUD 01–10, Codex 13–16, Problemreaktionen 21–24, Claude t3/n4, Kunstwerk k1); `n4-08-mittel.png` war byteidentisch mit `n4-05-ueberlagerung.png`, am 12.09.2026 entfernt | alt | 15.–17.08. |
...
Die neue Front beider Apps (Gen, Probeeq) entsteht in Figma (`fable-dummy`) — diese hier ist Verlauf.
