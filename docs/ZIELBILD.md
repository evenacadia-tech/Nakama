...
- Kurzzeit-Lautheit bleibt nach einer Störung kurz leer, statt einen alten Wert zu zeigen
  (U42).
- FLs eigener Bypass-Knopf am Mixer-Slot blendet weich, und Probeeq misst währenddessen
  weiter (U48; der Bau wartet auf Karte U58).
...
- **FLs Bypass-Knopf loslassen (U58):** laufen die Filter einfach weiter oder fangen sie
  neu an? Ohne Antwort wird FLs Bypass-Knopf nicht umgebaut: er schaltet weiter hart um, und
  die Messung pausiert.
