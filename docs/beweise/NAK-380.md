...
| Kanon nachher | Etappe 2 (Bau): GRUEN 70/70 an `83b9fc2c` (Code gleich `6172067a`), 25.09.2026, 12:00 bis 13:15 Uhr, `docs/beweise/roh/NAK-380-83b9fc2-dirty.md` (dirty: Broker-Pin des Runners in `nakama-installer-v1.json`); A32 Hinweis Exit 4, vorbestehende Codebase-Maße (NAK-292), A15 stillgelegt (§24). Ticketabschluss steht aus. |
