...
$kanon = @(
    ...
    #
    # NAK-94 Nacharbeit 12 (30.08.2026): journale/MANIFEST.json hat ZWEI Leser
    # - [3b] hier und pruefen() im Erzeuger. Der zweite griff ohne
    # Strukturpruefung zu und starb bei einer einzelnen Byteaenderung
    # ("faelle" -> "xaelle") mit einem KeyError-Traceback. Er liest jetzt ueber
    # dieselbe, IMPORTIERTE Pruefung, sein main() liegt im selben zentralen
    # Faenger, und [3c] faehrt ihn als zweiten Verbraucher mit: gemessen, nicht
    # behauptet.
