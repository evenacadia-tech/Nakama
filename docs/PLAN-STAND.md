...
**Stand:** 2026-08-30 · Quellstand `3687ea4` · **16 von 38 abgenommen** · 3 gebaut · 19 offen

> ⚠️ Gerechnet aus dem Arbeitsbaum: unter `docs/plan/`, `docs/beweise/`
> oder `tools/plan/` liegen Änderungen, die noch nicht in `3687ea4` sind.

`█████████████████▓▓▓░░░░░░░░░░░░░░░░░░░░` 42 % abgenommen · 50 % gebaut

**Als Nächstes:** **Nacharbeit an G1** — der Prüfer hat einen Befund offen gelassen (docs/beweise/G1.md).

**Wartet auf ein Urteil** (gebaut, nachgemessen, aber ohne PASS eines frischen Prüfers): `S9b` · `S14–15`
...
| **P1** — Verträge, gespeicherter Zustand, neutrale Hüllen | `█████████████████▓▓▓▓▓▓▓` | 5 | 2 | 0 |
...
flowchart LR
  ...
  P0 --> P1
  P2["P1<br/>5/7 abgenommen<br/>+2 gebaut"]:::laeuft
  P1 --> P2
...
### P1 — Verträge, gespeicherter Zustand, neutrale Hüllen  (5/7 abgenommen, 2 gebaut)
