...
**Stand:** 2026-08-29 · Quellstand `51d3f90` · **14 von 37 abgenommen** · 5 gebaut · 18 offen

> ⚠️ Gerechnet aus dem Arbeitsbaum: unter `docs/plan/`, `docs/beweise/`
> oder `tools/plan/` liegen Änderungen, die noch nicht in `51d3f90` sind.

`███████████████▓▓▓▓▓▓░░░░░░░░░░░░░░░░░░░` 38 % abgenommen · 51 % gebaut

**Als Nächstes:** **Nacharbeit an G1** — der Prüfer hat einen Befund offen gelassen (docs/beweise/G1.md).

**Wartet auf ein Urteil** (gebaut, nachgemessen, aber ohne PASS eines frischen Prüfers): `S8` · `S9` · `S9b`
