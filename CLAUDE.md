...
| 24.08. | **WhatsApp ist der Berichtskanal:** nach JEDER fertigen Session ein ganz kurzer Bericht — **nur an den User selbst**, nie an Dritte. Werkzeug: MCP `whatsapp` (User-Scope). Die Zieladresse steht bewusst **nicht im Repo**, sondern im Memory `feedback_whatsapp-berichtskanal` | „du schickst nur nachrichten an mich selbst. […] das ist der offizielle weg mich zu erreichen ab jetzt. schreib immer wenn eine session fertig ist ein ganz kurzen bericht" |
