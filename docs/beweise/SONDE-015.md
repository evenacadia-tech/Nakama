...
| Etappe | **Etappe 4a gebaut auf `dc6c148a` (10.09.2026, §10; Erstprüfung 4a läuft, Auftrag `docs/beweise/roh/SONDE-015-etappe-4a-erstpruefung-auftrag.txt`). Danach UNTERBROCHEN für den unabhängigen Codeaudit (User-Wort 10.09.2026, Register NAK-246): zuerst die SONDE-015-Nacharbeit D8/D10/N-12/N-9 (`docs/beweise/roh/SONDE-015-audit-nacharbeit-auftrag.txt`), dann NAK-246; erst danach Nacharbeit 4a (falls NEEDS_WORK) und Etappe 4b — Fernweg-Anteile und voller Kanon.** Etappe 1 (Matrix) nach sieben Matrixprüfungen, Konvergenzentscheid und NAK-245-Runde (§7); Etappe 2 (Verträge in drei Sprachen) nach Erstprüfung und zwei Nacharbeiten (§8); Etappe 3 (DSP-Kern als Bibliothek, B6 scharf) nach Erstprüfung und drei Nacharbeiten (§9). |
