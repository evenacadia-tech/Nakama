...
**Stand:** 2026-08-29 · Quellstand `a0053e4` · **14 von 37 abgenommen** · 5 gebaut · 18 offen

> ⚠️ Gerechnet aus dem Arbeitsbaum: unter `docs/plan/`, `docs/beweise/`
> oder `tools/plan/` liegen Änderungen, die noch nicht in `a0053e4` sind.
